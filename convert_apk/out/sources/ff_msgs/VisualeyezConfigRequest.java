...
public interface VisualeyezConfigRequest extends Message {
    public static final byte CALIBRATE = 2;
    public static final byte LOAD = 3;
    public static final byte RECORD = 1;
    public static final byte SAVE = 4;
    public static final byte TRACK = 0;
    ...
    public static final String _TYPE = "ff_msgs/VisualeyezConfigRequest";
