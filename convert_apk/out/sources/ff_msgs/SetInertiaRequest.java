...
import geometry_msgs.InertiaStamped;
import org.ros.internal.message.Message;

public interface SetInertiaRequest extends Message {
    ...
    public static final String _TYPE = "ff_msgs/SetInertiaRequest";

    InertiaStamped getInertia();

    void setInertia(InertiaStamped inertiaStamped);
}
