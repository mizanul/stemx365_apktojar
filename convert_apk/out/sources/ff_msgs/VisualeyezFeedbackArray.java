...
public interface VisualeyezFeedbackArray extends Message {
    ...
    public static final String _TYPE = "ff_msgs/VisualeyezFeedbackArray";

    List<VisualeyezFeedback> getFeedback();

    Header getHeader();

    void setFeedback(List<VisualeyezFeedback> list);
