...
public interface PerchActionResult extends Message {
    ...
    public static final String _TYPE = "ff_msgs/PerchActionResult";

    Header getHeader();

    PerchResult getResult();

    GoalStatus getStatus();

    void setHeader(Header header);

    void setResult(PerchResult perchResult);
