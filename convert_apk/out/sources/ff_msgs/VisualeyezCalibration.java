...
public interface VisualeyezCalibration extends Message {
    ...
    public static final String _TYPE = "ff_msgs/VisualeyezCalibration";

    List<VisualeyezDataArray> getTargets();

    void setTargets(List<VisualeyezDataArray> list);
}
