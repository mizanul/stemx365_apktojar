...
public interface VisualeyezDataArray extends Message {
    ...
    public static final String _TYPE = "ff_msgs/VisualeyezDataArray";

    Header getHeader();

    List<VisualeyezData> getMeasurements();

    void setHeader(Header header);

    void setMeasurements(List<VisualeyezData> list);
}
