...
import android.support.p002v4.graphics.PathParser;
...
public class AnimatorInflaterCompat {
    ...
    private static android.animation.PropertyValuesHolder getPVH(android.content.res.TypedArray r22, int r23, int r24, int r25, java.lang.String r26) {
        ...
        L_0x0045:
            ...
            android.support.v4.graphics.PathParser$PathDataNode[] r15 = android.support.p002v4.graphics.PathParser.createNodesFromPathData(r5)
            r18 = r4
            android.support.v4.graphics.PathParser$PathDataNode[] r4 = android.support.p002v4.graphics.PathParser.createNodesFromPathData(r6)
        ...
        L_0x006a:
            ...
            boolean r14 = android.support.p002v4.graphics.PathParser.canMorph(r15, r4)
    ...
    private static int inferValueTypeOfKeyframe(Resources res, Resources.Theme theme, AttributeSet attrs, XmlPullParser parser) {
        ...
        TypedValue keyframeValue = TypedArrayUtils.peekNamedValue(a, parser, TypeSerializerImpl.VALUE_TAG, 0);
    ...
    private static Keyframe loadKeyframe(Context context, Resources res, Resources.Theme theme, AttributeSet attrs, int valueType, XmlPullParser parser) throws XmlPullParserException, IOException {
        ...
        if (!hasValue) {
            ...
            keyframe2 = Keyframe.ofFloat(fraction, TypedArrayUtils.getNamedFloat(a, parser, TypeSerializerImpl.VALUE_TAG, 0, 0.0f));
        } else if (valueType == 1 || valueType == 3) {
            keyframe2 = Keyframe.ofInt(fraction, TypedArrayUtils.getNamedInt(a, parser, TypeSerializerImpl.VALUE_TAG, 0, 0));
        }
