...
import android.support.p002v4.view.ViewPropertyAnimatorUpdateListener;
...
public class WindowDecorActionBar extends ActionBar implements ActionBarOverlayLayout.ActionBarVisibilityCallback {
    ...
    private void init(View decor) {
        ActionBarOverlayLayout actionBarOverlayLayout = (ActionBarOverlayLayout) decor.findViewById(C0049R.C0051id.decor_content_parent);
        this.mOverlayLayout = actionBarOverlayLayout;
        if (actionBarOverlayLayout != null) {
            actionBarOverlayLayout.setActionBarVisibilityCallback(this);
        }
        this.mDecorToolbar = getDecorToolbar(decor.findViewById(C0049R.C0051id.action_bar));
        this.mContextView = (ActionBarContextView) decor.findViewById(C0049R.C0051id.action_context_bar);
        ActionBarContainer actionBarContainer = (ActionBarContainer) decor.findViewById(C0049R.C0051id.action_bar_container);
        ...
        TypedArray a = this.mContext.obtainStyledAttributes((AttributeSet) null, C0049R.styleable.ActionBar, C0049R.attr.actionBarStyle, 0);
        if (a.getBoolean(C0049R.styleable.ActionBar_hideOnContentScroll, false)) {
            setHideOnContentScrollEnabled(true);
        }
        int elevation = a.getDimensionPixelSize(C0049R.styleable.ActionBar_elevation, 0);
        if (elevation != 0) {
    ...
    public Context getThemedContext() {
        if (this.mThemedContext == null) {
            ...
            this.mContext.getTheme().resolveAttribute(C0049R.attr.actionBarWidgetTheme, outValue, true);
