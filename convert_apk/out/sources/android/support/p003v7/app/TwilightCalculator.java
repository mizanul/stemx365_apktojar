...
class TwilightCalculator {
    ...
    /* renamed from: C1 */
    private static final float f41C1 = 0.0334196f;

    /* renamed from: C2 */
    private static final float f42C2 = 3.49066E-4f;

    /* renamed from: C3 */
    private static final float f43C3 = 5.236E-6f;
    public static final int DAY = 0;
    private static final float DEGREES_TO_RADIANS = 0.017453292f;

    /* renamed from: J0 */
    private static final float f44J0 = 9.0E-4f;
    ...
    public void calculateTwilight(long time, double latitude, double longitude) {
        ...
        double solarTransitJ2000 = ((double) (f44J0 + ((float) Math.round(((double) (daysSince2000 - f44J0)) - arcLongitude)))) + arcLongitude + (Math.sin((double) meanAnomaly) * 0.0053d) + (Math.sin(2.0d * solarLng) * -0.0069d);
