...
public abstract class ForwardingListener implements View.OnTouchListener, View.OnAttachStateChangeListener {
    ...
    public ForwardingListener(View src2) {
        this.mSrc = src2;
        src2.setLongClickable(true);
        src2.addOnAttachStateChangeListener(this);
        this.mScaledTouchSlop = (float) ViewConfiguration.get(src2.getContext()).getScaledTouchSlop();
    ...
    private boolean onTouchObserved(android.view.MotionEvent r9) {
        ...
        L_0x006f:
            return r2
        */
        throw new UnsupportedOperationException("Method not decompiled: android.support.p003v7.widget.ForwardingListener.onTouchObserved(android.view.MotionEvent):boolean");
    }
    ...
    public void onLongPress() {
        clearCallbacks();
        View src2 = this.mSrc;
        if (src2.isEnabled() && !src2.isLongClickable() && onForwardingStarted()) {
            src2.getParent().requestDisallowInterceptTouchEvent(true);
            long now = SystemClock.uptimeMillis();
            MotionEvent e = MotionEvent.obtain(now, now, 3, 0.0f, 0.0f, 0);
            src2.onTouchEvent(e);
            e.recycle();
    ...
    private boolean onTouchForwarded(MotionEvent srcEvent) {
        ...
        toGlobalMotionEvent(src2, dstEvent);
