...
public class ActivityChooserView extends ViewGroup implements ActivityChooserModel.ActivityChooserModelClient {
    ...
    public ActivityChooserView(Context context, AttributeSet attrs, int defStyle) {
        ...
        TypedArray attributesArray = context.obtainStyledAttributes(attrs, C0049R.styleable.ActivityChooserView, defStyle, 0);
        this.mInitialActivityCount = attributesArray.getInt(C0049R.styleable.ActivityChooserView_initialActivityCount, 4);
        Drawable expandActivityOverflowButtonDrawable = attributesArray.getDrawable(C0049R.styleable.ActivityChooserView_expandActivityOverflowButtonDrawable);
        attributesArray.recycle();
        LayoutInflater.from(getContext()).inflate(C0049R.layout.abc_activity_chooser_view, this, true);
        this.mCallbacks = new Callbacks();
        LinearLayoutCompat linearLayoutCompat = (LinearLayoutCompat) findViewById(C0049R.C0051id.activity_chooser_view_content);
        this.mActivityChooserContent = linearLayoutCompat;
        this.mActivityChooserContentBackground = linearLayoutCompat.getBackground();
        FrameLayout frameLayout = (FrameLayout) findViewById(C0049R.C0051id.default_activity_button);
        this.mDefaultActivityButton = frameLayout;
        frameLayout.setOnClickListener(this.mCallbacks);
        this.mDefaultActivityButton.setOnLongClickListener(this.mCallbacks);
        this.mDefaultActivityButtonImage = (ImageView) this.mDefaultActivityButton.findViewById(C0049R.C0051id.image);
        FrameLayout expandButton = (FrameLayout) findViewById(C0049R.C0051id.expand_activities_button);
        ...
        ImageView imageView = (ImageView) expandButton.findViewById(C0049R.C0051id.image);
    ...
    public void showPopupUnchecked(int maxActivityCount) {
        if (this.mAdapter.getDataModel() != null) {
            ...
            if (!popupWindow.isShowing()) {
                ...
                popupWindow.getListView().setContentDescription(getContext().getString(C0049R.C0052string.abc_activitychooserview_choose_application));
    ...
    private class ActivityChooserViewAdapter extends BaseAdapter {
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            int itemViewType = getItemViewType(position);
            if (itemViewType == 0) {
                if (convertView == null || convertView.getId() != C0049R.C0051id.list_item) {
                    convertView = LayoutInflater.from(ActivityChooserView.this.getContext()).inflate(C0049R.layout.abc_activity_chooser_view_list_item, parent, false);
                }
                PackageManager packageManager = ActivityChooserView.this.getContext().getPackageManager();
                ResolveInfo activity = (ResolveInfo) getItem(position);
                ((ImageView) convertView.findViewById(C0049R.C0051id.icon)).setImageDrawable(activity.loadIcon(packageManager));
                ((TextView) convertView.findViewById(C0049R.C0051id.title)).setText(activity.loadLabel(packageManager));
                ...
                View convertView2 = LayoutInflater.from(ActivityChooserView.this.getContext()).inflate(C0049R.layout.abc_activity_chooser_view_list_item, parent, false);
                convertView2.setId(1);
                ((TextView) convertView2.findViewById(C0049R.C0051id.title)).setText(ActivityChooserView.this.getContext().getString(C0049R.C0052string.abc_activity_chooser_view_see_all));
                return convertView2;
            }
        }
