...
final class CascadingMenuPopup extends MenuPopup implements MenuPresenter, View.OnKeyListener, PopupWindow.OnDismissListener {
    ...
    public CascadingMenuPopup(Context context, View anchor, int popupStyleAttr, int popupStyleRes, boolean overflowOnly) {
        ...
        this.mMenuMaxWidth = Math.max(res.getDisplayMetrics().widthPixels / 2, res.getDimensionPixelSize(C0049R.dimen.abc_config_prefDialogWidth));
    ...
    private void showMenu(MenuBuilder menu) {
        ...
        if (parentView != null) {
            ...
            if ((this.mDropDownGravity & 5) == 5) {
                ...
                x = parentView.getWidth() + parentOffsetLeft;
            } else {
                x = parentOffsetLeft - menuWidth;
            }
        ...
        if (parentInfo == null && this.mShowTitle && menu.getHeaderTitle() != null) {
            FrameLayout titleItemView = (FrameLayout) inflater.inflate(C0049R.layout.abc_popup_menu_header_item_layout, listView, false);
    ...
    private android.view.View findParentViewForSubmenu(android.support.p003v7.view.menu.CascadingMenuPopup.CascadingMenuInfo r11, android.support.p003v7.view.menu.MenuBuilder r12) {
        /*
            r10 = this;
