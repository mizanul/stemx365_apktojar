...
class RemoteInputCompatApi20 {
    ...
    static RemoteInputCompatBase.RemoteInput[] toCompat(RemoteInput[] srcArray, RemoteInputCompatBase.RemoteInput.Factory factory) {
        ...
        for (int i = 0; i < srcArray.length; i++) {
            RemoteInput src2 = srcArray[i];
            result[i] = factory.build(src2.getResultKey(), src2.getLabel(), src2.getChoices(), src2.getAllowFreeFormInput(), src2.getExtras(), (Set<String>) null);
        }
        return result;
    }
    ...
    static RemoteInput[] fromCompat(RemoteInputCompatBase.RemoteInput[] srcArray) {
        ...
        for (int i = 0; i < srcArray.length; i++) {
            RemoteInputCompatBase.RemoteInput src2 = srcArray[i];
            result[i] = new RemoteInput.Builder(src2.getResultKey()).setLabel(src2.getLabel()).setChoices(src2.getChoices()).setAllowFreeFormInput(src2.getAllowFreeFormInput()).addExtras(src2.getExtras()).build();
        }
        return result;
    }
