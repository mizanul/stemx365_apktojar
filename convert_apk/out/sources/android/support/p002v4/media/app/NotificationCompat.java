package android.support.p002v4.media.app;
...
import android.support.mediacompat.C0041R;
import android.support.p002v4.app.BundleCompat;
import android.support.p002v4.app.NotificationBuilderWithBuilderAccessor;
...
public class NotificationCompat {
    ...
    public static class MediaStyle extends NotificationCompat.Style {
        ...
        public static MediaSessionCompat.Token getMediaSession(Notification notification) {
            Bundle extras = android.support.p002v4.app.NotificationCompat.getExtras(notification);
            if (extras == null) {
                return null;
            }
            if (Build.VERSION.SDK_INT >= 21) {
                Object tokenInner = extras.getParcelable(android.support.p002v4.app.NotificationCompat.EXTRA_MEDIA_SESSION);
                if (tokenInner != null) {
                    return MediaSessionCompat.Token.fromToken(tokenInner);
                }
                return null;
            }
            IBinder tokenInner2 = BundleCompat.getBinder(extras, android.support.p002v4.app.NotificationCompat.EXTRA_MEDIA_SESSION);
            if (tokenInner2 == null) {
                return null;
            }
        ...
        public RemoteViews generateContentView() {
            ...
            view.removeAllViews(C0041R.C0043id.media_actions);
            if (numActionsInCompact > 0) {
                int i = 0;
                while (i < numActionsInCompact) {
                    if (i < numActions) {
                        view.addView(C0041R.C0043id.media_actions, generateMediaActionButton(this.mBuilder.mActions.get(this.mActionsToShowInCompact[i])));
                        i++;
                    } else {
            ...
            if (this.mShowCancelButton) {
                view.setViewVisibility(C0041R.C0043id.end_padder, 8);
                view.setViewVisibility(C0041R.C0043id.cancel_action, 0);
                view.setOnClickPendingIntent(C0041R.C0043id.cancel_action, this.mCancelButtonIntent);
                view.setInt(C0041R.C0043id.cancel_action, "setAlpha", this.mBuilder.mContext.getResources().getInteger(C0041R.integer.cancel_button_image_alpha));
            } else {
                view.setViewVisibility(C0041R.C0043id.end_padder, 0);
                view.setViewVisibility(C0041R.C0043id.cancel_action, 8);
            }
            return view;
        }
        ...
        private RemoteViews generateMediaActionButton(NotificationCompat.Action action) {
            ...
            RemoteViews button = new RemoteViews(this.mBuilder.mContext.getPackageName(), C0041R.layout.notification_media_action);
            button.setImageViewResource(C0041R.C0043id.action0, action.getIcon());
            if (!tombstone) {
                button.setOnClickPendingIntent(C0041R.C0043id.action0, action.getActionIntent());
            }
            if (Build.VERSION.SDK_INT >= 15) {
                button.setContentDescription(C0041R.C0043id.action0, action.getTitle());
            }
            return button;
        }
        ...
        public int getContentViewLayoutResource() {
            return C0041R.layout.notification_template_media;
        }
        ...
        public RemoteViews generateBigContentView() {
            ...
            big.removeAllViews(C0041R.C0043id.media_actions);
            if (actionCount > 0) {
                for (int i = 0; i < actionCount; i++) {
                    big.addView(C0041R.C0043id.media_actions, generateMediaActionButton(this.mBuilder.mActions.get(i)));
                }
            }
            if (this.mShowCancelButton != 0) {
                big.setViewVisibility(C0041R.C0043id.cancel_action, 0);
                big.setInt(C0041R.C0043id.cancel_action, "setAlpha", this.mBuilder.mContext.getResources().getInteger(C0041R.integer.cancel_button_image_alpha));
                big.setOnClickPendingIntent(C0041R.C0043id.cancel_action, this.mCancelButtonIntent);
            } else {
                big.setViewVisibility(C0041R.C0043id.cancel_action, 8);
            }
            return big;
        }
        ...
        public int getBigContentViewLayoutResource(int actionCount) {
            return actionCount <= 3 ? C0041R.layout.notification_template_big_media_narrow : C0041R.layout.notification_template_big_media;
        }
    }
    ...
    public static class DecoratedMediaCustomViewStyle extends MediaStyle {
        ...
        public int getContentViewLayoutResource() {
            if (this.mBuilder.getContentView() != null) {
                return C0041R.layout.notification_template_media_custom;
            }
        ...
        /* access modifiers changed from: package-private */
        public int getBigContentViewLayoutResource(int actionCount) {
            return actionCount <= 3 ? C0041R.layout.notification_template_big_media_narrow_custom : C0041R.layout.notification_template_big_media_custom;
        }
        ...
        private void setBackgroundColor(RemoteViews views) {
            ...
            if (this.mBuilder.getColor() != 0) {
                ...
                color = this.mBuilder.mContext.getResources().getColor(C0041R.color.notification_material_background_media_default_color);
            }
            views.setInt(C0041R.C0043id.status_bar_latest_event_content, "setBackgroundColor", color);
        }
    }
}
