...
public final class MimeTypeFilter {
    ...
    private static boolean mimeTypeAgainstFilter(String[] mimeTypeParts, String[] filterParts) {
        if (filterParts.length != 2) {
            ...
            if (Subscriber.TOPIC_MESSAGE_TYPE_WILDCARD.equals(filterParts[0]) || filterParts[0].equals(mimeTypeParts[0])) {
                return Subscriber.TOPIC_MESSAGE_TYPE_WILDCARD.equals(filterParts[1]) || filterParts[1].equals(mimeTypeParts[1]);
            }
            return false;
        }
    }
