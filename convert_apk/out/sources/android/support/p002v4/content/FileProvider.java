...
public class FileProvider extends ContentProvider {
    ...
    private static android.support.p002v4.content.FileProvider.PathStrategy getPathStrategy(android.content.Context r5, java.lang.String r6) {
        /*
            ...
            android.support.v4.content.FileProvider$PathStrategy r2 = (android.support.p002v4.content.FileProvider.PathStrategy) r2     // Catch:{ all -> 0x002f }
            r1 = r2
        ...
        L_0x0032:
            ...
            goto L_0x0030
        */
        throw new UnsupportedOperationException("Method not decompiled: android.support.p002v4.content.FileProvider.getPathStrategy(android.content.Context, java.lang.String):android.support.v4.content.FileProvider$PathStrategy");
    }
    ...
    private static int modeToMode(String mode) {
        ...
        if ("rw".equals(mode)) {
            return Videoio.CAP_INTELPERC_GENERATORS_MASK;
        }
        if ("rwt".equals(mode)) {
            return 1006632960;
        }
