package android.support.p002v4.text.util;

import android.os.Build;
import android.support.p002v4.util.PatternsCompat;
...
public final class LinkifyCompat {
    ...
    public static final void addLinks(TextView text, Pattern pattern, String scheme, Linkify.MatchFilter matchFilter, Linkify.TransformFilter transformFilter) {
        if (Build.VERSION.SDK_INT >= 26) {
    ...
    public static final void addLinks(TextView text, Pattern pattern, String defaultScheme, String[] schemes, Linkify.MatchFilter matchFilter, Linkify.TransformFilter transformFilter) {
        if (Build.VERSION.SDK_INT >= 26) {
    ...
    public static final boolean addLinks(Spannable spannable, Pattern pattern, String scheme, Linkify.MatchFilter matchFilter, Linkify.TransformFilter transformFilter) {
        if (Build.VERSION.SDK_INT >= 26) {
    ...
    public static final boolean addLinks(Spannable spannable, Pattern pattern, String defaultScheme, String[] schemes, Linkify.MatchFilter matchFilter, Linkify.TransformFilter transformFilter) {
        if (Build.VERSION.SDK_INT >= 26) {
            ...
            try {
                ...
                if (findAddress != null) {
                    ...
                    if (start >= 0) {
                        ...
                        base += end;
                        try {
                            String encodedAddress = URLEncoder.encode(address, XmlRpcStreamConfig.UTF8_ENCODING);
