...
public class ConstraintSet {
    ...
    static {
        ...
        mapToConstant.append(C0019R.styleable.ConstraintSet_layout_constraintLeft_creator, 60);
        mapToConstant.append(C0019R.styleable.ConstraintSet_layout_constraintTop_creator, 60);
        mapToConstant.append(C0019R.styleable.ConstraintSet_layout_constraintRight_creator, 60);
        mapToConstant.append(C0019R.styleable.ConstraintSet_layout_constraintBottom_creator, 60);
        mapToConstant.append(C0019R.styleable.ConstraintSet_layout_constraintBaseline_creator, 60);
    ...
    private Constraint fillFromAttributeList(Context context, AttributeSet attrs) {
        ...
        TypedArray a = context.obtainStyledAttributes(attrs, C0019R.styleable.ConstraintSet);
