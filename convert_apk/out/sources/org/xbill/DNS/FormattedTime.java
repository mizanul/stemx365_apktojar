...
final class FormattedTime {
    ...
    /* renamed from: w2 */
    private static NumberFormat f206w2;

    /* renamed from: w4 */
    private static NumberFormat f207w4;

    static {
        DecimalFormat decimalFormat = new DecimalFormat();
        f206w2 = decimalFormat;
        decimalFormat.setMinimumIntegerDigits(2);
        DecimalFormat decimalFormat2 = new DecimalFormat();
        f207w4 = decimalFormat2;
        decimalFormat2.setMinimumIntegerDigits(4);
        f207w4.setGroupingUsed(false);
    }
    ...
    public static String format(Date date) {
        ...
        c.setTime(date);
        sb.append(f207w4.format((long) c.get(1)));
        sb.append(f206w2.format((long) (c.get(2) + 1)));
        sb.append(f206w2.format((long) c.get(5)));
        sb.append(f206w2.format((long) c.get(11)));
        sb.append(f206w2.format((long) c.get(12)));
        sb.append(f206w2.format((long) c.get(13)));
        return sb.toString();
    }
