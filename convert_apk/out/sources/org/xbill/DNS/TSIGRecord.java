...
public class TSIGRecord extends Record {
    ...
    public String rrToString() {
        ...
        if (Options.check("multiline")) {
            ...
            sb.append(C1114base64.formatString(this.signature, 64, "\t", false));
        } else {
            sb.append(" ");
            sb.append(C1114base64.toString(this.signature));
        }
        sb.append(" ");
        ...
        if (bArr == null) {
            ...
            if (this.error == 18) {
                ...
                if (bArr2.length != 6) {
                    ...
                    sb.append(new Date(1000 * ((((long) (bArr2[0] & 255)) << 40) + (((long) (bArr2[1] & 255)) << 32) + ((long) ((bArr2[2] & 255) << Ascii.CAN)) + ((long) ((bArr2[3] & 255) << 16)) + ((long) ((bArr2[4] & 255) << 8)) + ((long) (bArr2[5] & 255)))));
                    sb.append(">");
                }
            } else {
                sb.append("<");
                sb.append(C1114base64.toString(this.other));
                sb.append(">");
            }
        }
        if (Options.check("multiline")) {
