...
public class HeaderTest extends TestCase {
    ...
    public void test_ctor_0arg() {
        ...
        this.m_h = header;
        assertTrue(header.getID() >= 0 && this.m_h.getID() < 65535);
        boolean[] flags = this.m_h.getFlags();
        for (boolean assertFalse : flags) {
            assertFalse(assertFalse);
        }
    ...
    public void test_ctor_DNSInput() throws IOException {
        Header header = new Header(new DNSInput(new byte[]{18, -85, -113, -67, 101, Ascii.f49FS, 16, -16, -104, -70, 113, -112}));
        this.m_h = header;
        assertEquals(4779, header.getID());
        boolean[] flags = this.m_h.getFlags();
        assertTrue(flags[0]);
    ...
    public void test_toWire() throws IOException {
        byte[] raw = {18, -85, -113, -67, 101, Ascii.f49FS, 16, -16, -104, -70, 113, -112};
        ...
        for (int i2 = 0; i2 < out2.length; i2++) {
            ...
            assertEquals(stringBuffer.toString(), raw[i2], out2[i2]);
        }
    }
