...
public class MnemonicTest extends TestCase {
    ...
    public void setUp() {
        ...
        Class cls = class$org$xbill$DNS$MnemonicTest;
        if (cls == null) {
    ...
    public void test_basic_operation_lower() {
        ...
        Mnemonic mnemonic = new Mnemonic(stringBuffer.toString(), 3);
        this.m_mn = mnemonic;
        mnemonic.add(10, "Ten");
        this.m_mn.add(20, "Twenty");
        this.m_mn.addAlias(20, "Veinte");
    ...
    public void test_basic_operation_sensitive() {
        ...
        Mnemonic mnemonic = new Mnemonic(stringBuffer.toString(), 1);
        this.m_mn = mnemonic;
        mnemonic.add(10, "Ten");
        this.m_mn.add(20, "Twenty");
        this.m_mn.addAlias(20, "Veinte");
