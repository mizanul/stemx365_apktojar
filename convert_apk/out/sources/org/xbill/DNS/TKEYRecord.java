...
public class TKEYRecord extends Record {
    ...
    public String rrToString() {
        ...
        if (Options.check("multiline")) {
            ...
            byte[] bArr = this.key;
            if (bArr != null) {
                sb.append(C1114base64.formatString(bArr, 64, "\t", false));
                sb.append(Base64.LINE_SEPARATOR);
            }
            byte[] bArr2 = this.other;
            if (bArr2 != null) {
                sb.append(C1114base64.formatString(bArr2, 64, "\t", false));
            }
            sb.append(" )");
        } else {
            sb.append(" ");
            byte[] bArr3 = this.key;
            if (bArr3 != null) {
                sb.append(C1114base64.toString(bArr3));
                sb.append(" ");
            }
            byte[] bArr4 = this.other;
            if (bArr4 != null) {
                sb.append(C1114base64.toString(bArr4));
            }
        }
        return sb.toString();
    }
