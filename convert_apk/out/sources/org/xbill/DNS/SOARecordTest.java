...
public class SOARecordTest {
    ...
    public static class Test_rrFromWire extends TestCase {
        ...
        public void test() throws IOException {
            DNSInput di = new DNSInput(new byte[]{1, 109, 1, 104, 1, 110, 0, 1, 109, 1, 97, 1, 110, 0, -85, -51, -17, 18, -51, -17, 18, 52, -17, 18, 52, 86, 18, 52, 86, 120, 52, 86, 120, -102});
            SOARecord ar = new SOARecord();
            ar.rrFromWire(di);
            assertEquals(this.m_host, ar.getHost());
            assertEquals(this.m_admin, ar.getAdmin());
    ...
    public static class Test_rrToWire extends TestCase {
        ...
        public void test_canonical() {
            ...
            assertTrue(Arrays.equals(new byte[]{1, 109, 1, 104, 1, 110, 0, 1, 109, 1, 97, 1, 110, 0, -85, -51, -17, 18, -51, -17, 18, 52, -17, 18, 52, 86, 18, 52, 86, 120, 52, 86, 120, -102}, o.toByteArray()));
        }
        ...
        public void test_case_sensitive() {
            ...
            assertTrue(Arrays.equals(new byte[]{1, 77, 1, 104, 1, 78, 0, 1, 77, 1, 97, 1, 110, 0, -85, -51, -17, 18, -51, -17, 18, 52, -17, 18, 52, 86, 18, 52, 86, 120, 52, 86, 120, -102}, o.toByteArray()));
        }
    }
