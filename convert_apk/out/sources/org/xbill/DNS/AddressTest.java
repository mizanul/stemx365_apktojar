...
public class AddressTest extends TestCase {
    ...
    public void test_toByteArray_IPv6() {
        byte[] exp = {32, 1, 13, -72, -123, -93, 8, -45, 19, Ascii.f47EM, -118, 46, 3, 112, 115, 52};
        ...
        byte[] exp2 = {32, 1, 13, -72, 0, 0, 8, -45, 19, Ascii.f47EM, -118, 46, 3, 112, 115, 52};
        ...
        byte[] exp3 = {0, 0, 0, 0, -123, -93, 8, -45, 19, Ascii.f47EM, -118, 46, 3, 112, 115, 52};
        ...
        byte[] exp4 = {32, 1, 13, -72, -123, -93, 8, -45, 19, Ascii.f47EM, -118, 46, 0, 0, 0, 0};
        ...
        assertEquals(new byte[]{32, 1, 13, -72, -123, -93, 8, -45, 19, Ascii.f47EM, -118, 46, -64, -88, 89, 9}, Address.toByteArray("2001:0db8:85a3:08d3:1319:8a2e:192.168.89.9", 2));
    ...
    public void test_getAllByName() throws UnknownHostException {
        ...
        assertTrue(z);
        for (InetAddress hostName : out3) {
            assertTrue(hostName.getHostName().endsWith("cnn.com"));
        }
    }
