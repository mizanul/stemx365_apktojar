...
public class RRsetTest extends TestCase {
    ...
    public void test_addRR_invalidName() throws TextParseException, UnknownHostException {
        this.m_rs.addRR(this.m_a1);
        ARecord aRecord = new ARecord(this.m_name2, 1, this.m_ttl, InetAddress.getByName("192.169.232.11"));
        this.m_a2 = aRecord;
        try {
            this.m_rs.addRR(aRecord);
            fail("IllegalArgumentException not thrown");
        } catch (IllegalArgumentException e) {
        }
    }
    ...
    public void test_addRR_invalidDClass() throws TextParseException, UnknownHostException {
        this.m_rs.addRR(this.m_a1);
        ARecord aRecord = new ARecord(this.m_name, 3, this.m_ttl, InetAddress.getByName("192.169.232.11"));
        this.m_a2 = aRecord;
        try {
            this.m_rs.addRR(aRecord);
            fail("IllegalArgumentException not thrown");
