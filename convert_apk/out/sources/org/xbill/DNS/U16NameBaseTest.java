...
public class U16NameBaseTest extends TestCase {
    ...
    public void test_rrFromWire() throws IOException {
        DNSInput in = new DNSInput(new byte[]{-68, Ascii.f58US, 2, 77, 121, 6, 115, 105, 78, 103, 108, 69, 4, 110, 65, 109, 69, 0});
        TestClass tc = new TestClass();
        tc.rrFromWire(in);
    ...
    public void test_rrToWire() throws IOException, TextParseException {
        ...
        assertTrue(Arrays.equals(new byte[]{Ascii.f58US, 43, 1, 109, 1, 111, 1, 110, 0}, dout.toByteArray()));
        DNSOutput dout2 = new DNSOutput();
        tc.rrToWire(dout2, (Compression) null, false);
        assertTrue(Arrays.equals(new byte[]{Ascii.f58US, 43, 1, 77, 1, 79, 1, 110, 0}, dout2.toByteArray()));
    }
}
