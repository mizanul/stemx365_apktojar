...
public class RRset implements Serializable {
    ...
    public synchronized void addRR(org.xbill.DNS.Record r6) {
        /*
            r5 = this;
            monitor-enter(r5)
            java.util.List r0 = r5.rrs     // Catch:{ all -> 0x0078 }
            int r0 = r0.size()     // Catch:{ all -> 0x0078 }
            if (r0 != 0) goto L_0x000e
            r5.safeAddRR(r6)     // Catch:{ all -> 0x0078 }
            monitor-exit(r5)
            return
        L_0x000e:
            org.xbill.DNS.Record r0 = r5.first()     // Catch:{ all -> 0x0078 }
            boolean r1 = r6.sameRRset(r0)     // Catch:{ all -> 0x0078 }
            if (r1 == 0) goto L_0x0070
            long r1 = r6.getTTL()     // Catch:{ all -> 0x0078 }
            long r3 = r0.getTTL()     // Catch:{ all -> 0x0078 }
            ...
            org.xbill.DNS.Record r1 = r6.cloneRecord()     // Catch:{ all -> 0x0078 }
            r6 = r1
            long r1 = r0.getTTL()     // Catch:{ all -> 0x0078 }
            r6.setTTL(r1)     // Catch:{ all -> 0x0078 }
            goto L_0x0063
        L_0x003d:
            r1 = 0
        L_0x003e:
            java.util.List r2 = r5.rrs     // Catch:{ all -> 0x0078 }
            int r2 = r2.size()     // Catch:{ all -> 0x0078 }
            if (r1 >= r2) goto L_0x0063
            java.util.List r2 = r5.rrs     // Catch:{ all -> 0x0078 }
            java.lang.Object r2 = r2.get(r1)     // Catch:{ all -> 0x0078 }
            org.xbill.DNS.Record r2 = (org.xbill.DNS.Record) r2     // Catch:{ all -> 0x0078 }
            org.xbill.DNS.Record r3 = r2.cloneRecord()     // Catch:{ all -> 0x0078 }
            r2 = r3
            long r3 = r6.getTTL()     // Catch:{ all -> 0x0078 }
            r2.setTTL(r3)     // Catch:{ all -> 0x0078 }
            java.util.List r3 = r5.rrs     // Catch:{ all -> 0x0078 }
            r3.set(r1, r2)     // Catch:{ all -> 0x0078 }
            int r1 = r1 + 1
            goto L_0x003e
        L_0x0063:
            java.util.List r1 = r5.rrs     // Catch:{ all -> 0x0078 }
            boolean r1 = r1.contains(r6)     // Catch:{ all -> 0x0078 }
