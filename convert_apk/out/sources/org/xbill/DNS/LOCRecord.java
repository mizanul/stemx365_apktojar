...
public class LOCRecord extends Record {
    ...
    /* renamed from: w2 */
    private static NumberFormat f210w2;

    /* renamed from: w3 */
    private static NumberFormat f211w3;
    ...
    static {
        ...
        f210w2 = decimalFormat;
        decimalFormat.setMinimumIntegerDigits(2);
        DecimalFormat decimalFormat2 = new DecimalFormat();
        f211w3 = decimalFormat2;
    ...
    private String positionToString(long value, char pos, char neg) {
        ...
        sb.append(" ");
        renderFixedPoint(sb, f211w3, temp3, 1000);
        sb.append(" ");
        sb.append(direction);
        return sb.toString();
    }
    ...
    public String rrToString() {
        ...
        renderFixedPoint(stringBuffer, f210w2, this.altitude - 10000000, 100);
        sb.append("m ");
        renderFixedPoint(stringBuffer, f210w2, this.size, 100);
        sb.append("m ");
        renderFixedPoint(stringBuffer, f210w2, this.hPrecision, 100);
        sb.append("m ");
        renderFixedPoint(stringBuffer, f210w2, this.vPrecision, 100);
        sb.append("m");
        return sb.toString();
    }
