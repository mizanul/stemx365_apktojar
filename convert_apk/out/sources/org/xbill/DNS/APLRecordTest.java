...
public class APLRecordTest {
    ...
    public static class Test_init extends TestCase {
        ...
        public void setUp() throws TextParseException, UnknownHostException {
            ...
            InetAddress byName = InetAddress.getByName("193.160.232.5");
            this.m_addr4 = byName;
            this.m_addr4_bytes = byName.getAddress();
            this.m_addr6_string = "2001:db8:85a3:8d3:1319:8a2e:370:7334";
            InetAddress byName2 = InetAddress.getByName("2001:db8:85a3:8d3:1319:8a2e:370:7334");
            this.m_addr6 = byName2;
            this.m_addr6_bytes = byName2.getAddress();
    ...
    public static class Test_rrFromWire extends TestCase {
        ...
        public void test_validIPv4() throws IOException {
            byte[] bArr = this.m_addr4_bytes;
            DNSInput di = new DNSInput(new byte[]{0, 1, 8, -124, bArr[0], bArr[1], bArr[2], bArr[3]});
            APLRecord ar = new APLRecord();
            ar.rrFromWire(di);
        ...
        public void test_validIPv4_short_address() throws IOException {
            byte[] bArr = this.m_addr4_bytes;
            DNSInput di = new DNSInput(new byte[]{0, 1, Ascii.DC4, -125, bArr[0], bArr[1], bArr[2]});
            APLRecord ar = new APLRecord();
            ar.rrFromWire(di);
        ...
        public void test_invalid_IPv4_prefix() throws IOException {
            byte[] bArr = this.m_addr4_bytes;
            try {
                new APLRecord().rrFromWire(new DNSInput(new byte[]{0, 1, 33, -124, bArr[0], bArr[1], bArr[2], bArr[3]}));
        ...
        public void test_invalid_IPv4_length() throws IOException {
            byte[] bArr = this.m_addr4_bytes;
            try {
                new APLRecord().rrFromWire(new DNSInput(new byte[]{0, 1, 8, -123, bArr[0], bArr[1], bArr[2], bArr[3], 10}));
                fail("WireParseException not thrown");
            } catch (WireParseException e) {
            }
        }
        ...
        public void test_multiple_validIPv4() throws IOException {
            byte[] bArr = this.m_addr4_bytes;
            DNSInput di = new DNSInput(new byte[]{0, 1, 8, -124, bArr[0], bArr[1], bArr[2], bArr[3], 0, 1, Ascii.f54RS, 4, bArr[0], bArr[1], bArr[2], bArr[3]});
            APLRecord ar = new APLRecord();
            ar.rrFromWire(di);
            ArrayList exp = new ArrayList();
            exp.add(new APLRecord.Element(true, this.m_addr4, 8));
        ...
        public void test_validIPv6() throws IOException {
            byte[] bArr = this.m_addr6_bytes;
            DNSInput di = new DNSInput(new byte[]{0, 2, 115, 16, bArr[0], bArr[1], bArr[2], bArr[3], bArr[4], bArr[5], bArr[6], bArr[7], bArr[8], bArr[9], bArr[10], bArr[11], bArr[12], bArr[13], bArr[14], bArr[15]});
            APLRecord ar = new APLRecord();
            ar.rrFromWire(di);
            ArrayList exp = new ArrayList();
    ...
    public static class Test_rrToWire extends TestCase {
        ...
        public void test_basic() {
            APLRecord ar = new APLRecord(this.m_an, 1, this.m_ttl, this.m_elements);
            byte[] bArr = this.m_addr4_bytes;
            byte[] bArr2 = this.m_addr6_bytes;
            byte[] exp = {0, 1, 12, -124, bArr[0], bArr[1], bArr[2], bArr[3], 0, 2, SignedBytes.MAX_POWER_OF_TWO, 16, bArr2[0], bArr2[1], bArr2[2], bArr2[3], bArr2[4], bArr2[5], bArr2[6], bArr2[7], bArr2[8], bArr2[9], bArr2[10], bArr2[11], bArr2[12], bArr2[13], bArr2[14], bArr2[15]};
            DNSOutput dout = new DNSOutput();
            ar.rrToWire(dout, (Compression) null, true);
        ...
        public void test_address_with_embedded_zero() throws UnknownHostException {
            ...
            byte[] exp = {0, 1, Ascii.f58US, -124, -24, 0, 11, 1};
            DNSOutput dout = new DNSOutput();
            ar.rrToWire(dout, (Compression) null, true);
            assertTrue(Arrays.equals(exp, dout.toByteArray()));
        }
        ...
        public void test_short_address() throws UnknownHostException {
            ...
            elements.add(new APLRecord.Element(true, a, 31));
            APLRecord ar = new APLRecord(this.m_an, 1, this.m_ttl, elements);
            byte[] exp = {0, 1, Ascii.f58US, -125, -24, 0, 11};
            DNSOutput dout = new DNSOutput();
            ar.rrToWire(dout, (Compression) null, true);
            assertTrue(Arrays.equals(exp, dout.toByteArray()));
        }
        ...
        public void test_wildcard_address() throws UnknownHostException {
            ...
            elements.add(new APLRecord.Element(true, a, 31));
            APLRecord ar = new APLRecord(this.m_an, 1, this.m_ttl, elements);
            byte[] exp = {0, 1, Ascii.f58US, Byte.MIN_VALUE};
            DNSOutput dout = new DNSOutput();
            ar.rrToWire(dout, (Compression) null, true);
            assertTrue(Arrays.equals(exp, dout.toByteArray()));
        }
