...
public class RecordTest extends TestCase {
    ...
    public void test_byteArrayFromString() throws TextParseException {
        ...
        assertTrue(Arrays.equals(new byte[]{32, Ascii.f58US, 65, 97, HttpConstants.SEMICOLON, HttpConstants.DOUBLE_QUOTE, 92, 126, Byte.MAX_VALUE, -1}, SubRecord.byteArrayFromString(" \\031Aa\\;\\\"\\\\~\\127\\255")));
    }
    ...
    public void test_byteArrayToString() {
        assertEquals("\" \\031Aa;\\\"\\\\~\\127\\255\"", SubRecord.byteArrayToString(new byte[]{32, Ascii.f58US, 65, 97, HttpConstants.SEMICOLON, HttpConstants.DOUBLE_QUOTE, 92, 126, Byte.MAX_VALUE, -1}, true));
    }

    public void test_unknownToString() {
        byte[] data = {18, 52, 86, 120, -102, -68, -34, -1};
    ...
    public void test_cloneRecord() throws TextParseException {
        Name n = Name.fromString("My.N.");
        Record r = Record.newRecord(n, 1, 1, 11259369, new byte[]{Ascii.ETB, 12, 9, -127});
    ...
    public void test_compareTo() throws TextParseException {
        ...
        Name m = Name.fromString("My.M.");
        byte[] d = {Ascii.ETB, 12, 9, -127};
        byte[] d2 = {Ascii.ETB, 12, 9, Byte.MIN_VALUE};
