...
public class NameTest extends TestCase {
    ...
    public static class Test_String_init extends TestCase {
        ...
        public void test_ctor_wildcard() throws TextParseException {
            Name n = new Name(Subscriber.TOPIC_MESSAGE_TYPE_WILDCARD);
            assertFalse(n.isAbsolute());
            assertTrue(n.isWild());
            assertEquals(1, n.labels());
            assertEquals(2, n.length());
            assertTrue(Arrays.equals(new byte[]{1, 42}, n.getLabel(0)));
            assertEquals(Subscriber.TOPIC_MESSAGE_TYPE_WILDCARD, n.getLabelString(0));
        }
    ...
    public void test_toString_special_char() throws TextParseException, WireParseException {
        assertEquals("\\\".\\(.\\).\\..\\;.\\\\.\\@.\\$.", new Name(new DNSInput(new byte[]{1, HttpConstants.DOUBLE_QUOTE, 1, 40, 1, 41, 1, 46, 1, HttpConstants.SEMICOLON, 1, 92, 1, SignedBytes.MAX_POWER_OF_TWO, 1, 36, 0})).toString());
    }
