...
public class GPOSRecordTest extends TestCase {
    ...
    public static class Test_rrFromWire extends TestCase {
        public void test_basic() throws IOException {
            ...
            assertEquals(new Double(0.0d), new Double(gr.getAltitude()));
        }
    ...
    public static Test suite() {
        ...
        Class cls = class$org$xbill$DNS$GPOSRecordTest$Test_Ctor_6arg_doubles;
        if (cls == null) {
        ...
        s.addTestSuite(cls);
        Class cls2 = class$org$xbill$DNS$GPOSRecordTest$Test_Ctor_6arg_Strings;
        if (cls2 == null) {
