...
public class DSRecordTest extends TestCase {
    ...
    public void test_rrFromWire() throws IOException {
        DNSInput in = new DNSInput(new byte[]{-85, -51, -17, 1, 35, 69, 103, -119});
        DSRecord dr = new DSRecord();
        dr.rrFromWire(in);
        assertEquals(43981, dr.getFootprint());
        assertEquals(239, dr.getAlgorithm());
        assertEquals(1, dr.getDigestID());
        assertTrue(Arrays.equals(new byte[]{35, 69, 103, -119}, dr.getDigest()));
    }
    ...
    public void test_rdataFromString() throws IOException {
        ...
        assertEquals(239, dr.getAlgorithm());
        assertEquals(1, dr.getDigestID());
        assertTrue(Arrays.equals(new byte[]{35, 69, 103, -119, -85}, dr.getDigest()));
    }

    public void test_rrToString() throws TextParseException {
        assertEquals("43981 239 1 23456789AB", new DSRecord(Name.fromString("The.Name."), 1, 291, 43981, 239, 1, new byte[]{35, 69, 103, -119, -85}).rrToString());
    }

    public void test_rrToWire() throws TextParseException {
        DSRecord dr = new DSRecord(Name.fromString("The.Name."), 1, 291, 43981, 239, 1, new byte[]{35, 69, 103, -119, -85});
        DNSOutput out = new DNSOutput();
        dr.rrToWire(out, (Compression) null, true);
        assertTrue(Arrays.equals(new byte[]{-85, -51, -17, 1, 35, 69, 103, -119, -85}, out.toByteArray()));
    }

    public static Test suite() {
        TestSuite s = new TestSuite();
        Class cls = class$org$xbill$DNS$DSRecordTest$Test_Ctor_7arg;
        if (cls == null) {
            cls = class$("org.xbill.DNS.DSRecordTest$Test_Ctor_7arg");
            class$org$xbill$DNS$DSRecordTest$Test_Ctor_7arg = cls;
        }
        s.addTestSuite(cls);
        Class cls2 = class$org$xbill$DNS$DSRecordTest;
        if (cls2 == null) {
