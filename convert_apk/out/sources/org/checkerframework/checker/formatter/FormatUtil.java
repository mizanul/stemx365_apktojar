...
public class FormatUtil {
    ...
    public static void tryFormatSatisfiability(String format) throws IllegalFormatException {
        String format2 = String.format(format, (Object[]) null);
    }
    ...
    public static class ExcessiveOrMissingFormatArgumentException extends MissingFormatArgumentException {
        ...
        public String getMessage() {
            return String.format("Expected %d arguments but found %d.", new Object[]{Integer.valueOf(this.expected), Integer.valueOf(this.found)});
        }
    }
