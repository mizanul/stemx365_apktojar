...
public class DynamicChannelBuffer extends AbstractChannelBuffer {
    ...
    public void setBytes(int index, byte[] src2, int srcIndex, int length) {
        this.buffer.setBytes(index, src2, srcIndex, length);
    }
    ...
    public void setBytes(int index, ByteBuffer src2) {
        this.buffer.setBytes(index, src2);
    }
    ...
    public void writeBytes(byte[] src2, int srcIndex, int length) {
        ...
        super.writeBytes(src2, srcIndex, length);
    }
    ...
    public void writeBytes(ByteBuffer src2) {
        ensureWritableBytes(src2.remaining());
        super.writeBytes(src2);
    }
