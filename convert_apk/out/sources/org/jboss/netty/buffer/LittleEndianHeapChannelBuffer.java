...
public class LittleEndianHeapChannelBuffer extends HeapChannelBuffer {
    ...
    public int getUnsignedMedium(int index) {
        return ((this.array[index] & 255) << 0) | ((this.array[index + 1] & 255) << 8) | ((this.array[index + 2] & 255) << 16);
    }

    public int getInt(int index) {
        return ((this.array[index] & 255) << 0) | ((this.array[index + 1] & 255) << 8) | ((this.array[index + 2] & 255) << 16) | ((this.array[index + 3] & 255) << Ascii.CAN);
    }
