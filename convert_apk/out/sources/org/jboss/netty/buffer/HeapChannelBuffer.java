...
public abstract class HeapChannelBuffer extends AbstractChannelBuffer {
    ...
    public HeapChannelBuffer(byte[] array2) {
    ...
    public void setBytes(int index, ChannelBuffer src2, int srcIndex, int length) {
        if (src2 instanceof HeapChannelBuffer) {
            setBytes(index, ((HeapChannelBuffer) src2).array, srcIndex, length);
        } else {
            src2.getBytes(srcIndex, this.array, index, length);
        }
    }

    public void setBytes(int index, byte[] src2, int srcIndex, int length) {
        System.arraycopy(src2, srcIndex, this.array, index, length);
    }

    public void setBytes(int index, ByteBuffer src2) {
        src2.get(this.array, index, src2.remaining());
    }
