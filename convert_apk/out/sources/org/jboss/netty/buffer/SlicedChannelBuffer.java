...
public class SlicedChannelBuffer extends AbstractChannelBuffer implements WrappedChannelBuffer {
    ...
    public void setBytes(int index, byte[] src2, int srcIndex, int length2) {
        checkIndex(index, length2);
        this.buffer.setBytes(this.adjustment + index, src2, srcIndex, length2);
    }

    public void setBytes(int index, ChannelBuffer src2, int srcIndex, int length2) {
        checkIndex(index, length2);
        this.buffer.setBytes(this.adjustment + index, src2, srcIndex, length2);
    }

    public void setBytes(int index, ByteBuffer src2) {
        checkIndex(index, src2.remaining());
        this.buffer.setBytes(this.adjustment + index, src2);
    }
