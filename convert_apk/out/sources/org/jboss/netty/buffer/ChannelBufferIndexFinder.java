...
public interface ChannelBufferIndexFinder {
    ...
    /* renamed from: CR */
    public static final ChannelBufferIndexFinder f115CR = new ChannelBufferIndexFinder() {
    ...
    /* renamed from: LF */
    public static final ChannelBufferIndexFinder f116LF = new ChannelBufferIndexFinder() {
        public boolean find(ChannelBuffer buffer, int guessedIndex) {
