...
public class TrafficCounter {
    ...
    public void start() {
        /*
            ...
            monitor-enter(r0)
            java.util.concurrent.atomic.AtomicBoolean r1 = r6.monitorActive     // Catch:{ all -> 0x0043 }
            boolean r1 = r1.get()     // Catch:{ all -> 0x0043 }
            if (r1 == 0) goto L_0x000d
            monitor-exit(r0)     // Catch:{ all -> 0x0043 }
            return
        L_0x000d:
            java.util.concurrent.atomic.AtomicLong r1 = r6.lastTime     // Catch:{ all -> 0x0043 }
            long r2 = java.lang.System.currentTimeMillis()     // Catch:{ all -> 0x0043 }
            r1.set(r2)     // Catch:{ all -> 0x0043 }
            java.util.concurrent.atomic.AtomicLong r1 = r6.checkInterval     // Catch:{ all -> 0x0043 }
            long r1 = r1.get()     // Catch:{ all -> 0x0043 }
            r3 = 0
            ...
            r2 = 1
            r1.set(r2)     // Catch:{ all -> 0x0043 }
            org.jboss.netty.handler.traffic.TrafficCounter$TrafficMonitoringTask r1 = new org.jboss.netty.handler.traffic.TrafficCounter$TrafficMonitoringTask     // Catch:{ all -> 0x0043 }
            org.jboss.netty.handler.traffic.AbstractTrafficShapingHandler r2 = r6.trafficShapingHandler     // Catch:{ all -> 0x0043 }
            r1.<init>(r2, r6)     // Catch:{ all -> 0x0043 }
            r6.timerTask = r1     // Catch:{ all -> 0x0043 }
            org.jboss.netty.util.Timer r2 = r6.timer     // Catch:{ all -> 0x0043 }
            java.util.concurrent.atomic.AtomicLong r3 = r6.checkInterval     // Catch:{ all -> 0x0043 }
            long r3 = r3.get()     // Catch:{ all -> 0x0043 }
            java.util.concurrent.TimeUnit r5 = java.util.concurrent.TimeUnit.MILLISECONDS     // Catch:{ all -> 0x0043 }
            org.jboss.netty.util.Timeout r1 = r2.newTimeout(r1, r3, r5)     // Catch:{ all -> 0x0043 }
            r6.timeout = r1     // Catch:{ all -> 0x0043 }
        L_0x0041:
            monitor-exit(r0)     // Catch:{ all -> 0x0043 }
            return
        L_0x0043:
    ...
    public void resetAccounting(long newLastTime) {
        synchronized (this.lastTime) {
            ...
            if (interval != 0) {
                ...
                long andSet = this.currentWrittenBytes.getAndSet(0);
                this.lastWrittenBytes = andSet;
                this.lastReadThroughput = (this.lastReadBytes / interval) * 1000;
                this.lastWriteThroughput = (andSet / interval) * 1000;
            }
        }
    }
