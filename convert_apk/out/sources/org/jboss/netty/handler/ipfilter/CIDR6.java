...
public class CIDR6 extends CIDR {
    ...
    protected CIDR6(Inet6Address newaddress, int newmask) {
        ...
        try {
            BigInteger and = this.addressBigInt.and(ipv6CidrMaskToMask(newmask));
            this.addressBigInt = and;
            this.baseAddress = bigIntToIPv6Address(and);
    ...
    public int compareTo(CIDR arg) {
        if (arg instanceof CIDR4) {
            ...
            return arg.cidrMask < this.cidrMask ? -1 : 1;
        }
        CIDR6 o = (CIDR6) arg;
        ...
        if (res2 == 0) {
            return o.cidrMask < this.cidrMask ? -1 : 1;
        }
        return res2;
    }
