...
public abstract class AbstractMemoryHttpData extends AbstractHttpData {
        ...
        if (buffer != null) {
            ...
            if (this.definedSize <= 0 || this.definedSize >= this.size + localsize) {
                ...
                if (channelBuffer2 == null) {
                    ...
                    this.channelBuffer = ChannelBuffers.wrappedBuffer(channelBuffer2, buffer);
                }
            } else {
    ...
    public byte[] get() {
        ...
        byte[] array = new byte[channelBuffer2.readableBytes()];
        ChannelBuffer channelBuffer3 = this.channelBuffer;
        channelBuffer3.getBytes(channelBuffer3.readerIndex(), array);
        return array;
    }
    ...
    public String getString(Charset encoding) {
        ...
        return channelBuffer2.toString(encoding);
    }
    ...
    public ChannelBuffer getChunk(int length) throws IOException {
        ChannelBuffer channelBuffer2 = this.channelBuffer;
        if (channelBuffer2 == null || length == 0 || channelBuffer2.readableBytes() == 0) {
    ...
    public boolean renameTo(File dest) throws IOException {
        if (dest != null) {
            ...
            int length = channelBuffer2.readableBytes();
