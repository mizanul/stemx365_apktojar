...
public class HttpHeaders {
    ...
    public static final class Names {
        ...
        /* renamed from: TE */
        public static final String f132TE = "TE";
    ...
    /* renamed from: eq */
    private static boolean m160eq(String name1, String name2) {
    ...
    private void removeHeader0(int h, int i, String name) {
        ...
        if (e != null) {
            while (e.hash == h && m160eq(name, e.key)) {
                e.remove();
                Entry next = e.next;
                if (next != null) {
                    this.entries[i] = next;
            ...
            while (true) {
                Entry next2 = e.next;
                if (next2 != null) {
                    if (next2.hash != h || !m160eq(name, next2.key)) {
                        e = next2;
                    } else {
                        e.next = next2.next;
                        next2.remove();
