...
public class WebSocketClientHandshaker00 extends WebSocketClientHandshaker {
    ...
    public WebSocketClientHandshaker00(URI webSocketURL, WebSocketVersion version, String subprotocol, Map<String, String> customHeaders) {
        this(webSocketURL, version, subprotocol, customHeaders, LongCompanionObject.MAX_VALUE);
    }
    ...
    private static String insertRandomCharacters(String key) {
        ...
        for (int i = 0; i < count; i++) {
            ...
            key = key.substring(0, split) + randomChars[i] + key.substring(split);
        }
        return key;
    }
    ...
    private static String insertSpaces(String key, int spaces) {
        for (int i = 0; i < spaces; i++) {
            ...
            key = key.substring(0, split) + " " + key.substring(split);
        }
        return key;
    }
}
