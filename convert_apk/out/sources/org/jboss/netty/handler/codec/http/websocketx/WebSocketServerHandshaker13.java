...
public class WebSocketServerHandshaker13 extends WebSocketServerHandshaker {
    ...
    public WebSocketServerHandshaker13(String webSocketURL, String subprotocols, boolean allowExtensions2) {
        this(webSocketURL, subprotocols, allowExtensions2, LongCompanionObject.MAX_VALUE);
    }
    ...
    public ChannelFuture handshake(Channel channel, HttpRequest req) {
        ...
        if (key != null) {
            try {
                ...
                byte[] bArr = sha1;
                p.replace(HttpRequestDecoder.class, "wsdecoder", (ChannelHandler) new WebSocket13FrameDecoder(true, this.allowExtensions, getMaxFramePayloadLength()));
                p.replace(HttpResponseEncoder.class, "wsencoder", (ChannelHandler) new WebSocket13FrameEncoder(false));
                return future;
