...
public class SpdySessionHandler extends SimpleChannelUpstreamHandler implements ChannelDownstreamHandler {
    ...
    public void handleDownstream(ChannelHandlerContext ctx, ChannelEvent evt) throws Exception {
        ...
        if (evt instanceof ChannelStateEvent) {
            ...
            int i = C08895.$SwitchMap$org$jboss$netty$channel$ChannelState[e.getState().ordinal()];
    ...
    private void sendGoAwayFrame(ChannelHandlerContext ctx, ChannelStateEvent e) {
        ...
        ChannelFuture future = sendGoAwayFrame(ctx, e.getChannel(), (SocketAddress) null, SpdySessionStatus.f145OK);
    ...
    private static final class ClosingChannelFutureListener implements ChannelFutureListener {
        ...
        /* renamed from: e */
        private final ChannelStateEvent f144e;

        ClosingChannelFutureListener(ChannelHandlerContext ctx2, ChannelStateEvent e) {
            this.ctx = ctx2;
            this.f144e = e;
        }
        ...
        public void operationComplete(ChannelFuture sentGoAwayFuture) throws Exception {
            if (!(sentGoAwayFuture.getCause() instanceof ClosedChannelException)) {
                Channels.close(this.ctx, this.f144e.getFuture());
            } else {
                this.f144e.getFuture().setSuccess();
            }
        }
    }
}
