...
public class SpdyHeaders {
    ...
    public static void setVersion(int spdyVersion, SpdyHeaderBlock block, HttpVersion httpVersion) {
        if (spdyVersion < 3) {
            block.setHeader(Spdy2HttpNames.VERSION, (Object) httpVersion.getText());
        } else {
    ...
    /* renamed from: eq */
    private static boolean m161eq(String name1, String name2) {
    ...
    SpdyHeaders() {
        Entry entry = new Entry(-1, (String) null, (String) null);
        this.head = entry;
        entry.after = entry;
        entry.before = entry;
    }
    ...
    private void removeHeader0(int h, int i, String name) {
        ...
        if (e != null) {
            while (e.hash == h && m161eq(name, e.key)) {
                e.remove();
                Entry next = e.next;
                if (next != null) {
                    this.entries[i] = next;
            ...
            while (true) {
                Entry next2 = e.next;
                if (next2 != null) {
                    if (next2.hash != h || !m161eq(name, next2.key)) {
                        e = next2;
                    } else {
                        e.next = next2.next;
                        next2.remove();
