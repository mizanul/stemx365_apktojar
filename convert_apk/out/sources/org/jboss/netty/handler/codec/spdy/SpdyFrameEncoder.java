...
public class SpdyFrameEncoder extends OneToOneEncoder {
    ...
    public void handleDownstream(ChannelHandlerContext ctx, ChannelEvent evt) throws Exception {
        if (evt instanceof ChannelStateEvent) {
            ...
            int i = C08841.$SwitchMap$org$jboss$netty$channel$ChannelState[e.getState().ordinal()];
    ...
    public Object encode(ChannelHandlerContext ctx, Channel channel, Object msg) throws Exception {
        ...
        if (obj instanceof SpdySynStreamFrame) {
            ...
            if (this.version < 3) {
                ...
                frame.writeShort((priority & 255) << 14);
            } else {
                frame.writeShort((spdySynStreamFrame.getPriority() & 255) << 13);
            }
    ...
    private static ChannelBuffer encodeHeaderBlock(int version2, SpdyHeaderBlock headerFrame) throws Exception {
        ...
        if (numHeaders <= 65535) {
            ...
            for (String name : names) {
                byte[] nameBytes = name.getBytes(XmlRpcStreamConfig.UTF8_ENCODING);
                ...
                for (String value : headerFrame.getHeaders(name)) {
                    byte[] valueBytes = value.getBytes(XmlRpcStreamConfig.UTF8_ENCODING);
