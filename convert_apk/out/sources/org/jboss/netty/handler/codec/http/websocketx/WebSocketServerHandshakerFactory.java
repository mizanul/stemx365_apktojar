...
public class WebSocketServerHandshakerFactory {
    ...
    public WebSocketServerHandshakerFactory(String webSocketURL2, String subprotocols2, boolean allowExtensions2) {
        this(webSocketURL2, subprotocols2, allowExtensions2, LongCompanionObject.MAX_VALUE);
    }
    ...
    public void sendUnsupportedWebSocketVersionResponse(Channel channel) {
        ...
        res.setHeader(HttpHeaders.Names.SEC_WEBSOCKET_VERSION, (Object) WebSocketVersion.V13.toHttpHeaderValue());
        channel.write(res);
    }
}
