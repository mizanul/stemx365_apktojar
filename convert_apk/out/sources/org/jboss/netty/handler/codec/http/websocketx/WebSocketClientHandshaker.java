...
public abstract class WebSocketClientHandshaker {
    ...
    public WebSocketClientHandshaker(URI webSocketUrl2, WebSocketVersion version2, String subprotocol, Map<String, String> customHeaders2) {
        this(webSocketUrl2, version2, subprotocol, customHeaders2, LongCompanionObject.MAX_VALUE);
    }

    public WebSocketClientHandshaker(URI webSocketUrl2, WebSocketVersion version2, String subprotocol, Map<String, String> customHeaders2, long maxFramePayloadLength2) {
