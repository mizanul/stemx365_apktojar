...
public abstract class AbstractDiskHttpData extends AbstractHttpData {
    ...
    public void delete() {
        File file2;
        if (!this.isRenamed && (file2 = this.file) != null) {
            file2.delete();
        }
    }
    ...
    public ChannelBuffer getChannelBuffer() throws IOException {
        ...
        return ChannelBuffers.wrappedBuffer(readFrom(file2));
    }
    ...
    public String getString(Charset encoding) throws IOException {
        ...
        return new String(readFrom(file2), encoding.name());
    }
    ...
    public boolean renameTo(File dest) throws IOException {
        if (dest == null) {
            ...
            while (position < this.size) {
                ...
                position += in.transferTo(position, (long) chunkSize2, out);
    ...
    private static byte[] readFrom(File src2) throws IOException {
        long srcsize = src2.length();
        if (srcsize <= TTL.MAX_VALUE) {
            FileChannel fileChannel2 = new FileInputStream(src2).getChannel();
