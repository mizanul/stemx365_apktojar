...
public class SpdyHttpEncoder implements ChannelDownstreamHandler {
    ...
    private class SpdyFrameWriter implements ChannelFutureListener {
        ...
        /* renamed from: e */
        private final MessageEvent f143e;
        private final Object spdyFrame;

        SpdyFrameWriter(ChannelHandlerContext ctx2, MessageEvent e, Object spdyFrame2) {
            this.ctx = ctx2;
            this.f143e = e;
        ...
        public void operationComplete(ChannelFuture future) throws Exception {
            if (future.isSuccess()) {
                Channels.write(this.ctx, this.f143e.getFuture(), this.spdyFrame, this.f143e.getRemoteAddress());
            } else if (future.isCancelled()) {
                this.f143e.getFuture().cancel();
            } else {
                this.f143e.getFuture().setFailure(future.getCause());
            }
        }
    }
