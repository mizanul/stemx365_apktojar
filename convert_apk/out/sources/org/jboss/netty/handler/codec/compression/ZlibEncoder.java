...
public class ZlibEncoder extends OneToOneEncoder implements LifeCycleAwareChannelHandler {
    ...
    public ZlibEncoder(ZlibWrapper wrapper, int compressionLevel, int windowBits, int memLevel) {
        ...
        if (compressionLevel < 0 || compressionLevel > 9) {
            ...
            synchronized (this.f127z) {
                int resultCode = this.f127z.deflateInit(compressionLevel, windowBits, memLevel, ZlibUtil.convertWrapperType(wrapper));
                if (resultCode != 0) {
                    ZlibUtil.fail(this.f127z, "initialization failure", resultCode);
                }
            }
        } else {
    ...
    public ZlibEncoder(int compressionLevel, int windowBits, int memLevel, byte[] dictionary) {
        ...
        if (compressionLevel < 0 || compressionLevel > 9) {
            ...
            synchronized (this.f127z) {
                int resultCode = this.f127z.deflateInit(compressionLevel, windowBits, memLevel, JZlib.W_ZLIB);
                if (resultCode != 0) {
                    ZlibUtil.fail(this.f127z, "initialization failure", resultCode);
                } else {
                    int resultCode2 = this.f127z.deflateSetDictionary(dictionary, dictionary.length);
                    if (resultCode2 != 0) {
                        ZlibUtil.fail(this.f127z, "failed to set the dictionary", resultCode2);
                    }
                }
            }
        } else {
    ...
    public Object encode(ChannelHandlerContext ctx2, Channel channel, Object msg) throws Exception {
        ...
        synchronized (this.f127z) {
            try {
                ...
                this.f127z.next_in = in;
                this.f127z.next_in_index = 0;
                this.f127z.avail_in = in.length;
                byte[] out = new byte[(((int) Math.ceil(((double) in.length) * 1.001d)) + 12)];
                this.f127z.next_out = out;
                this.f127z.next_out_index = 0;
                this.f127z.avail_out = out.length;
                int resultCode = this.f127z.deflate(2);
                if (resultCode != 0) {
                    ZlibUtil.fail(this.f127z, "compression failure", resultCode);
                }
                if (this.f127z.next_out_index != 0) {
                    result = ctx2.getChannel().getConfig().getBufferFactory().getBuffer(uncompressed.order(), out, 0, this.f127z.next_out_index);
                } else {
                    result = ChannelBuffers.EMPTY_BUFFER;
                }
                try {
                    this.f127z.next_in = null;
                    this.f127z.next_out = null;
                    return result;
                } catch (Throwable th) {
                    th = th;
                    throw th;
    ...
    public void handleDownstream(ChannelHandlerContext ctx2, ChannelEvent evt) throws Exception {
        if (evt instanceof ChannelStateEvent) {
            ...
            int i = C08732.$SwitchMap$org$jboss$netty$channel$ChannelState[e.getState().ordinal()];
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:28:0x0099, code lost:
        if (r11 == null) goto L_0x00a3;
     */
    /* JADX WARNING: Code restructure failed: missing block: B:29:0x009b, code lost:
        r1.addListener(new org.jboss.netty.handler.codec.compression.ZlibEncoder.C08721(r9));
     */
    ...
    private org.jboss.netty.channel.ChannelFuture finishEncode(final org.jboss.netty.channel.ChannelHandlerContext r10, final org.jboss.netty.channel.ChannelEvent r11) {
        ...
        L_0x000f:
            ...
            return r0
        L_0x0018:
            org.jboss.netty.util.internal.jzlib.ZStream r0 = r9.f127z
            monitor-enter(r0)
            r3 = 0
            org.jboss.netty.util.internal.jzlib.ZStream r4 = r9.f127z     // Catch:{ all -> 0x00aa }
            byte[] r5 = EMPTY_ARRAY     // Catch:{ all -> 0x00aa }
            r4.next_in = r5     // Catch:{ all -> 0x00aa }
            org.jboss.netty.util.internal.jzlib.ZStream r4 = r9.f127z     // Catch:{ all -> 0x00aa }
            r4.next_in_index = r2     // Catch:{ all -> 0x00aa }
            org.jboss.netty.util.internal.jzlib.ZStream r4 = r9.f127z     // Catch:{ all -> 0x00aa }
            r4.avail_in = r2     // Catch:{ all -> 0x00aa }
            r4 = 32
            byte[] r4 = new byte[r4]     // Catch:{ all -> 0x00aa }
            org.jboss.netty.util.internal.jzlib.ZStream r5 = r9.f127z     // Catch:{ all -> 0x00aa }
            r5.next_out = r4     // Catch:{ all -> 0x00aa }
            org.jboss.netty.util.internal.jzlib.ZStream r5 = r9.f127z     // Catch:{ all -> 0x00aa }
            r5.next_out_index = r2     // Catch:{ all -> 0x00aa }
            org.jboss.netty.util.internal.jzlib.ZStream r5 = r9.f127z     // Catch:{ all -> 0x00aa }
            int r6 = r4.length     // Catch:{ all -> 0x00aa }
            r5.avail_out = r6     // Catch:{ all -> 0x00aa }
            org.jboss.netty.util.internal.jzlib.ZStream r5 = r9.f127z     // Catch:{ all -> 0x00aa }
            r6 = 4
            int r5 = r5.deflate(r6)     // Catch:{ all -> 0x00aa }
            if (r5 == 0) goto L_0x0058
            if (r5 == r1) goto L_0x0058
            org.jboss.netty.channel.Channel r1 = r10.getChannel()     // Catch:{ all -> 0x00aa }
            org.jboss.netty.util.internal.jzlib.ZStream r2 = r9.f127z     // Catch:{ all -> 0x00aa }
            java.lang.String r6 = "compression failure"
            org.jboss.netty.handler.codec.compression.CompressionException r2 = org.jboss.netty.handler.codec.compression.ZlibUtil.exception(r2, r6, r5)     // Catch:{ all -> 0x00aa }
            org.jboss.netty.channel.ChannelFuture r1 = org.jboss.netty.channel.Channels.failedFuture(r1, r2)     // Catch:{ all -> 0x00aa }
            r2 = 0
            goto L_0x0085
        L_0x0058:
            org.jboss.netty.util.internal.jzlib.ZStream r1 = r9.f127z     // Catch:{ all -> 0x00aa }
            int r1 = r1.next_out_index     // Catch:{ all -> 0x00aa }
            if (r1 == 0) goto L_0x007b
            org.jboss.netty.channel.Channel r1 = r10.getChannel()     // Catch:{ all -> 0x00aa }
            org.jboss.netty.channel.ChannelFuture r1 = org.jboss.netty.channel.Channels.future(r1)     // Catch:{ all -> 0x00aa }
            org.jboss.netty.channel.Channel r6 = r10.getChannel()     // Catch:{ all -> 0x00a4 }
            org.jboss.netty.channel.ChannelConfig r6 = r6.getConfig()     // Catch:{ all -> 0x00a4 }
            org.jboss.netty.buffer.ChannelBufferFactory r6 = r6.getBufferFactory()     // Catch:{ all -> 0x00a4 }
            org.jboss.netty.util.internal.jzlib.ZStream r7 = r9.f127z     // Catch:{ all -> 0x00a4 }
            int r7 = r7.next_out_index     // Catch:{ all -> 0x00a4 }
            org.jboss.netty.buffer.ChannelBuffer r2 = r6.getBuffer(r4, r2, r7)     // Catch:{ all -> 0x00a4 }
            goto L_0x0085
        L_0x007b:
            org.jboss.netty.channel.Channel r1 = r10.getChannel()     // Catch:{ all -> 0x00aa }
            org.jboss.netty.channel.ChannelFuture r1 = org.jboss.netty.channel.Channels.future(r1)     // Catch:{ all -> 0x00aa }
            org.jboss.netty.buffer.ChannelBuffer r2 = org.jboss.netty.buffer.ChannelBuffers.EMPTY_BUFFER     // Catch:{ all -> 0x00a4 }
        L_0x0085:
            org.jboss.netty.util.internal.jzlib.ZStream r4 = r9.f127z     // Catch:{ all -> 0x00c0 }
            r4.deflateEnd()     // Catch:{ all -> 0x00c0 }
            org.jboss.netty.util.internal.jzlib.ZStream r4 = r9.f127z     // Catch:{ all -> 0x00c0 }
            r4.next_in = r3     // Catch:{ all -> 0x00c0 }
            org.jboss.netty.util.internal.jzlib.ZStream r4 = r9.f127z     // Catch:{ all -> 0x00c0 }
            r4.next_out = r3     // Catch:{ all -> 0x00c0 }
        ...
        L_0x00aa:
            ...
            r4 = r3
        L_0x00ad:
            org.jboss.netty.util.internal.jzlib.ZStream r5 = r9.f127z     // Catch:{ all -> 0x00bb }
            r5.deflateEnd()     // Catch:{ all -> 0x00bb }
            org.jboss.netty.util.internal.jzlib.ZStream r5 = r9.f127z     // Catch:{ all -> 0x00bb }
            r5.next_in = r3     // Catch:{ all -> 0x00bb }
            org.jboss.netty.util.internal.jzlib.ZStream r5 = r9.f127z     // Catch:{ all -> 0x00bb }
            r5.next_out = r3     // Catch:{ all -> 0x00bb }
