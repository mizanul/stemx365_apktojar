...
public class WebSocketClientHandshaker13 extends WebSocketClientHandshaker {
    ...
    public WebSocketClientHandshaker13(URI webSocketURL, WebSocketVersion version, String subprotocol, boolean allowExtensions2, Map<String, String> customHeaders) {
        this(webSocketURL, version, subprotocol, allowExtensions2, customHeaders, LongCompanionObject.MAX_VALUE);
    }
    ...
    public ChannelFuture handshake(Channel channel) throws Exception {
        ...
        request.addHeader(HttpHeaders.Names.SEC_WEBSOCKET_VERSION, "13");
        ...
        channel.getPipeline().replace(HttpRequestEncoder.class, "ws-encoder", (ChannelHandler) new WebSocket13FrameEncoder(true));
        return future;
    }
