...
public class StaticChannelPipeline implements ChannelPipeline {
    ...
    public StaticChannelPipeline(ChannelHandler... handlers) {
        if (handlers == null) {
            ...
            if (nContexts == contexts2.length) {
                ...
                StaticChannelHandlerContext[] staticChannelHandlerContextArr = new StaticChannelHandlerContext[nContexts];
                contexts2 = staticChannelHandlerContextArr;
    ...
    public StaticChannelHandlerContext getActualUpstreamContext(int index) {
        ...
        while (true) {
            ...
            StaticChannelHandlerContext ctx = staticChannelHandlerContextArr[i];
    ...
    private final class StaticChannelHandlerContext implements ChannelHandlerContext {
        ...
        StaticChannelHandlerContext(int index2, String name2, ChannelHandler handler2) {
            if (name2 == null) {
                ...
                boolean z = handler2 instanceof ChannelUpstreamHandler;
                this.canHandleUpstream = z;
                boolean z2 = handler2 instanceof ChannelDownstreamHandler;
