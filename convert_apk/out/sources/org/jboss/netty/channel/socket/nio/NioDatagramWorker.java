...
public class NioDatagramWorker extends AbstractNioWorker {
    ...
    public void write0(AbstractNioChannel<?> channel) {
        ...
        synchronized (abstractNioChannel.writeLock) {
            ...
            while (true) {
                MessageEvent evt2 = abstractNioChannel.currentWriteEvent;
                if (evt2 == null) {
                    MessageEvent poll = writeBuffer.poll();
                    MessageEvent evt3 = poll;
                    ...
                    SocketSendBufferPool.SendBuffer acquire = sendBufferPool.acquire(evt3.getMessage());
                    buf = acquire;
