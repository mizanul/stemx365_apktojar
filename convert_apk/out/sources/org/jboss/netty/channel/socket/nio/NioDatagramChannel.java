...
public final class NioDatagramChannel extends AbstractNioChannel<DatagramChannel> implements org.jboss.netty.channel.socket.DatagramChannel {
    ...
    NioDatagramChannel(ChannelFactory factory, ChannelPipeline pipeline, ChannelSink sink, NioDatagramWorker worker, InternetProtocolFamily family) {
        super((Channel) null, factory, pipeline, sink, worker, openNonBlockingChannel(family));
    ...
    private static DatagramChannel openNonBlockingChannel(InternetProtocolFamily family) {
        ...
        try {
            if (DetectionUtil.javaVersion() >= 7) {
                if (family != null) {
                    int i = C08631.$SwitchMap$org$jboss$netty$channel$socket$InternetProtocolFamily[family.ordinal()];
                    if (i == 1) {
    ...
    public ChannelFuture joinGroup(InetAddress multicastAddress) {
        try {
            return joinGroup(multicastAddress, NetworkInterface.getByInetAddress(getLocalAddress().getAddress()), (InetAddress) null);
    ...
    public ChannelFuture joinGroup(InetSocketAddress multicastAddress, NetworkInterface networkInterface) {
        return joinGroup(multicastAddress.getAddress(), networkInterface, (InetAddress) null);
    }
    ...
    public ChannelFuture leaveGroup(InetAddress multicastAddress) {
        try {
            return leaveGroup(multicastAddress, NetworkInterface.getByInetAddress(getLocalAddress().getAddress()), (InetAddress) null);
        } catch (SocketException e) {
            return Channels.failedFuture(this, e);
        }
    }
    ...
    public ChannelFuture leaveGroup(InetSocketAddress multicastAddress, NetworkInterface networkInterface) {
        return leaveGroup(multicastAddress.getAddress(), networkInterface, (InetAddress) null);
    }
