        ...
        this.realChannel.connect(remoteAddress).addListener(new ChannelFutureListener() {
            public void operationComplete(ChannelFuture f) {
                ...
                if (f.isSuccess()) {
                    ...
                    if (serverName != null) {
                        req.setHeader("Host", (Object) serverName);
                    }
                    req.setHeader("Content-Type", (Object) HttpPostBodyUtil.DEFAULT_BINARY_CONTENT_TYPE);
                    req.setHeader("Transfer-Encoding", (Object) HttpHeaders.Values.CHUNKED);
                    req.setHeader(HttpHeaders.Names.CONTENT_TRANSFER_ENCODING, (Object) HttpHeaders.Values.BINARY);
                    req.setHeader("User-Agent", (Object) HttpTunnelingClientSocketChannel.class.getName());
    ...
    final class ServletChannelHandler extends SimpleChannelUpstreamHandler {
        ...
        public void messageReceived(ChannelHandlerContext ctx, MessageEvent e) throws Exception {
            if (!this.readingChunks) {
                ...
                if (res.getStatus().getCode() != HttpResponseStatus.f134OK.getCode()) {
