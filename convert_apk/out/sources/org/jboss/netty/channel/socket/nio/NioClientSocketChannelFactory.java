...
public class NioClientSocketChannelFactory implements ClientSocketChannelFactory {
    ...
    public SocketChannel newChannel(ChannelPipeline pipeline) {
        ...
        return new NioClientSocketChannel(this, pipeline, nioClientSocketPipelineSink, nioClientSocketPipelineSink.nextWorker());
    }

    public void releaseExternalResources() {
        ExecutorUtil.terminate(this.bossExecutor);
        WorkerPool<NioWorker> workerPool2 = this.workerPool;
