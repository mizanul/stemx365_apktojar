...
public final class ConcurrentIdentityWeakKeyHashMap<K, V> extends AbstractMap<K, V> implements ConcurrentMap<K, V> {
    ...
    public boolean containsValue(java.lang.Object r9) {
        /*
            ...
            org.jboss.netty.util.internal.ConcurrentIdentityWeakKeyHashMap$Segment<K, V>[] r0 = r8.segments
            int r1 = r0.length
            int[] r1 = new int[r1]
            r2 = 0
        L_0x0008:
    ...
    static class SimpleEntry<K, V> implements Map.Entry<K, V> {
        ...
        public boolean equals(Object o) {
            ...
            if (!m164eq(this.key, e.getKey()) || !m164eq(this.value, e.getValue())) {
                return false;
            }
            return true;
        }
        ...
        /* renamed from: eq */
        private static boolean m164eq(Object o1, Object o2) {
            if (o1 == null) {
                return o2 == null;
            }
            return o1.equals(o2);
