...
public final class ConcurrentIdentityHashMap<K, V> extends AbstractMap<K, V> implements ConcurrentMap<K, V> {
    ...
    public boolean containsValue(java.lang.Object r9) {
        /*
            ...
            org.jboss.netty.util.internal.ConcurrentIdentityHashMap$Segment<K, V>[] r0 = r8.segments
            int r1 = r0.length
            int[] r1 = new int[r1]
            r2 = 0
        L_0x0008:
        ...
        L_0x007b:
            ...
            throw r0
        */
        throw new UnsupportedOperationException("Method not decompiled: org.jboss.netty.util.internal.ConcurrentIdentityHashMap.containsValue(java.lang.Object):boolean");
    }
    ...
    static class SimpleEntry<K, V> implements Map.Entry<K, V> {
        ...
        public boolean equals(Object o) {
            ...
            if (!m163eq(this.key, e.getKey()) || !m163eq(this.value, e.getValue())) {
                return false;
            }
            return true;
        }
        ...
        /* renamed from: eq */
        private static boolean m163eq(Object o1, Object o2) {
            if (o1 == null) {
                return o2 == null;
            }
            return o1.equals(o2);
