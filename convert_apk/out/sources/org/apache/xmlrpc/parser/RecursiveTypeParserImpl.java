...
public abstract class RecursiveTypeParserImpl extends TypeParserImpl {
    ...
    public void endValueTag() throws SAXException {
        if (this.inValueTag) {
            TypeParser typeParser2 = this.typeParser;
            if (typeParser2 == null) {
                addResult(this.text.toString());
                this.text.setLength(0);
                return;
            }
            typeParser2.endDocument();
            try {
    ...
    public void endElement(String pURI, String pLocalName, String pQName) throws SAXException {
        if (this.inValueTag) {
            TypeParser typeParser2 = this.typeParser;
            if (typeParser2 != null) {
                typeParser2.endElement(pURI, pLocalName, pQName);
                return;
            }
    ...
    public void startElement(String pURI, String pLocalName, String pQName, Attributes pAttrs) throws SAXException {
        if (this.inValueTag) {
            if (this.typeParser == null) {
                TypeParser parser = this.factory.getParser(this.cfg, this.context, pURI, pLocalName);
    ...
    public void characters(char[] pChars, int pOffset, int pLength) throws SAXException {
        TypeParser typeParser2 = this.typeParser;
        if (typeParser2 != null) {
            typeParser2.characters(pChars, pOffset, pLength);
    ...
    public void ignorableWhitespace(char[] pChars, int pOffset, int pLength) throws SAXException {
        TypeParser typeParser2 = this.typeParser;
        if (typeParser2 != null) {
            typeParser2.ignorableWhitespace(pChars, pOffset, pLength);
        } else if (this.inValueTag) {
            this.text.append(pChars, pOffset, pLength);
        } else {
    ...
    public void processingInstruction(String pTarget, String pData) throws SAXException {
        ...
        if (typeParser2 == null) {
            ...
            typeParser2.processingInstruction(pTarget, pData);
        }
    }
    ...
    public void skippedEntity(String pEntity) throws SAXException {
        ...
        if (typeParser2 == null) {
            ...
            typeParser2.skippedEntity(pEntity);
        }
    }
