...
public class TypeFactoryImpl implements TypeFactory {
    ...
    public final XmlRpcController controller;
    ...
    public TypeParser getParser(XmlRpcStreamConfig pConfig, NamespaceContextImpl pContext, String pURI, String pLocalName) {
        if (XmlRpcWriter.EXTENSIONS_URI.equals(pURI)) {
            ...
            if (I1Serializer.I1_TAG.equals(pLocalName)) {
                return new I1Parser();
            }
            if (I2Serializer.I2_TAG.equals(pLocalName)) {
                return new I2Parser();
            }
            if (I8Serializer.I8_TAG.equals(pLocalName)) {
                return new I8Parser();
            }
            if (FloatSerializer.FLOAT_TAG.equals(pLocalName)) {
                return new FloatParser();
            }
            if (NodeSerializer.DOM_TAG.equals(pLocalName)) {
                return new NodeParser();
            }
            if (BigDecimalSerializer.BIGDECIMAL_TAG.equals(pLocalName)) {
                return new BigDecimalParser();
            }
            if (BigIntegerSerializer.BIGINTEGER_TAG.equals(pLocalName)) {
                return new BigIntegerParser();
            }
            if (SerializableSerializer.SERIALIZABLE_TAG.equals(pLocalName)) {
                return new SerializableParser();
            }
            if (CalendarSerializer.CALENDAR_TAG.equals(pLocalName)) {
            ...
            if (BooleanSerializer.BOOLEAN_TAG.equals(pLocalName)) {
            ...
            if (StringSerializer.STRING_TAG.equals(pLocalName)) {
