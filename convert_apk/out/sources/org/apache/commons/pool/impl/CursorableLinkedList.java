...
class CursorableLinkedList<E> implements List<E>, Serializable {
    ...
    public int indexOf(Object o) {
        ...
        Listable<E> past2 = null;
        for (Listable<E> elt2 = this._head.next(); elt2 != null && past2 != this._head.prev(); elt2 = elt2.next()) {
    ...
    public int lastIndexOf(Object o) {
        ...
        if (o == null) {
            Listable<E> past = null;
            for (Listable<E> elt = this._head.prev(); elt != null && past != this._head.next(); elt = elt.prev()) {
                if (elt.value() == null) {
                    return ndx;
                }
                ndx--;
        ...
        Listable<E> past2 = null;
        for (Listable<E> elt2 = this._head.prev(); elt2 != null && past2 != this._head.next(); elt2 = elt2.prev()) {
            if (o.equals(elt2.value())) {
                return ndx;
            }
            ndx--;
    ...
    class ListIter implements ListIterator<E> {
        ...
        public E previous() {
            ...
            if (hasPrevious()) {
                ...
                Listable<E> listable = this._cur;
                listable.setNext(listable.prev());
                Listable<E> listable2 = this._cur;
        ...
        public void remove() {
            checkForComod();
            Listable<E> listable = this._lastReturned;
            if (listable != null) {
        ...
        public void add(E o) {
            checkForComod();
            Listable<E> listable = this._cur;
            listable.setPrev(CursorableLinkedList.this.insertListable(listable.prev(), this._cur.next(), o));
            this._lastReturned = null;
            this._nextIndex++;
            this._expectedModCount++;
        }
