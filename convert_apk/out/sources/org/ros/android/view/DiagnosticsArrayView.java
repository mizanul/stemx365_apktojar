...
public class DiagnosticsArrayView extends TableLayout implements NodeMain {
    ...
    private void init() {
        ...
        this.errorDrawable = resources.getDrawable(C0068R.C0069drawable.error);
        this.warningDrawable = resources.getDrawable(C0068R.C0069drawable.warn);
        this.okDrawable = resources.getDrawable(C0068R.C0069drawable.f11ok);
        this.staleDrawable = resources.getDrawable(C0068R.C0069drawable.stale);
    }

    public GraphName getDefaultNodeName() {
        return GraphName.m181of("android_10/diagnostics_array_view");
    }
