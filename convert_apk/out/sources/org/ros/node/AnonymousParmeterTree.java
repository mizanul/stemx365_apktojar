...
public class AnonymousParmeterTree implements ParameterTree {
    ...
    public AnonymousParmeterTree(URI masterUri) {
        this.parameterTree = DefaultParameterTree.newFromNodeIdentifier(new NodeIdentifier(GraphName.m181of("invalid"), (URI) null), masterUri, NameResolver.newRoot(), (ParameterManager) null);
    }
