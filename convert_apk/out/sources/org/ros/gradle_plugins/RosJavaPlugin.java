...
public class RosJavaPlugin implements Plugin<Project>, GroovyObject {
    ...
    public void apply(Project project2) {
        ...
        this.project = (Project) ScriptBytecodeAdapter.castToType((Project) project3.get(), Project.class);
        boolean z = false;
        if (!DefaultTypeTransformation.booleanUnbox($getCallSiteArray[0].call($getCallSiteArray[1].callGetProperty((Project) project3.get()), "ros"))) {
            $getCallSiteArray[2].call((Project) project3.get(), ScriptBytecodeAdapter.createMap(new Object[]{"plugin", "ros"}));
        }
        if (!DefaultTypeTransformation.booleanUnbox($getCallSiteArray[3].call($getCallSiteArray[4].callGetProperty((Project) project3.get()), "java"))) {
            $getCallSiteArray[5].call((Project) project3.get(), ScriptBytecodeAdapter.createMap(new Object[]{"plugin", "java"}));
        }
        if (!DefaultTypeTransformation.booleanUnbox($getCallSiteArray[6].call($getCallSiteArray[7].callGetProperty((Project) project3.get()), "maven-publish"))) {
            $getCallSiteArray[8].call((Project) project3.get(), ScriptBytecodeAdapter.createMap(new Object[]{"plugin", "maven-publish"}));
        }
        ScriptBytecodeAdapter.setProperty($const$0, (Class) null, (Project) project3.get(), "sourceCompatibility");
        ScriptBytecodeAdapter.setProperty($const$0, (Class) null, (Project) project3.get(), "targetCompatibility");
        if (!BytecodeInterface8.isOrigZ() || __$stMC || BytecodeInterface8.disabledStandardMetaClass()) {
            if (ScriptBytecodeAdapter.compareNotEqual($getCallSiteArray[9].callGetProperty($getCallSiteArray[10].callGetProperty((Project) project3.get())), "null") && ScriptBytecodeAdapter.compareNotEqual($getCallSiteArray[11].callGetProperty($getCallSiteArray[12].callGetProperty((Project) project3.get())), "")) {
                z = true;
            }
            if (z) {
                $getCallSiteArray[13].call((Project) project3.get(), new _apply_closure1(this, this, project3));
                return;
            }
            return;
        }
        if (ScriptBytecodeAdapter.compareNotEqual($getCallSiteArray[14].callGetProperty($getCallSiteArray[15].callGetProperty((Project) project3.get())), "null") && ScriptBytecodeAdapter.compareNotEqual($getCallSiteArray[16].callGetProperty($getCallSiteArray[17].callGetProperty((Project) project3.get())), "")) {
            z = true;
        }
        if (z) {
            $getCallSiteArray[18].call((Project) project3.get(), new _apply_closure1(this, this, project3));
        }
    }
