...
public class CatkinPackages implements GroovyObject {
    ...
    private static /* synthetic */ void $createCallSiteArray_1(String[] strArr) {
        ...
        strArr[5] = "getAt";
        strArr[6] = SpdyHeaders.Spdy2HttpNames.VERSION;
        strArr[7] = "add";
    ...
    public class _generate_closure1 extends Closure implements GeneratedClosure {
        ...
        public class _closure4 extends Closure implements GeneratedClosure {
            ...
            private static /* synthetic */ void $createCallSiteArray_1(String[] strArr) {
                ...
                strArr[3] = "pkgs";
                strArr[4] = "name";
                strArr[5] = SpdyHeaders.Spdy2HttpNames.VERSION;
                strArr[6] = "getAt";
                strArr[7] = "pkgs";
                strArr[8] = "name";
                strArr[9] = SpdyHeaders.Spdy2HttpNames.VERSION;
                strArr[10] = "println";
                strArr[11] = "plus";
                strArr[12] = "plus";
                strArr[13] = "plus";
                ...
                strArr[16] = "plus";
                strArr[17] = "name";
                strArr[18] = SpdyHeaders.Spdy2HttpNames.VERSION;
                strArr[19] = "getAt";
                strArr[20] = "pkgs";
                strArr[21] = "name";
                strArr[22] = SpdyHeaders.Spdy2HttpNames.VERSION;
                strArr[23] = "putAt";
                strArr[24] = "pkgs";
                strArr[25] = "name";
                strArr[26] = "put";
    ...
    public void generateMessageArtifact(Project project2, String package_name) {
        ...
        ScriptBytecodeAdapter.setProperty($getCallSiteArray[6].callGetProperty(pkg), (Class) null, (Project) project3.get(), SpdyHeaders.Spdy2HttpNames.VERSION);
    ...
    public class _generateMessageArtifact_closure3 extends Closure implements GeneratedClosure {
        ...
        public Object doCall(Object d) {
            ...
            return $getCallSiteArray[3].call($getCallSiteArray[4].callGetProperty(this.project.get()), "compile", $getCallSiteArray[5].call($getCallSiteArray[6].callGetProperty(this.project.get()), ScriptBytecodeAdapter.createMap(new Object[]{"path", $getCallSiteArray[7].call(":", d)})));
        }
    }
}
