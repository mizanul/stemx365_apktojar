...
public class DefaultParameterTree implements ParameterTree {
    ...
    public boolean has(String name) {
        return has(GraphName.m181of(name));
    }
    ...
    public GraphName search(String name) {
        return search(GraphName.m181of(name));
    }
    ...
    public void addParameterListener(String name, ParameterListener listener) {
        addParameterListener(GraphName.m181of(name), listener);
    }
    ...
    public void set(String name, boolean value) {
        set(GraphName.m181of(name), value);
    }
    ...
    public boolean getBoolean(String name) {
        return getBoolean(GraphName.m181of(name));
    }
    ...
    public boolean getBoolean(String name, boolean defaultValue) {
        return getBoolean(GraphName.m181of(name), defaultValue);
    }
    ...
    public int getInteger(String name) {
        return getInteger(GraphName.m181of(name));
    }
    ...
    public int getInteger(String name, int defaultValue) {
        return getInteger(GraphName.m181of(name), defaultValue);
    }
    ...
    public double getDouble(String name) {
        return getDouble(GraphName.m181of(name));
    }
    ...
    public double getDouble(String name, double defaultValue) {
        return getDouble(GraphName.m181of(name), defaultValue);
    }
    ...
    public String getString(String name) {
        return (String) get(GraphName.m181of(name), String.class);
    }
    ...
    public String getString(String name, String defaultValue) {
        return getString(GraphName.m181of(name), defaultValue);
    }
    ...
    public List<?> getList(String name) {
        return getList(GraphName.m181of(name));
    }
    ...
    public List<?> getList(String name, List<?> defaultValue) {
        return getList(GraphName.m181of(name), defaultValue);
    }
    ...
    public Map<?, ?> getMap(String name) {
        return getMap(GraphName.m181of(name));
    }
    ...
    public Map<?, ?> getMap(String name, Map<?, ?> defaultValue) {
        return getMap(GraphName.m181of(name), defaultValue);
    }
}
