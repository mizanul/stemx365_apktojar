...
public class MasterXmlRpcEndpointImpl implements MasterXmlRpcEndpoint, ParameterServerXmlRpcEndpoint {
    ...
    public List<Object> getPublishedTopics(String callerId, String subgraph) {
        return Response.newSuccess("current topics", this.master.getPublishedTopics(GraphName.m181of(callerId), GraphName.m181of(subgraph))).toList();
    }

    public List<Object> getTopicTypes(String callerId) {
        return Response.newSuccess("topic types", this.master.getTopicTypes(GraphName.m181of(callerId))).toList();
    }
    ...
    public List<Object> lookupNode(String callerId, String nodeName) {
        URI nodeSlaveUri = this.master.lookupNode(GraphName.m181of(nodeName));
    ...
    public List<Object> registerPublisher(String callerId, String topicName, String topicMessageType, String callerSlaveUri) {
        try {
            List<URI> subscribers = this.master.registerPublisher(GraphName.m181of(callerId), new URI(callerSlaveUri), GraphName.m181of(topicName), topicMessageType);
    ...
    public List<Object> unregisterPublisher(String callerId, String topicName, String callerSlaveUri) {
        return Response.newSuccess("Success", Integer.valueOf(this.master.unregisterPublisher(GraphName.m181of(callerId), GraphName.m181of(topicName)))).toList();
    }

    public List<Object> registerSubscriber(String callerId, String topicName, String topicMessageType, String callerSlaveUri) {
        try {
            List<URI> publishers = this.master.registerSubscriber(GraphName.m181of(callerId), new URI(callerSlaveUri), GraphName.m181of(topicName), topicMessageType);
            List<String> urls = Lists.newArrayList();
    ...
    public List<Object> unregisterSubscriber(String callerId, String topicName, String callerSlaveUri) {
        return Response.newSuccess("Success", Integer.valueOf(this.master.unregisterSubscriber(GraphName.m181of(callerId), GraphName.m181of(topicName)))).toList();
    }

    public List<Object> lookupService(String callerId, String serviceName) {
        URI slaveUri = this.master.lookupService(GraphName.m181of(serviceName));
        if (slaveUri != null) {
    ...
    public List<Object> registerService(String callerId, String serviceName, String serviceUri, String callerSlaveUri) {
        try {
            this.master.registerService(GraphName.m181of(callerId), new URI(callerSlaveUri), GraphName.m181of(serviceName), new URI(serviceUri));
    ...
    public List<Object> unregisterService(String callerId, String serviceName, String serviceUri) {
        try {
            return Response.newSuccess("Success", Integer.valueOf(this.master.unregisterService(GraphName.m181of(callerId), GraphName.m181of(serviceName), new URI(serviceUri)) ? 1 : 0)).toList();
        } catch (URISyntaxException e) {
            throw new RosRuntimeException((Throwable) e);
        }
    }
    ...
    public List<Object> getParam(String callerId, String key) {
        Object value = this.parameterServer.get(GraphName.m181of(key));
        if (value != null) {
    ...
    public List<Object> subscribeParam(String callerId, String callerSlaveUri, String key) {
        this.parameterServer.subscribe(GraphName.m181of(key), NodeIdentifier.forNameAndUri(callerId, callerSlaveUri));
        Object value = this.parameterServer.get(GraphName.m181of(key));
        if (value == null) {
            value = new HashMap();
        }
    ...
    public List<Object> deleteParam(String callerId, String key) {
        this.parameterServer.delete(GraphName.m181of(key));
        return Response.newSuccess("Success", null).toList();
    }

    public List<Object> hasParam(String callerId, String key) {
        return Response.newSuccess("Success", Boolean.valueOf(this.parameterServer.has(GraphName.m181of(key)))).toList();
    }
