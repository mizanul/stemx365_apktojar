...
public class DefaultServiceClient<T, S> implements ServiceClient<T, S> {
    ...
    private DefaultServiceClient(GraphName nodeName, ServiceDeclaration serviceDeclaration2, MessageSerializer<T> serializer2, MessageDeserializer<S> deserializer, MessageFactory messageFactory2, ScheduledExecutorService executorService) {
        ...
        ConnectionHeader connectionHeader2 = new ConnectionHeader();
        this.connectionHeader = connectionHeader2;
        connectionHeader2.addField(ConnectionHeaderFields.CALLER_ID, nodeName.toString());
        ...
        DefaultServiceClient<T, S>.HandshakeLatch handshakeLatch2 = new HandshakeLatch();
        this.handshakeLatch = handshakeLatch2;
        serviceClientHandshakeHandler.addListener(handshakeLatch2);
