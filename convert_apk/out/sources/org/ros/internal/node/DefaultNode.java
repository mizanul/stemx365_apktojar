...
public class DefaultNode implements ConnectedNode {
    ...
    public DefaultNode(NodeConfiguration nodeConfiguration2, Collection<NodeListener> nodeListeners2, ScheduledExecutorService scheduledExecutorService2) {
        ...
        ListenerGroup<NodeListener> listenerGroup = new ListenerGroup<>(scheduledExecutorService3);
        this.nodeListeners = listenerGroup;
        listenerGroup.addAll(nodeListeners2);
        ...
        Registrar registrar2 = new Registrar(this.masterClient, scheduledExecutorService3);
        this.registrar = registrar2;
        this.topicParticipantManager.setListener(registrar2);
    ...
    public void start() {
        ...
        RosoutLogger rosoutLogger = new RosoutLogger(this);
        this.log = rosoutLogger;
        rosoutLogger.getPublisher().addListener(new DefaultPublisherListener<Log>() {
    ...
    public <T> Publisher<T> newPublisher(String topicName, String messageType) {
        return newPublisher(GraphName.m181of(topicName), messageType);
    }
    ...
    public <T> Subscriber<T> newSubscriber(String topicName, String messageType) {
        return newSubscriber(GraphName.m181of(topicName), messageType);
    }
    ...
    public <T, S> ServiceServer<T, S> newServiceServer(String serviceName, String serviceType, ServiceResponseBuilder<T, S> responseBuilder) {
        return newServiceServer(GraphName.m181of(serviceName), serviceType, responseBuilder);
    }
    ...
    public <T, S> ServiceServer<T, S> getServiceServer(String serviceName) {
        return getServiceServer(GraphName.m181of(serviceName));
    }
    ...
    public URI lookupServiceUri(String serviceName) {
        return lookupServiceUri(GraphName.m181of(serviceName));
    }
    ...
    public <T, S> ServiceClient<T, S> newServiceClient(String serviceName, String serviceType) throws ServiceNotFoundException {
        return newServiceClient(GraphName.m181of(serviceName), serviceType);
    }
    ...
    public GraphName resolveName(String name) {
        return this.resolver.resolve(GraphName.m181of(name));
    }
