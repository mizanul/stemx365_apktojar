...
public class IncomingMessageQueue<T> {
    ...
    public IncomingMessageQueue(MessageDeserializer<T> deserializer, ExecutorService executorService) {
        ...
        MessageDispatcher<T> messageDispatcher2 = new MessageDispatcher<>(lazyMessages, executorService);
        this.messageDispatcher = messageDispatcher2;
        executorService.execute(messageDispatcher2);
    }
