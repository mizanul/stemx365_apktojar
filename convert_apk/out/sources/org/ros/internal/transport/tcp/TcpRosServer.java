...
public class TcpRosServer {
    ...
    public void start() {
        ...
        this.channelFactory = new NioServerSocketChannelFactory((Executor) scheduledExecutorService, (Executor) scheduledExecutorService);
    ...
    public void shutdown() {
        Channel channel = this.outgoingChannel;
        if (channel != null) {
