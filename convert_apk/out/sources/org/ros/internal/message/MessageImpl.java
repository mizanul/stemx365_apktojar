...
class MessageImpl implements RawMessage, GetInstance {
    ...
    public int hashCode() {
        ...
        int i2 = 0;
        int result = (i + (messageContext2 == null ? 0 : messageContext2.hashCode())) * 31;
        MessageFields messageFields2 = this.messageFields;
        if (messageFields2 != null) {
            i2 = messageFields2.hashCode();
        }
        return result + i2;
    }
    ...
    public boolean equals(Object obj) {
        ...
        } else if (!messageContext2.equals(other.messageContext)) {
            return false;
        }
        MessageFields messageFields2 = this.messageFields;
        if (messageFields2 == null) {
        ...
        } else if (!messageFields2.equals(other.messageFields)) {
            return false;
        }
        return true;
    }
