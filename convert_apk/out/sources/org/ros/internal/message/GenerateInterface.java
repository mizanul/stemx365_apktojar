...
public class GenerateInterface {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            MessageIdentifier messageIdentifier = MessageIdentifier.m180of(pkg, name);
            ...
            if (extension.equals(NotificationCompat.CATEGORY_MESSAGE)) {
                ...
                MessageDeclaration requestDeclaration = MessageDeclaration.m178of(messageIdentifier.getType() + "Request", requestAndResponse.get(0));
                MessageDeclaration responseDeclaration = MessageDeclaration.m178of(messageIdentifier.getType() + "Response", requestAndResponse.get(1));
