...
public class TopicDefinitionFileProvider extends MessageDefinitionFileProvider {
    ...
    private static StringFileProvider newStringFileProvider() {
        return new StringFileProvider(FileFilterUtils.andFileFilter(FileFilterUtils.suffixFileFilter(NotificationCompat.CATEGORY_MESSAGE), FileFilterUtils.asFileFilter(new FileFilter() {
