...
public class MessageContext {
    ...
    public int hashCode() {
        int i = 1 * 31;
        MessageDeclaration messageDeclaration2 = this.messageDeclaration;
        return i + (messageDeclaration2 == null ? 0 : messageDeclaration2.hashCode());
    }
    ...
    public boolean equals(Object obj) {
        ...
        MessageDeclaration messageDeclaration2 = this.messageDeclaration;
        if (messageDeclaration2 == null) {
            if (other.messageDeclaration != null) {
                return false;
            }
        } else if (!messageDeclaration2.equals(other.messageDeclaration)) {
            return false;
        }
        return true;
    }
