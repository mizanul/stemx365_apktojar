...
public class GenerateInterfaces {
    ...
    public GenerateInterfaces() {
        TopicDefinitionFileProvider topicDefinitionFileProvider2 = new TopicDefinitionFileProvider();
        this.topicDefinitionFileProvider = topicDefinitionFileProvider2;
        this.messageDefinitionProviderChain.addMessageDefinitionProvider(topicDefinitionFileProvider2);
        ServiceDefinitionFileProvider serviceDefinitionFileProvider2 = new ServiceDefinitionFileProvider();
        this.serviceDefinitionFileProvider = serviceDefinitionFileProvider2;
        this.messageDefinitionProviderChain.addMessageDefinitionProvider(serviceDefinitionFileProvider2);
        ActionDefinitionFileProvider actionDefinitionFileProvider2 = new ActionDefinitionFileProvider();
        this.actionDefinitionFileProvider = actionDefinitionFileProvider2;
        this.messageDefinitionProviderChain.addMessageDefinitionProvider(actionDefinitionFileProvider2);
    ...
    private void writeServiceInterfaces(File outputDirectory, Collection<String> packages) throws IOException {
        ...
        for (MessageIdentifier serviceType : serviceTypes) {
            ...
            writeInterface(MessageDeclaration.m178of(serviceType.getType(), definition), outputDirectory, false);
            List<String> requestAndResponse = MessageDefinitionTupleParser.parse(definition, 2);
            MessageDeclaration requestDeclaration = MessageDeclaration.m178of(serviceType.getType() + "Request", requestAndResponse.get(0));
            MessageDeclaration responseDeclaration = MessageDeclaration.m178of(serviceType.getType() + "Response", requestAndResponse.get(1));
    ...
    private void writeActionInterfaces(File outputDirectory, Collection<String> packages) throws IOException {
        ...
        for (MessageIdentifier actionType : actionTypes) {
            ...
            writeInterface(MessageDeclaration.m178of(actionType.getType(), definition), file, false);
            List<String> goalResultAndFeedback = MessageDefinitionTupleParser.parse(definition, 3);
            MessageDeclaration goalDeclaration = MessageDeclaration.m178of(actionType.getType() + "Goal", this.actionGenerationTemplateGoal.applyTemplate(goalResultAndFeedback.get(0)));
            MessageDeclaration resultDeclaration = MessageDeclaration.m178of(actionType.getType() + "Result", this.actionGenerationTemplateResult.applyTemplate(goalResultAndFeedback.get(1)));
            MessageDeclaration feedbackDeclaration = MessageDeclaration.m178of(actionType.getType() + "Feedback", this.actionGenerationTemplateFeedback.applyTemplate(goalResultAndFeedback.get(2)));
            MessageDeclaration actionGoalDeclaration = MessageDeclaration.m178of(actionType.getType() + "ActionGoal", this.actionGenerationTemplateActionGoal.applyTemplate(actionType.getType()));
            MessageDeclaration actionResultDeclaration = MessageDeclaration.m178of(actionType.getType() + "ActionResult", this.actionGenerationTemplateActionResult.applyTemplate(actionType.getType()));
            Collection<MessageIdentifier> actionTypes2 = actionTypes;
            MessageDeclaration actionFeedbackDeclaration = MessageDeclaration.m178of(actionType.getType() + "ActionFeedback", this.actionGenerationTemplateActionFeedback.applyTemplate(actionType.getType()));
