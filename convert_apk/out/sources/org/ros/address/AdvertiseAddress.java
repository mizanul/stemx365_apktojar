...
public class AdvertiseAddress {
    ...
    public URI toUri(String scheme) {
        Preconditions.checkNotNull(this.portCallable);
        try {
            return new URI(scheme, (String) null, this.host, this.portCallable.call().intValue(), "/", (String) null, (String) null);
        } catch (Exception e) {
    ...
    public int hashCode() {
        ...
        try {
            return ((i + (str == null ? 0 : str.hashCode())) * 31) + this.portCallable.call().intValue();
        } catch (Exception e) {
            throw new RosRuntimeException((Throwable) e);
        }
    }
