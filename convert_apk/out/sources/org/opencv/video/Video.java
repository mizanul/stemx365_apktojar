...
public class Video {
    ...
    public static RotatedRect CamShift(Mat probImage, Rect window, TermCriteria criteria) {
        ...
        RotatedRect retVal = new RotatedRect(CamShift_0(probImage.nativeObj, window.f180x, window.f181y, window.width, window.height, window_out, criteria.type, criteria.maxCount, criteria.epsilon));
        if (window != null) {
            window.f180x = (int) window_out[0];
            window.f181y = (int) window_out[1];
    ...
    public static int meanShift(Mat probImage, Rect window, TermCriteria criteria) {
        double[] window_out = new double[4];
        int retVal = meanShift_0(probImage.nativeObj, window.f180x, window.f181y, window.width, window.height, window_out, criteria.type, criteria.maxCount, criteria.epsilon);
        if (window != null) {
            window.f180x = (int) window_out[0];
            window.f181y = (int) window_out[1];
            window.width = (int) window_out[2];
    ...
    public static void calcOpticalFlowPyrLK(Mat prevImg, Mat nextImg, MatOfPoint2f prevPts, MatOfPoint2f nextPts, MatOfByte status, MatOfFloat err, Size winSize, int maxLevel, TermCriteria criteria, int flags, double minEigThreshold) {
        ...
        MatOfPoint2f matOfPoint2f5 = matOfPoint2f2;
        long j2 = j;
    ...
    public static void calcOpticalFlowPyrLK(Mat prevImg, Mat nextImg, MatOfPoint2f prevPts, MatOfPoint2f nextPts, MatOfByte status, MatOfFloat err, Size winSize, int maxLevel) {
        ...
        long j2 = j;
        calcOpticalFlowPyrLK_3(j2, nextImg.nativeObj, matOfPoint2f.nativeObj, mat.nativeObj, matOfByte.nativeObj, matOfFloat.nativeObj, size.width, size.height, maxLevel);
    }
    ...
    public static void calcOpticalFlowPyrLK(Mat prevImg, Mat nextImg, MatOfPoint2f prevPts, MatOfPoint2f nextPts, MatOfByte status, MatOfFloat err, Size winSize) {
        ...
        MatOfFloat matOfFloat = err;
        long j = prevImg.nativeObj;
        long j2 = nextImg.nativeObj;
        long j3 = matOfPoint2f.nativeObj;
        long j4 = matOfPoint2f2.nativeObj;
        MatOfPoint2f matOfPoint2f3 = matOfPoint2f;
        MatOfPoint2f matOfPoint2f4 = matOfPoint2f2;
        long j5 = matOfByte.nativeObj;
        MatOfByte matOfByte2 = matOfByte;
        MatOfFloat matOfFloat2 = matOfFloat;
        calcOpticalFlowPyrLK_4(j, j2, j3, j4, j5, matOfFloat.nativeObj, size.width, size.height);
    }
    ...
    public static double findTransformECC(Mat templateImage, Mat inputImage, Mat warpMatrix, int motionType, TermCriteria criteria, Mat inputMask, int gaussFiltSize) {
        TermCriteria termCriteria = criteria;
        return findTransformECC_0(templateImage.nativeObj, inputImage.nativeObj, warpMatrix.nativeObj, motionType, termCriteria.type, termCriteria.maxCount, termCriteria.epsilon, inputMask.nativeObj, gaussFiltSize);
    }
    ...
    public static double findTransformECC(Mat templateImage, Mat inputImage, Mat warpMatrix, int motionType, TermCriteria criteria, Mat inputMask) {
        TermCriteria termCriteria = criteria;
        return findTransformECC_1(templateImage.nativeObj, inputImage.nativeObj, warpMatrix.nativeObj, motionType, termCriteria.type, termCriteria.maxCount, termCriteria.epsilon, inputMask.nativeObj);
    }
