...
public class Photo {
    ...
    public static void inpaint(Mat src2, Mat inpaintMask, Mat dst, double inpaintRadius, int flags) {
        inpaint_0(src2.nativeObj, inpaintMask.nativeObj, dst.nativeObj, inpaintRadius, flags);
    }

    public static void fastNlMeansDenoising(Mat src2, Mat dst, float h, int templateWindowSize, int searchWindowSize) {
        fastNlMeansDenoising_0(src2.nativeObj, dst.nativeObj, h, templateWindowSize, searchWindowSize);
    }

    public static void fastNlMeansDenoising(Mat src2, Mat dst, float h, int templateWindowSize) {
        fastNlMeansDenoising_1(src2.nativeObj, dst.nativeObj, h, templateWindowSize);
    }

    public static void fastNlMeansDenoising(Mat src2, Mat dst, float h) {
        fastNlMeansDenoising_2(src2.nativeObj, dst.nativeObj, h);
    }

    public static void fastNlMeansDenoising(Mat src2, Mat dst) {
        fastNlMeansDenoising_3(src2.nativeObj, dst.nativeObj);
    }

    public static void fastNlMeansDenoising(Mat src2, Mat dst, MatOfFloat h, int templateWindowSize, int searchWindowSize, int normType) {
        fastNlMeansDenoising_4(src2.nativeObj, dst.nativeObj, h.nativeObj, templateWindowSize, searchWindowSize, normType);
    }

    public static void fastNlMeansDenoising(Mat src2, Mat dst, MatOfFloat h, int templateWindowSize, int searchWindowSize) {
        fastNlMeansDenoising_5(src2.nativeObj, dst.nativeObj, h.nativeObj, templateWindowSize, searchWindowSize);
    }

    public static void fastNlMeansDenoising(Mat src2, Mat dst, MatOfFloat h, int templateWindowSize) {
        fastNlMeansDenoising_6(src2.nativeObj, dst.nativeObj, h.nativeObj, templateWindowSize);
    }

    public static void fastNlMeansDenoising(Mat src2, Mat dst, MatOfFloat h) {
        fastNlMeansDenoising_7(src2.nativeObj, dst.nativeObj, h.nativeObj);
    }

    public static void fastNlMeansDenoisingColored(Mat src2, Mat dst, float h, float hColor, int templateWindowSize, int searchWindowSize) {
        fastNlMeansDenoisingColored_0(src2.nativeObj, dst.nativeObj, h, hColor, templateWindowSize, searchWindowSize);
    }

    public static void fastNlMeansDenoisingColored(Mat src2, Mat dst, float h, float hColor, int templateWindowSize) {
        fastNlMeansDenoisingColored_1(src2.nativeObj, dst.nativeObj, h, hColor, templateWindowSize);
    }

    public static void fastNlMeansDenoisingColored(Mat src2, Mat dst, float h, float hColor) {
        fastNlMeansDenoisingColored_2(src2.nativeObj, dst.nativeObj, h, hColor);
    }

    public static void fastNlMeansDenoisingColored(Mat src2, Mat dst, float h) {
        fastNlMeansDenoisingColored_3(src2.nativeObj, dst.nativeObj, h);
    }

    public static void fastNlMeansDenoisingColored(Mat src2, Mat dst) {
        fastNlMeansDenoisingColored_4(src2.nativeObj, dst.nativeObj);
    }
    ...
    public static void decolor(Mat src2, Mat grayscale, Mat color_boost) {
        decolor_0(src2.nativeObj, grayscale.nativeObj, color_boost.nativeObj);
    }

    public static void seamlessClone(Mat src2, Mat dst, Mat mask, Point p, Mat blend, int flags) {
        Point point = p;
        seamlessClone_0(src2.nativeObj, dst.nativeObj, mask.nativeObj, point.f175x, point.f176y, blend.nativeObj, flags);
    }

    public static void colorChange(Mat src2, Mat mask, Mat dst, float red_mul, float green_mul, float blue_mul) {
        colorChange_0(src2.nativeObj, mask.nativeObj, dst.nativeObj, red_mul, green_mul, blue_mul);
    }

    public static void colorChange(Mat src2, Mat mask, Mat dst, float red_mul, float green_mul) {
        colorChange_1(src2.nativeObj, mask.nativeObj, dst.nativeObj, red_mul, green_mul);
    }

    public static void colorChange(Mat src2, Mat mask, Mat dst, float red_mul) {
        colorChange_2(src2.nativeObj, mask.nativeObj, dst.nativeObj, red_mul);
    }

    public static void colorChange(Mat src2, Mat mask, Mat dst) {
        colorChange_3(src2.nativeObj, mask.nativeObj, dst.nativeObj);
    }

    public static void illuminationChange(Mat src2, Mat mask, Mat dst, float alpha, float beta) {
        illuminationChange_0(src2.nativeObj, mask.nativeObj, dst.nativeObj, alpha, beta);
    }

    public static void illuminationChange(Mat src2, Mat mask, Mat dst, float alpha) {
        illuminationChange_1(src2.nativeObj, mask.nativeObj, dst.nativeObj, alpha);
    }

    public static void illuminationChange(Mat src2, Mat mask, Mat dst) {
        illuminationChange_2(src2.nativeObj, mask.nativeObj, dst.nativeObj);
    }

    public static void textureFlattening(Mat src2, Mat mask, Mat dst, float low_threshold, float high_threshold, int kernel_size) {
        textureFlattening_0(src2.nativeObj, mask.nativeObj, dst.nativeObj, low_threshold, high_threshold, kernel_size);
    }

    public static void textureFlattening(Mat src2, Mat mask, Mat dst, float low_threshold, float high_threshold) {
        textureFlattening_1(src2.nativeObj, mask.nativeObj, dst.nativeObj, low_threshold, high_threshold);
    }

    public static void textureFlattening(Mat src2, Mat mask, Mat dst, float low_threshold) {
        textureFlattening_2(src2.nativeObj, mask.nativeObj, dst.nativeObj, low_threshold);
    }

    public static void textureFlattening(Mat src2, Mat mask, Mat dst) {
        textureFlattening_3(src2.nativeObj, mask.nativeObj, dst.nativeObj);
    }

    public static void edgePreservingFilter(Mat src2, Mat dst, int flags, float sigma_s, float sigma_r) {
        edgePreservingFilter_0(src2.nativeObj, dst.nativeObj, flags, sigma_s, sigma_r);
    }

    public static void edgePreservingFilter(Mat src2, Mat dst, int flags, float sigma_s) {
        edgePreservingFilter_1(src2.nativeObj, dst.nativeObj, flags, sigma_s);
    }

    public static void edgePreservingFilter(Mat src2, Mat dst, int flags) {
        edgePreservingFilter_2(src2.nativeObj, dst.nativeObj, flags);
    }

    public static void edgePreservingFilter(Mat src2, Mat dst) {
        edgePreservingFilter_3(src2.nativeObj, dst.nativeObj);
    }

    public static void detailEnhance(Mat src2, Mat dst, float sigma_s, float sigma_r) {
        detailEnhance_0(src2.nativeObj, dst.nativeObj, sigma_s, sigma_r);
    }

    public static void detailEnhance(Mat src2, Mat dst, float sigma_s) {
        detailEnhance_1(src2.nativeObj, dst.nativeObj, sigma_s);
    }

    public static void detailEnhance(Mat src2, Mat dst) {
        detailEnhance_2(src2.nativeObj, dst.nativeObj);
    }

    public static void pencilSketch(Mat src2, Mat dst1, Mat dst2, float sigma_s, float sigma_r, float shade_factor) {
        pencilSketch_0(src2.nativeObj, dst1.nativeObj, dst2.nativeObj, sigma_s, sigma_r, shade_factor);
    }

    public static void pencilSketch(Mat src2, Mat dst1, Mat dst2, float sigma_s, float sigma_r) {
        pencilSketch_1(src2.nativeObj, dst1.nativeObj, dst2.nativeObj, sigma_s, sigma_r);
    }

    public static void pencilSketch(Mat src2, Mat dst1, Mat dst2, float sigma_s) {
        pencilSketch_2(src2.nativeObj, dst1.nativeObj, dst2.nativeObj, sigma_s);
    }

    public static void pencilSketch(Mat src2, Mat dst1, Mat dst2) {
        pencilSketch_3(src2.nativeObj, dst1.nativeObj, dst2.nativeObj);
    }

    public static void stylization(Mat src2, Mat dst, float sigma_s, float sigma_r) {
        stylization_0(src2.nativeObj, dst.nativeObj, sigma_s, sigma_r);
    }

    public static void stylization(Mat src2, Mat dst, float sigma_s) {
        stylization_1(src2.nativeObj, dst.nativeObj, sigma_s);
    }

    public static void stylization(Mat src2, Mat dst) {
        stylization_2(src2.nativeObj, dst.nativeObj);
    }
}
