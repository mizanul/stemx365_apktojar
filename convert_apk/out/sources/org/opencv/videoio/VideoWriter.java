...
public class VideoWriter {
    ...
    public VideoWriter(String filename, int fourcc, double fps, Size frameSize, boolean isColor) {
        this.nativeObj = VideoWriter_1(filename, fourcc, fps, frameSize.width, frameSize.height, isColor);
    }

    public VideoWriter(String filename, int fourcc, double fps, Size frameSize) {
        this.nativeObj = VideoWriter_2(filename, fourcc, fps, frameSize.width, frameSize.height);
    }

    public VideoWriter(String filename, int apiPreference, int fourcc, double fps, Size frameSize, boolean isColor) {
        Size size = frameSize;
        this.nativeObj = VideoWriter_3(filename, apiPreference, fourcc, fps, size.width, size.height, isColor);
    }

    public VideoWriter(String filename, int apiPreference, int fourcc, double fps, Size frameSize) {
        this.nativeObj = VideoWriter_4(filename, apiPreference, fourcc, fps, frameSize.width, frameSize.height);
    }

    public VideoWriter(String filename, int fourcc, double fps, Size frameSize, MatOfInt params) {
        Size size = frameSize;
        this.nativeObj = VideoWriter_5(filename, fourcc, fps, size.width, size.height, params.nativeObj);
    }

    public VideoWriter(String filename, int apiPreference, int fourcc, double fps, Size frameSize, MatOfInt params) {
        Size size = frameSize;
        this.nativeObj = VideoWriter_6(filename, apiPreference, fourcc, fps, size.width, size.height, params.nativeObj);
    }

    public boolean open(String filename, int fourcc, double fps, Size frameSize, boolean isColor) {
        Size size = frameSize;
        return open_0(this.nativeObj, filename, fourcc, fps, size.width, size.height, isColor);
    }

    public boolean open(String filename, int fourcc, double fps, Size frameSize) {
        return open_1(this.nativeObj, filename, fourcc, fps, frameSize.width, frameSize.height);
    }

    public boolean open(String filename, int apiPreference, int fourcc, double fps, Size frameSize, boolean isColor) {
        Size size = frameSize;
        return open_2(this.nativeObj, filename, apiPreference, fourcc, fps, size.width, size.height, isColor);
    }

    public boolean open(String filename, int apiPreference, int fourcc, double fps, Size frameSize) {
        Size size = frameSize;
        return open_3(this.nativeObj, filename, apiPreference, fourcc, fps, size.width, size.height);
    }

    public boolean open(String filename, int fourcc, double fps, Size frameSize, MatOfInt params) {
        Size size = frameSize;
        return open_4(this.nativeObj, filename, fourcc, fps, size.width, size.height, params.nativeObj);
    }

    public boolean open(String filename, int apiPreference, int fourcc, double fps, Size frameSize, MatOfInt params) {
        Size size = frameSize;
        return open_5(this.nativeObj, filename, apiPreference, fourcc, fps, size.width, size.height, params.nativeObj);
    }
