...
public class Retina extends Algorithm {
    ...
    private static native long create_1(double d, double d2, boolean z, int i, boolean z2, float f, float f2);

    private static native long create_2(double d, double d2, boolean z, int i, boolean z2, float f);

    private static native long create_3(double d, double d2, boolean z, int i, boolean z2);

    private static native long create_4(double d, double d2, boolean z, int i);

    private static native long create_5(double d, double d2, boolean z);

    private static native void delete(long j);

    private static native double[] getInputSize_0(long j);

    private static native void getMagnoRAW_0(long j, long j2);

    private static native long getMagnoRAW_1(long j);

    private static native void getMagno_0(long j, long j2);

    private static native double[] getOutputSize_0(long j);

    private static native void getParvoRAW_0(long j, long j2);

    private static native long getParvoRAW_1(long j);
    ...
    public void getParvoRAW(Mat retinaOutput_parvo) {
        getParvoRAW_0(this.nativeObj, retinaOutput_parvo.nativeObj);
    }
    ...
    public void getMagnoRAW(Mat retinaOutput_magno) {
        getMagnoRAW_0(this.nativeObj, retinaOutput_magno.nativeObj);
    }

    public Mat getMagnoRAW() {
        return new Mat(getMagnoRAW_1(this.nativeObj));
    }

    public Mat getParvoRAW() {
        return new Mat(getParvoRAW_1(this.nativeObj));
    }
    ...
    public static Retina create(Size inputSize, boolean colorMode, int colorSamplingMethod, boolean useRetinaLogSampling, float reductionFactor, float samplingStrength) {
        return __fromPtr__(create_1(inputSize.width, inputSize.height, colorMode, colorSamplingMethod, useRetinaLogSampling, reductionFactor, samplingStrength));
    }
    ...
    public static Retina create(Size inputSize, boolean colorMode, int colorSamplingMethod, boolean useRetinaLogSampling, float reductionFactor) {
        return __fromPtr__(create_2(inputSize.width, inputSize.height, colorMode, colorSamplingMethod, useRetinaLogSampling, reductionFactor));
    }

    public static Retina create(Size inputSize, boolean colorMode, int colorSamplingMethod, boolean useRetinaLogSampling) {
        return __fromPtr__(create_3(inputSize.width, inputSize.height, colorMode, colorSamplingMethod, useRetinaLogSampling));
    }

    public static Retina create(Size inputSize, boolean colorMode, int colorSamplingMethod) {
        return __fromPtr__(create_4(inputSize.width, inputSize.height, colorMode, colorSamplingMethod));
    }

    public static Retina create(Size inputSize, boolean colorMode) {
        return __fromPtr__(create_5(inputSize.width, inputSize.height, colorMode));
    }
