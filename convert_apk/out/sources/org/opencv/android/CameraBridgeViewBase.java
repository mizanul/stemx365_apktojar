...
public abstract class CameraBridgeViewBase extends SurfaceView implements SurfaceHolder.Callback {
    ...
    public CameraBridgeViewBase(Context context, AttributeSet attrs) {
        ...
        TypedArray styledAttrs = getContext().obtainStyledAttributes(attrs, C0066R.styleable.CameraBridgeViewBase);
        if (styledAttrs.getBoolean(C0066R.styleable.CameraBridgeViewBase_show_fps, false)) {
            enableFpsMeter();
        }
        this.mCameraIndex = styledAttrs.getInt(C0066R.styleable.CameraBridgeViewBase_camera_id, -1);
        getHolder().addCallback(this);
        this.mMaxWidth = -1;
        this.mMaxHeight = -1;
        styledAttrs.recycle();
    ...
    public void SetCaptureFormat(int format) {
        ...
        if (cvCameraViewListener2 instanceof CvCameraViewListenerAdapter) {
            ((CvCameraViewListenerAdapter) cvCameraViewListener2).setFrameFormat(format);
        }
    }
    ...
    public void deliverAndDrawFrame(CvCameraViewFrame frame) {
        ...
        if (modified != null) {
            try {
                ...
                Log.e(TAG, "Bitmap type: " + this.mCacheBitmap.getWidth() + Subscriber.TOPIC_MESSAGE_TYPE_WILDCARD + this.mCacheBitmap.getHeight());
