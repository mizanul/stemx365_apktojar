...
public class KeyPoint {
    ...
    public KeyPoint(float x, float y, float _size, float _angle, float _response, int _octave, int _class_id) {
        this.f165pt = new Point((double) x, (double) y);
        this.size = _size;
        this.angle = _angle;
    ...
    public String toString() {
        return "KeyPoint [pt=" + this.f165pt + ", size=" + this.size + ", angle=" + this.angle + ", response=" + this.response + ", octave=" + this.octave + ", class_id=" + this.class_id + "]";
    }
}
