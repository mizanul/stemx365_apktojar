...
public class Core {
    ...
    public static void copyMakeBorder(Mat src2, Mat dst, int top, int bottom, int left, int right, int borderType, Scalar value) {
        Scalar scalar = value;
        long j = src2.nativeObj;
        long j2 = j;
        copyMakeBorder_0(j2, dst.nativeObj, top, bottom, left, right, borderType, scalar.val[0], scalar.val[1], scalar.val[2], scalar.val[3]);
    }

    public static void copyMakeBorder(Mat src2, Mat dst, int top, int bottom, int left, int right, int borderType) {
        copyMakeBorder_1(src2.nativeObj, dst.nativeObj, top, bottom, left, right, borderType);
    }
    ...
    public static void convertScaleAbs(Mat src2, Mat dst, double alpha, double beta) {
        convertScaleAbs_0(src2.nativeObj, dst.nativeObj, alpha, beta);
    }

    public static void convertScaleAbs(Mat src2, Mat dst, double alpha) {
        convertScaleAbs_1(src2.nativeObj, dst.nativeObj, alpha);
    }

    public static void convertScaleAbs(Mat src2, Mat dst) {
        convertScaleAbs_2(src2.nativeObj, dst.nativeObj);
    }

    public static void convertFp16(Mat src2, Mat dst) {
        convertFp16_0(src2.nativeObj, dst.nativeObj);
    }

    public static void LUT(Mat src2, Mat lut, Mat dst) {
        LUT_0(src2.nativeObj, lut.nativeObj, dst.nativeObj);
    }

    public static Scalar sumElems(Mat src2) {
        return new Scalar(sumElems_0(src2.nativeObj));
    }

    public static int countNonZero(Mat src2) {
        return countNonZero_0(src2.nativeObj);
    }

    public static void findNonZero(Mat src2, Mat idx) {
        findNonZero_0(src2.nativeObj, idx.nativeObj);
    }

    public static Scalar mean(Mat src2, Mat mask) {
        return new Scalar(mean_0(src2.nativeObj, mask.nativeObj));
    }

    public static Scalar mean(Mat src2) {
        return new Scalar(mean_1(src2.nativeObj));
    }

    public static void meanStdDev(Mat src2, MatOfDouble mean, MatOfDouble stddev, Mat mask) {
        meanStdDev_0(src2.nativeObj, mean.nativeObj, stddev.nativeObj, mask.nativeObj);
    }

    public static void meanStdDev(Mat src2, MatOfDouble mean, MatOfDouble stddev) {
        meanStdDev_1(src2.nativeObj, mean.nativeObj, stddev.nativeObj);
    }
    ...
    public static void normalize(Mat src2, Mat dst, double alpha, double beta, int norm_type, int dtype, Mat mask) {
        normalize_0(src2.nativeObj, dst.nativeObj, alpha, beta, norm_type, dtype, mask.nativeObj);
    }

    public static void normalize(Mat src2, Mat dst, double alpha, double beta, int norm_type, int dtype) {
        normalize_1(src2.nativeObj, dst.nativeObj, alpha, beta, norm_type, dtype);
    }

    public static void normalize(Mat src2, Mat dst, double alpha, double beta, int norm_type) {
        normalize_2(src2.nativeObj, dst.nativeObj, alpha, beta, norm_type);
    }

    public static void normalize(Mat src2, Mat dst, double alpha, double beta) {
        normalize_3(src2.nativeObj, dst.nativeObj, alpha, beta);
    }

    public static void normalize(Mat src2, Mat dst, double alpha) {
        normalize_4(src2.nativeObj, dst.nativeObj, alpha);
    }

    public static void normalize(Mat src2, Mat dst) {
        normalize_5(src2.nativeObj, dst.nativeObj);
    }

    public static void reduce(Mat src2, Mat dst, int dim, int rtype, int dtype) {
        reduce_0(src2.nativeObj, dst.nativeObj, dim, rtype, dtype);
    }

    public static void reduce(Mat src2, Mat dst, int dim, int rtype) {
        reduce_1(src2.nativeObj, dst.nativeObj, dim, rtype);
    }
    ...
    public static void mixChannels(List<Mat> src2, List<Mat> dst, MatOfInt fromTo) {
        mixChannels_0(Converters.vector_Mat_to_Mat(src2).nativeObj, Converters.vector_Mat_to_Mat(dst).nativeObj, fromTo.nativeObj);
    }

    public static void extractChannel(Mat src2, Mat dst, int coi) {
        extractChannel_0(src2.nativeObj, dst.nativeObj, coi);
    }

    public static void insertChannel(Mat src2, Mat dst, int coi) {
        insertChannel_0(src2.nativeObj, dst.nativeObj, coi);
    }

    public static void flip(Mat src2, Mat dst, int flipCode) {
        flip_0(src2.nativeObj, dst.nativeObj, flipCode);
    }

    public static void rotate(Mat src2, Mat dst, int rotateCode) {
        rotate_0(src2.nativeObj, dst.nativeObj, rotateCode);
    }

    public static void repeat(Mat src2, int ny, int nx, Mat dst) {
        repeat_0(src2.nativeObj, ny, nx, dst.nativeObj);
    }

    public static void hconcat(List<Mat> src2, Mat dst) {
        hconcat_0(Converters.vector_Mat_to_Mat(src2).nativeObj, dst.nativeObj);
    }

    public static void vconcat(List<Mat> src2, Mat dst) {
        vconcat_0(Converters.vector_Mat_to_Mat(src2).nativeObj, dst.nativeObj);
    }
    ...
    public static void bitwise_not(Mat src2, Mat dst, Mat mask) {
        bitwise_not_0(src2.nativeObj, dst.nativeObj, mask.nativeObj);
    }

    public static void bitwise_not(Mat src2, Mat dst) {
        bitwise_not_1(src2.nativeObj, dst.nativeObj);
    }
    ...
    public static void copyTo(Mat src2, Mat dst, Mat mask) {
        copyTo_0(src2.nativeObj, dst.nativeObj, mask.nativeObj);
    }

    public static void inRange(Mat src2, Scalar lowerb, Scalar upperb, Mat dst) {
        Scalar scalar = lowerb;
        Scalar scalar2 = upperb;
        inRange_0(src2.nativeObj, scalar.val[0], scalar.val[1], scalar.val[2], scalar.val[3], scalar2.val[0], scalar2.val[1], scalar2.val[2], scalar2.val[3], dst.nativeObj);
    }
    ...
    public static void sqrt(Mat src2, Mat dst) {
        sqrt_0(src2.nativeObj, dst.nativeObj);
    }

    public static void pow(Mat src2, double power, Mat dst) {
        pow_0(src2.nativeObj, power, dst.nativeObj);
    }

    public static void exp(Mat src2, Mat dst) {
        exp_0(src2.nativeObj, dst.nativeObj);
    }

    public static void log(Mat src2, Mat dst) {
        log_0(src2.nativeObj, dst.nativeObj);
    }
    ...
    public static void mulTransposed(Mat src2, Mat dst, boolean aTa, Mat delta, double scale, int dtype) {
        mulTransposed_0(src2.nativeObj, dst.nativeObj, aTa, delta.nativeObj, scale, dtype);
    }

    public static void mulTransposed(Mat src2, Mat dst, boolean aTa, Mat delta, double scale) {
        mulTransposed_1(src2.nativeObj, dst.nativeObj, aTa, delta.nativeObj, scale);
    }

    public static void mulTransposed(Mat src2, Mat dst, boolean aTa, Mat delta) {
        mulTransposed_2(src2.nativeObj, dst.nativeObj, aTa, delta.nativeObj);
    }

    public static void mulTransposed(Mat src2, Mat dst, boolean aTa) {
        mulTransposed_3(src2.nativeObj, dst.nativeObj, aTa);
    }

    public static void transpose(Mat src2, Mat dst) {
        transpose_0(src2.nativeObj, dst.nativeObj);
    }

    public static void transform(Mat src2, Mat dst, Mat m) {
        transform_0(src2.nativeObj, dst.nativeObj, m.nativeObj);
    }

    public static void perspectiveTransform(Mat src2, Mat dst, Mat m) {
        perspectiveTransform_0(src2.nativeObj, dst.nativeObj, m.nativeObj);
    }
    ...
    public static double invert(Mat src2, Mat dst, int flags) {
        return invert_0(src2.nativeObj, dst.nativeObj, flags);
    }

    public static double invert(Mat src2, Mat dst) {
        return invert_1(src2.nativeObj, dst.nativeObj);
    }
    ...
    public static void sort(Mat src2, Mat dst, int flags) {
        sort_0(src2.nativeObj, dst.nativeObj, flags);
    }

    public static void sortIdx(Mat src2, Mat dst, int flags) {
        sortIdx_0(src2.nativeObj, dst.nativeObj, flags);
    }
    ...
    public static boolean eigen(Mat src2, Mat eigenvalues, Mat eigenvectors) {
        return eigen_0(src2.nativeObj, eigenvalues.nativeObj, eigenvectors.nativeObj);
    }

    public static boolean eigen(Mat src2, Mat eigenvalues) {
        return eigen_1(src2.nativeObj, eigenvalues.nativeObj);
    }

    public static void eigenNonSymmetric(Mat src2, Mat eigenvalues, Mat eigenvectors) {
        eigenNonSymmetric_0(src2.nativeObj, eigenvalues.nativeObj, eigenvectors.nativeObj);
    }
    ...
    public static void SVDecomp(Mat src2, Mat w, Mat u, Mat vt, int flags) {
        SVDecomp_0(src2.nativeObj, w.nativeObj, u.nativeObj, vt.nativeObj, flags);
    }

    public static void SVDecomp(Mat src2, Mat w, Mat u, Mat vt) {
        SVDecomp_1(src2.nativeObj, w.nativeObj, u.nativeObj, vt.nativeObj);
    }
    ...
    public static void dft(Mat src2, Mat dst, int flags, int nonzeroRows) {
        dft_0(src2.nativeObj, dst.nativeObj, flags, nonzeroRows);
    }

    public static void dft(Mat src2, Mat dst, int flags) {
        dft_1(src2.nativeObj, dst.nativeObj, flags);
    }

    public static void dft(Mat src2, Mat dst) {
        dft_2(src2.nativeObj, dst.nativeObj);
    }

    public static void idft(Mat src2, Mat dst, int flags, int nonzeroRows) {
        idft_0(src2.nativeObj, dst.nativeObj, flags, nonzeroRows);
    }

    public static void idft(Mat src2, Mat dst, int flags) {
        idft_1(src2.nativeObj, dst.nativeObj, flags);
    }

    public static void idft(Mat src2, Mat dst) {
        idft_2(src2.nativeObj, dst.nativeObj);
    }

    public static void dct(Mat src2, Mat dst, int flags) {
        dct_0(src2.nativeObj, dst.nativeObj, flags);
    }

    public static void dct(Mat src2, Mat dst) {
        dct_1(src2.nativeObj, dst.nativeObj);
    }

    public static void idct(Mat src2, Mat dst, int flags) {
        idct_0(src2.nativeObj, dst.nativeObj, flags);
    }

    public static void idct(Mat src2, Mat dst) {
        idct_1(src2.nativeObj, dst.nativeObj);
    }
    ...
    public static double kmeans(Mat data, int K, Mat bestLabels, TermCriteria criteria, int attempts, int flags, Mat centers) {
        ...
        return kmeans_0(data.nativeObj, K, bestLabels.nativeObj, termCriteria.type, termCriteria.maxCount, termCriteria.epsilon, attempts, flags, centers.nativeObj);
    }

    public static double kmeans(Mat data, int K, Mat bestLabels, TermCriteria criteria, int attempts, int flags) {
        TermCriteria termCriteria = criteria;
        return kmeans_1(data.nativeObj, K, bestLabels.nativeObj, termCriteria.type, termCriteria.maxCount, termCriteria.epsilon, attempts, flags);
    }
    ...
    public static void subtract(Mat src1, Scalar src2, Mat dst, Mat mask, int dtype) {
        Scalar scalar = src2;
        subtract_3(src1.nativeObj, scalar.val[0], scalar.val[1], scalar.val[2], scalar.val[3], dst.nativeObj, mask.nativeObj, dtype);
    }

    public static void subtract(Mat src1, Scalar src2, Mat dst, Mat mask) {
        Scalar scalar = src2;
        subtract_4(src1.nativeObj, scalar.val[0], scalar.val[1], scalar.val[2], scalar.val[3], dst.nativeObj, mask.nativeObj);
    }
    ...
    public static void multiply(Mat src1, Scalar src2, Mat dst, double scale, int dtype) {
        Scalar scalar = src2;
        multiply_3(src1.nativeObj, scalar.val[0], scalar.val[1], scalar.val[2], scalar.val[3], dst.nativeObj, scale, dtype);
    }

    public static void multiply(Mat src1, Scalar src2, Mat dst, double scale) {
        Scalar scalar = src2;
        multiply_4(src1.nativeObj, scalar.val[0], scalar.val[1], scalar.val[2], scalar.val[3], dst.nativeObj, scale);
    }
    ...
    public static void divide(Mat src1, Scalar src2, Mat dst, double scale, int dtype) {
        Scalar scalar = src2;
        divide_5(src1.nativeObj, scalar.val[0], scalar.val[1], scalar.val[2], scalar.val[3], dst.nativeObj, scale, dtype);
    }

    public static void divide(Mat src1, Scalar src2, Mat dst, double scale) {
        Scalar scalar = src2;
        divide_6(src1.nativeObj, scalar.val[0], scalar.val[1], scalar.val[2], scalar.val[3], dst.nativeObj, scale);
    }
    ...
    public static void compare(Mat src1, Scalar src2, Mat dst, int cmpop) {
        Scalar scalar = src2;
        compare_1(src1.nativeObj, scalar.val[0], scalar.val[1], scalar.val[2], scalar.val[3], dst.nativeObj, cmpop);
    }
    ...
    public static MinMaxLocResult minMaxLoc(Mat src2, Mat mask) {
        MinMaxLocResult res = new MinMaxLocResult();
        long maskNativeObj = 0;
        if (mask != null) {
            maskNativeObj = mask.nativeObj;
        }
        double[] resarr = n_minMaxLocManual(src2.nativeObj, maskNativeObj);
        res.minVal = resarr[0];
        res.maxVal = resarr[1];
        res.minLoc.f175x = resarr[2];
        res.minLoc.f176y = resarr[3];
        res.maxLoc.f175x = resarr[4];
        res.maxLoc.f176y = resarr[5];
        return res;
    }

    public static MinMaxLocResult minMaxLoc(Mat src2) {
        return minMaxLoc(src2, (Mat) null);
    }
}
