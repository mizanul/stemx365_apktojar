...
public class C0934EM extends StatModel {
    ...
    protected C0934EM(long addr) {
        super(addr);
    }

    public static C0934EM __fromPtr__(long addr) {
        return new C0934EM(addr);
    }
    ...
    public static C0934EM create() {
        return __fromPtr__(create_0());
    }

    public static C0934EM load(String filepath, String nodeName) {
        return __fromPtr__(load_0(filepath, nodeName));
    }

    public static C0934EM load(String filepath) {
