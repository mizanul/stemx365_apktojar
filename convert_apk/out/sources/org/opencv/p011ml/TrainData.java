...
public class TrainData {
    ...
    public Mat getTrainSamples(int layout, boolean compressSamples) {
        return new Mat(getTrainSamples_1(this.nativeObj, layout, compressSamples));
    }

    public Mat getTrainSamples(int layout) {
        return new Mat(getTrainSamples_2(this.nativeObj, layout));
    }
    ...
    public static TrainData create(Mat samples, int layout, Mat responses, Mat varIdx, Mat sampleIdx, Mat sampleWeights, Mat varType) {
        return __fromPtr__(create_0(samples.nativeObj, layout, responses.nativeObj, varIdx.nativeObj, sampleIdx.nativeObj, sampleWeights.nativeObj, varType.nativeObj));
    }

    public static TrainData create(Mat samples, int layout, Mat responses, Mat varIdx, Mat sampleIdx, Mat sampleWeights) {
        return __fromPtr__(create_1(samples.nativeObj, layout, responses.nativeObj, varIdx.nativeObj, sampleIdx.nativeObj, sampleWeights.nativeObj));
    }

    public static TrainData create(Mat samples, int layout, Mat responses, Mat varIdx, Mat sampleIdx) {
        return __fromPtr__(create_2(samples.nativeObj, layout, responses.nativeObj, varIdx.nativeObj, sampleIdx.nativeObj));
    }

    public static TrainData create(Mat samples, int layout, Mat responses, Mat varIdx) {
        return __fromPtr__(create_3(samples.nativeObj, layout, responses.nativeObj, varIdx.nativeObj));
    }

    public static TrainData create(Mat samples, int layout, Mat responses) {
        return __fromPtr__(create_4(samples.nativeObj, layout, responses.nativeObj));
    }
