...
public class DisparityFilter extends Algorithm {
    ...
    public void filter(Mat disparity_map_left, Mat left_view, Mat filtered_disparity_map, Mat disparity_map_right, Rect ROI) {
        Rect rect = ROI;
        filter_1(this.nativeObj, disparity_map_left.nativeObj, left_view.nativeObj, filtered_disparity_map.nativeObj, disparity_map_right.nativeObj, rect.f180x, rect.f181y, rect.width, rect.height);
    }
