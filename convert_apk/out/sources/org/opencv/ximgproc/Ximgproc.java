...
public class Ximgproc {
    ...
    private static native double computeBadPixelPercent_0(long j, long j2, int i, int i2, int i3, int i4, int i5);

    private static native double computeBadPixelPercent_1(long j, long j2, int i, int i2, int i3, int i4);

    private static native double computeMSE_0(long j, long j2, int i, int i2, int i3, int i4);
    ...
    private static native long createSelectiveSearchSegmentationStrategyMultiple_1(long j);

    private static native long createSelectiveSearchSegmentationStrategyMultiple_2(long j, long j2);

    private static native long createSelectiveSearchSegmentationStrategyMultiple_3(long j, long j2, long j3);

    private static native long createSelectiveSearchSegmentationStrategyMultiple_4(long j, long j2, long j3, long j4);
    ...
    private static native void getDisparityVis_0(long j, long j2, double d);

    private static native void getDisparityVis_1(long j, long j2);
    ...
    private static native int readGT_0(String str, long j);
    ...
    public static void thinning(Mat src2, Mat dst, int thinningType) {
        thinning_0(src2.nativeObj, dst.nativeObj, thinningType);
    }

    public static void thinning(Mat src2, Mat dst) {
        thinning_1(src2.nativeObj, dst.nativeObj);
    }

    public static void anisotropicDiffusion(Mat src2, Mat dst, float alpha, float K, int niters) {
        anisotropicDiffusion_0(src2.nativeObj, dst.nativeObj, alpha, K, niters);
    }
    ...
    public static void edgePreservingFilter(Mat src2, Mat dst, int d, double threshold) {
        edgePreservingFilter_0(src2.nativeObj, dst.nativeObj, d, threshold);
    }

    public static void fourierDescriptor(Mat src2, Mat dst, int nbElt, int nbFD) {
        fourierDescriptor_0(src2.nativeObj, dst.nativeObj, nbElt, nbFD);
    }

    public static void fourierDescriptor(Mat src2, Mat dst, int nbElt) {
        fourierDescriptor_1(src2.nativeObj, dst.nativeObj, nbElt);
    }

    public static void fourierDescriptor(Mat src2, Mat dst) {
        fourierDescriptor_2(src2.nativeObj, dst.nativeObj);
    }

    public static void transformFD(Mat src2, Mat t, Mat dst, boolean fdContour) {
        transformFD_0(src2.nativeObj, t.nativeObj, dst.nativeObj, fdContour);
    }

    public static void transformFD(Mat src2, Mat t, Mat dst) {
        transformFD_1(src2.nativeObj, t.nativeObj, dst.nativeObj);
    }

    public static void contourSampling(Mat src2, Mat out, int nbElt) {
        contourSampling_0(src2.nativeObj, out.nativeObj, nbElt);
    }
    ...
    public static double computeMSE(Mat GT, Mat src2, Rect ROI) {
        return computeMSE_0(GT.nativeObj, src2.nativeObj, ROI.f180x, ROI.f181y, ROI.width, ROI.height);
    }

    public static double computeBadPixelPercent(Mat GT, Mat src2, Rect ROI, int thresh) {
        return computeBadPixelPercent_0(GT.nativeObj, src2.nativeObj, ROI.f180x, ROI.f181y, ROI.width, ROI.height, thresh);
    }

    public static double computeBadPixelPercent(Mat GT, Mat src2, Rect ROI) {
        return computeBadPixelPercent_1(GT.nativeObj, src2.nativeObj, ROI.f180x, ROI.f181y, ROI.width, ROI.height);
    }

    public static void getDisparityVis(Mat src2, Mat dst, double scale) {
        getDisparityVis_0(src2.nativeObj, dst.nativeObj, scale);
    }

    public static void getDisparityVis(Mat src2, Mat dst) {
        getDisparityVis_1(src2.nativeObj, dst.nativeObj);
    }
    ...
    public static void covarianceEstimation(Mat src2, Mat dst, int windowRows, int windowCols) {
        covarianceEstimation_0(src2.nativeObj, dst.nativeObj, windowRows, windowCols);
    }
    ...
    public static void dtFilter(Mat guide, Mat src2, Mat dst, double sigmaSpatial, double sigmaColor, int mode, int numIters) {
        dtFilter_0(guide.nativeObj, src2.nativeObj, dst.nativeObj, sigmaSpatial, sigmaColor, mode, numIters);
    }

    public static void dtFilter(Mat guide, Mat src2, Mat dst, double sigmaSpatial, double sigmaColor, int mode) {
        dtFilter_1(guide.nativeObj, src2.nativeObj, dst.nativeObj, sigmaSpatial, sigmaColor, mode);
    }

    public static void dtFilter(Mat guide, Mat src2, Mat dst, double sigmaSpatial, double sigmaColor) {
        dtFilter_2(guide.nativeObj, src2.nativeObj, dst.nativeObj, sigmaSpatial, sigmaColor);
    }
    ...
    public static void guidedFilter(Mat guide, Mat src2, Mat dst, int radius, double eps, int dDepth) {
        guidedFilter_0(guide.nativeObj, src2.nativeObj, dst.nativeObj, radius, eps, dDepth);
    }

    public static void guidedFilter(Mat guide, Mat src2, Mat dst, int radius, double eps) {
        guidedFilter_1(guide.nativeObj, src2.nativeObj, dst.nativeObj, radius, eps);
    }
    ...
    public static void amFilter(Mat joint, Mat src2, Mat dst, double sigma_s, double sigma_r, boolean adjust_outliers) {
        amFilter_0(joint.nativeObj, src2.nativeObj, dst.nativeObj, sigma_s, sigma_r, adjust_outliers);
    }

    public static void amFilter(Mat joint, Mat src2, Mat dst, double sigma_s, double sigma_r) {
        amFilter_1(joint.nativeObj, src2.nativeObj, dst.nativeObj, sigma_s, sigma_r);
    }

    public static void jointBilateralFilter(Mat joint, Mat src2, Mat dst, int d, double sigmaColor, double sigmaSpace, int borderType) {
        jointBilateralFilter_0(joint.nativeObj, src2.nativeObj, dst.nativeObj, d, sigmaColor, sigmaSpace, borderType);
    }

    public static void jointBilateralFilter(Mat joint, Mat src2, Mat dst, int d, double sigmaColor, double sigmaSpace) {
        jointBilateralFilter_1(joint.nativeObj, src2.nativeObj, dst.nativeObj, d, sigmaColor, sigmaSpace);
    }

    public static void bilateralTextureFilter(Mat src2, Mat dst, int fr, int numIter, double sigmaAlpha, double sigmaAvg) {
        bilateralTextureFilter_0(src2.nativeObj, dst.nativeObj, fr, numIter, sigmaAlpha, sigmaAvg);
    }

    public static void bilateralTextureFilter(Mat src2, Mat dst, int fr, int numIter, double sigmaAlpha) {
        bilateralTextureFilter_1(src2.nativeObj, dst.nativeObj, fr, numIter, sigmaAlpha);
    }

    public static void bilateralTextureFilter(Mat src2, Mat dst, int fr, int numIter) {
        bilateralTextureFilter_2(src2.nativeObj, dst.nativeObj, fr, numIter);
    }

    public static void bilateralTextureFilter(Mat src2, Mat dst, int fr) {
        bilateralTextureFilter_3(src2.nativeObj, dst.nativeObj, fr);
    }

    public static void bilateralTextureFilter(Mat src2, Mat dst) {
        bilateralTextureFilter_4(src2.nativeObj, dst.nativeObj);
    }

    public static void rollingGuidanceFilter(Mat src2, Mat dst, int d, double sigmaColor, double sigmaSpace, int numOfIter, int borderType) {
        rollingGuidanceFilter_0(src2.nativeObj, dst.nativeObj, d, sigmaColor, sigmaSpace, numOfIter, borderType);
    }

    public static void rollingGuidanceFilter(Mat src2, Mat dst, int d, double sigmaColor, double sigmaSpace, int numOfIter) {
        rollingGuidanceFilter_1(src2.nativeObj, dst.nativeObj, d, sigmaColor, sigmaSpace, numOfIter);
    }

    public static void rollingGuidanceFilter(Mat src2, Mat dst, int d, double sigmaColor, double sigmaSpace) {
        rollingGuidanceFilter_2(src2.nativeObj, dst.nativeObj, d, sigmaColor, sigmaSpace);
    }

    public static void rollingGuidanceFilter(Mat src2, Mat dst, int d, double sigmaColor) {
        rollingGuidanceFilter_3(src2.nativeObj, dst.nativeObj, d, sigmaColor);
    }

    public static void rollingGuidanceFilter(Mat src2, Mat dst, int d) {
        rollingGuidanceFilter_4(src2.nativeObj, dst.nativeObj, d);
    }

    public static void rollingGuidanceFilter(Mat src2, Mat dst) {
        rollingGuidanceFilter_5(src2.nativeObj, dst.nativeObj);
    }
    ...
    public static void fastBilateralSolverFilter(Mat guide, Mat src2, Mat confidence, Mat dst, double sigma_spatial, double sigma_luma, double sigma_chroma, double lambda, int num_iter, double max_tol) {
        long j = guide.nativeObj;
        long j2 = j;
        fastBilateralSolverFilter_0(j2, src2.nativeObj, confidence.nativeObj, dst.nativeObj, sigma_spatial, sigma_luma, sigma_chroma, lambda, num_iter, max_tol);
    }

    public static void fastBilateralSolverFilter(Mat guide, Mat src2, Mat confidence, Mat dst, double sigma_spatial, double sigma_luma, double sigma_chroma, double lambda, int num_iter) {
        long j = guide.nativeObj;
        long j2 = j;
        fastBilateralSolverFilter_1(j2, src2.nativeObj, confidence.nativeObj, dst.nativeObj, sigma_spatial, sigma_luma, sigma_chroma, lambda, num_iter);
    }

    public static void fastBilateralSolverFilter(Mat guide, Mat src2, Mat confidence, Mat dst, double sigma_spatial, double sigma_luma, double sigma_chroma, double lambda) {
        fastBilateralSolverFilter_2(guide.nativeObj, src2.nativeObj, confidence.nativeObj, dst.nativeObj, sigma_spatial, sigma_luma, sigma_chroma, lambda);
    }

    public static void fastBilateralSolverFilter(Mat guide, Mat src2, Mat confidence, Mat dst, double sigma_spatial, double sigma_luma, double sigma_chroma) {
        fastBilateralSolverFilter_3(guide.nativeObj, src2.nativeObj, confidence.nativeObj, dst.nativeObj, sigma_spatial, sigma_luma, sigma_chroma);
    }

    public static void fastBilateralSolverFilter(Mat guide, Mat src2, Mat confidence, Mat dst, double sigma_spatial, double sigma_luma) {
        fastBilateralSolverFilter_4(guide.nativeObj, src2.nativeObj, confidence.nativeObj, dst.nativeObj, sigma_spatial, sigma_luma);
    }

    public static void fastBilateralSolverFilter(Mat guide, Mat src2, Mat confidence, Mat dst, double sigma_spatial) {
        fastBilateralSolverFilter_5(guide.nativeObj, src2.nativeObj, confidence.nativeObj, dst.nativeObj, sigma_spatial);
    }

    public static void fastBilateralSolverFilter(Mat guide, Mat src2, Mat confidence, Mat dst) {
        fastBilateralSolverFilter_6(guide.nativeObj, src2.nativeObj, confidence.nativeObj, dst.nativeObj);
    }
    ...
    public static void fastGlobalSmootherFilter(Mat guide, Mat src2, Mat dst, double lambda, double sigma_color, double lambda_attenuation, int num_iter) {
        fastGlobalSmootherFilter_0(guide.nativeObj, src2.nativeObj, dst.nativeObj, lambda, sigma_color, lambda_attenuation, num_iter);
    }

    public static void fastGlobalSmootherFilter(Mat guide, Mat src2, Mat dst, double lambda, double sigma_color, double lambda_attenuation) {
        fastGlobalSmootherFilter_1(guide.nativeObj, src2.nativeObj, dst.nativeObj, lambda, sigma_color, lambda_attenuation);
    }

    public static void fastGlobalSmootherFilter(Mat guide, Mat src2, Mat dst, double lambda, double sigma_color) {
        fastGlobalSmootherFilter_2(guide.nativeObj, src2.nativeObj, dst.nativeObj, lambda, sigma_color);
    }

    public static void l0Smooth(Mat src2, Mat dst, double lambda, double kappa) {
        l0Smooth_0(src2.nativeObj, dst.nativeObj, lambda, kappa);
    }

    public static void l0Smooth(Mat src2, Mat dst, double lambda) {
        l0Smooth_1(src2.nativeObj, dst.nativeObj, lambda);
    }

    public static void l0Smooth(Mat src2, Mat dst) {
        l0Smooth_2(src2.nativeObj, dst.nativeObj);
    }

    public static void FastHoughTransform(Mat src2, Mat dst, int dstMatDepth, int angleRange, int op, int makeSkew) {
        FastHoughTransform_0(src2.nativeObj, dst.nativeObj, dstMatDepth, angleRange, op, makeSkew);
    }

    public static void FastHoughTransform(Mat src2, Mat dst, int dstMatDepth, int angleRange, int op) {
        FastHoughTransform_1(src2.nativeObj, dst.nativeObj, dstMatDepth, angleRange, op);
    }

    public static void FastHoughTransform(Mat src2, Mat dst, int dstMatDepth, int angleRange) {
        FastHoughTransform_2(src2.nativeObj, dst.nativeObj, dstMatDepth, angleRange);
    }

    public static void FastHoughTransform(Mat src2, Mat dst, int dstMatDepth) {
        FastHoughTransform_3(src2.nativeObj, dst.nativeObj, dstMatDepth);
    }
    ...
    public static void weightedMedianFilter(Mat joint, Mat src2, Mat dst, int r, double sigma, int weightType, Mat mask) {
        weightedMedianFilter_0(joint.nativeObj, src2.nativeObj, dst.nativeObj, r, sigma, weightType, mask.nativeObj);
    }

    public static void weightedMedianFilter(Mat joint, Mat src2, Mat dst, int r, double sigma, int weightType) {
        weightedMedianFilter_1(joint.nativeObj, src2.nativeObj, dst.nativeObj, r, sigma, weightType);
    }

    public static void weightedMedianFilter(Mat joint, Mat src2, Mat dst, int r, double sigma) {
        weightedMedianFilter_2(joint.nativeObj, src2.nativeObj, dst.nativeObj, r, sigma);
    }

    public static void weightedMedianFilter(Mat joint, Mat src2, Mat dst, int r) {
        weightedMedianFilter_3(joint.nativeObj, src2.nativeObj, dst.nativeObj, r);
    }
