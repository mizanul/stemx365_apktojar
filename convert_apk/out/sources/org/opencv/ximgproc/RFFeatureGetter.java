...
public class RFFeatureGetter extends Algorithm {
    ...
    public void getFeatures(Mat src2, Mat features, int gnrmRad, int gsmthRad, int shrink, int outNum, int gradNum) {
        getFeatures_0(this.nativeObj, src2.nativeObj, features.nativeObj, gnrmRad, gsmthRad, shrink, outNum, gradNum);
    }
