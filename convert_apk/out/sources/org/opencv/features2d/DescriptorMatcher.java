...
public class DescriptorMatcher extends Algorithm {
    ...
    public void knnMatch(Mat queryDescriptors, List<MatOfDMatch> matches, int k, List<Mat> masks, boolean compactResult) {
        Mat matches_mat = new Mat();
        int i = k;
        knnMatch_3(this.nativeObj, queryDescriptors.nativeObj, matches_mat.nativeObj, i, Converters.vector_Mat_to_Mat(masks).nativeObj, compactResult);
        Converters.Mat_to_vector_vector_DMatch(matches_mat, matches);
        matches_mat.release();
    }
    ...
    public void knnMatch(Mat queryDescriptors, List<MatOfDMatch> matches, int k, List<Mat> masks) {
        Mat matches_mat = new Mat();
        int i = k;
        knnMatch_4(this.nativeObj, queryDescriptors.nativeObj, matches_mat.nativeObj, i, Converters.vector_Mat_to_Mat(masks).nativeObj);
        Converters.Mat_to_vector_vector_DMatch(matches_mat, matches);
        matches_mat.release();
    }
    ...
    public void radiusMatch(Mat queryDescriptors, List<MatOfDMatch> matches, float maxDistance, List<Mat> masks, boolean compactResult) {
        Mat matches_mat = new Mat();
        float f = maxDistance;
        radiusMatch_3(this.nativeObj, queryDescriptors.nativeObj, matches_mat.nativeObj, f, Converters.vector_Mat_to_Mat(masks).nativeObj, compactResult);
        Converters.Mat_to_vector_vector_DMatch(matches_mat, matches);
        matches_mat.release();
    }
    ...
    public void radiusMatch(Mat queryDescriptors, List<MatOfDMatch> matches, float maxDistance, List<Mat> masks) {
        Mat matches_mat = new Mat();
        float f = maxDistance;
        radiusMatch_4(this.nativeObj, queryDescriptors.nativeObj, matches_mat.nativeObj, f, Converters.vector_Mat_to_Mat(masks).nativeObj);
        Converters.Mat_to_vector_vector_DMatch(matches_mat, matches);
        matches_mat.release();
    }
    ...
    public static DescriptorMatcher create(String descriptorMatcherType) {
        return __fromPtr__(create_0(descriptorMatcherType));
    }

    public static DescriptorMatcher create(int matcherType) {
        return __fromPtr__(create_1(matcherType));
    }
