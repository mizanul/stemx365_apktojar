...
public class Features2d {
    ...
    public static void drawMatches(Mat img1, MatOfKeyPoint keypoints1, Mat img2, MatOfKeyPoint keypoints2, MatOfDMatch matches1to2, Mat outImg, Scalar matchColor, Scalar singlePointColor, MatOfByte matchesMask, int flags) {
        ...
        MatOfDMatch matOfDMatch3 = matOfDMatch2;
    ...
    public static void drawMatches(Mat img1, MatOfKeyPoint keypoints1, Mat img2, MatOfKeyPoint keypoints2, MatOfDMatch matches1to2, Mat outImg, int matchesThickness, Scalar matchColor, Scalar singlePointColor, MatOfByte matchesMask, int flags) {
        ...
        long j3 = img2.nativeObj;
        long j4 = matOfKeyPoint2.nativeObj;
        long j5 = matOfDMatch.nativeObj;
        long j6 = j;
        MatOfByte matOfByte = matchesMask;
        MatOfKeyPoint matOfKeyPoint3 = matOfKeyPoint2;
        long j7 = outImg.nativeObj;
        MatOfKeyPoint matOfKeyPoint4 = matOfKeyPoint3;
        MatOfDMatch matOfDMatch2 = matOfDMatch;
        MatOfKeyPoint matOfKeyPoint5 = matOfKeyPoint;
        double d = scalar.val[0];
        double d2 = scalar.val[1];
        double d3 = scalar.val[2];
        double d4 = scalar.val[3];
        double d5 = scalar2.val[0];
        double d6 = scalar2.val[1];
        double d7 = scalar2.val[2];
        double d8 = scalar2.val[3];
        long j8 = matOfByte.nativeObj;
        MatOfByte matOfByte2 = matOfByte;
        drawMatches_5(j6, j2, j3, j4, j5, j7, matchesThickness, d, d2, d3, d4, d5, d6, d7, d8, j8, flags);
    }
    ...
    public static void drawMatches(Mat img1, MatOfKeyPoint keypoints1, Mat img2, MatOfKeyPoint keypoints2, MatOfDMatch matches1to2, Mat outImg, int matchesThickness, Scalar matchColor, Scalar singlePointColor, MatOfByte matchesMask) {
        ...
        MatOfDMatch matOfDMatch2 = matOfDMatch;
        MatOfKeyPoint matOfKeyPoint5 = matOfKeyPoint;
        double d = scalar.val[1];
        double d2 = scalar.val[2];
        double d3 = scalar.val[3];
        double d4 = scalar2.val[0];
        double d5 = scalar2.val[1];
        double d6 = scalar2.val[2];
        double d7 = scalar2.val[3];
        long j8 = matOfByte.nativeObj;
        MatOfByte matOfByte2 = matOfByte;
        drawMatches_6(j6, j2, j3, j4, j5, j7, matchesThickness, scalar.val[0], d, d2, d3, d4, d5, d6, d7, j8);
    }
    ...
    public static void drawMatches(Mat img1, MatOfKeyPoint keypoints1, Mat img2, MatOfKeyPoint keypoints2, MatOfDMatch matches1to2, Mat outImg, int matchesThickness, Scalar matchColor, Scalar singlePointColor) {
        ...
        MatOfKeyPoint matOfKeyPoint5 = matOfKeyPoint;
        long j2 = j;
        drawMatches_7(j2, matOfKeyPoint.nativeObj, img2.nativeObj, matOfKeyPoint2.nativeObj, matOfDMatch.nativeObj, outImg.nativeObj, matchesThickness, scalar.val[0], scalar.val[1], scalar.val[2], scalar.val[3], scalar2.val[0], scalar2.val[1], scalar2.val[2], scalar2.val[3]);
    }
    ...
    public static void drawMatches(Mat img1, MatOfKeyPoint keypoints1, Mat img2, MatOfKeyPoint keypoints2, MatOfDMatch matches1to2, Mat outImg, int matchesThickness, Scalar matchColor) {
        ...
        MatOfKeyPoint matOfKeyPoint4 = matOfKeyPoint2;
        long j2 = j;
        drawMatches_8(j2, matOfKeyPoint.nativeObj, img2.nativeObj, matOfKeyPoint2.nativeObj, matOfDMatch.nativeObj, outImg.nativeObj, matchesThickness, scalar.val[0], scalar.val[1], scalar.val[2], scalar.val[3]);
    }
    ...
    public static void drawMatches(Mat img1, MatOfKeyPoint keypoints1, Mat img2, MatOfKeyPoint keypoints2, MatOfDMatch matches1to2, Mat outImg, int matchesThickness) {
        ...
        MatOfKeyPoint matOfKeyPoint3 = matOfKeyPoint;
        MatOfKeyPoint matOfKeyPoint4 = matOfKeyPoint2;
        drawMatches_9(img1.nativeObj, matOfKeyPoint.nativeObj, img2.nativeObj, matOfKeyPoint2.nativeObj, matches1to2.nativeObj, outImg.nativeObj, matchesThickness);
    }
