...
public class SIFT extends Feature2D {
    ...
    private static native long create_6(int i, int i2, double d, double d2, double d3, int i3);
    ...
    public static SIFT create(int nfeatures, int nOctaveLayers, double contrastThreshold, double edgeThreshold, double sigma, int descriptorType) {
        return __fromPtr__(create_6(nfeatures, nOctaveLayers, contrastThreshold, edgeThreshold, sigma, descriptorType));
    }
