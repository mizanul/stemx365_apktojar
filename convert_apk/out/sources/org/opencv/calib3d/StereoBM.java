...
public class StereoBM extends StereoMatcher {
    ...
    public void setROI1(Rect roi1) {
        setROI1_0(this.nativeObj, roi1.f180x, roi1.f181y, roi1.width, roi1.height);
    }
    ...
    public void setROI2(Rect roi2) {
        setROI2_0(this.nativeObj, roi2.f180x, roi2.f181y, roi2.width, roi2.height);
    }

    public static StereoBM create(int numDisparities, int blockSize) {
        return __fromPtr__(create_0(numDisparities, blockSize));
    }

    public static StereoBM create(int numDisparities) {
        return __fromPtr__(create_1(numDisparities));
    }
