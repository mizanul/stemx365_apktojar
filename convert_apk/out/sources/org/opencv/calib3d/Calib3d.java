...
public class Calib3d {
    ...
    private static native int recoverPose_0(long j, long j2, long j3, long j4, long j5, long j6, long j7);

    private static native int recoverPose_1(long j, long j2, long j3, long j4, long j5, long j6);

    private static native int recoverPose_2(long j, long j2, long j3, long j4, long j5, double d, double d2, double d3, long j6);

    private static native int recoverPose_3(long j, long j2, long j3, long j4, long j5, double d, double d2, double d3);

    private static native int recoverPose_4(long j, long j2, long j3, long j4, long j5, double d);

    private static native int recoverPose_5(long j, long j2, long j3, long j4, long j5);
    ...
    public static void Rodrigues(Mat src2, Mat dst, Mat jacobian) {
        Rodrigues_0(src2.nativeObj, dst.nativeObj, jacobian.nativeObj);
    }

    public static void Rodrigues(Mat src2, Mat dst) {
        Rodrigues_1(src2.nativeObj, dst.nativeObj);
    }
    ...
    public static Mat findHomography(MatOfPoint2f srcPoints, MatOfPoint2f dstPoints, Mat mask, UsacParams params) {
        return new Mat(findHomography_6(srcPoints.nativeObj, dstPoints.nativeObj, mask.nativeObj, params.nativeObj));
    }

    public static double[] RQDecomp3x3(Mat src2, Mat mtxR, Mat mtxQ, Mat Qx, Mat Qy, Mat Qz) {
        return RQDecomp3x3_0(src2.nativeObj, mtxR.nativeObj, mtxQ.nativeObj, Qx.nativeObj, Qy.nativeObj, Qz.nativeObj);
    }

    public static double[] RQDecomp3x3(Mat src2, Mat mtxR, Mat mtxQ, Mat Qx, Mat Qy) {
        return RQDecomp3x3_1(src2.nativeObj, mtxR.nativeObj, mtxQ.nativeObj, Qx.nativeObj, Qy.nativeObj);
    }

    public static double[] RQDecomp3x3(Mat src2, Mat mtxR, Mat mtxQ, Mat Qx) {
        return RQDecomp3x3_2(src2.nativeObj, mtxR.nativeObj, mtxQ.nativeObj, Qx.nativeObj);
    }

    public static double[] RQDecomp3x3(Mat src2, Mat mtxR, Mat mtxQ) {
        return RQDecomp3x3_3(src2.nativeObj, mtxR.nativeObj, mtxQ.nativeObj);
    }
    ...
    public static boolean solvePnPRansac(MatOfPoint3f objectPoints, MatOfPoint2f imagePoints, Mat cameraMatrix, MatOfDouble distCoeffs, Mat rvec, Mat tvec, boolean useExtrinsicGuess, int iterationsCount, float reprojectionError, double confidence, Mat inliers, int flags) {
        ...
        MatOfPoint3f matOfPoint3f2 = matOfPoint3f;
        MatOfPoint3f matOfPoint3f3 = matOfPoint3f2;
        MatOfPoint2f matOfPoint2f2 = matOfPoint2f;
    ...
    public static boolean solvePnPRansac(MatOfPoint3f objectPoints, MatOfPoint2f imagePoints, Mat cameraMatrix, MatOfDouble distCoeffs, Mat rvec, Mat tvec, Mat inliers, UsacParams params) {
        ...
        MatOfPoint2f matOfPoint2f2 = matOfPoint2f;
        MatOfDouble matOfDouble2 = matOfDouble;
        return solvePnPRansac_7(matOfPoint3f.nativeObj, matOfPoint2f.nativeObj, cameraMatrix.nativeObj, matOfDouble.nativeObj, rvec.nativeObj, tvec.nativeObj, inliers.nativeObj, params.nativeObj);
    }
    ...
    public static boolean solvePnPRansac(MatOfPoint3f objectPoints, MatOfPoint2f imagePoints, Mat cameraMatrix, MatOfDouble distCoeffs, Mat rvec, Mat tvec, Mat inliers) {
        ...
        MatOfPoint2f matOfPoint2f2 = matOfPoint2f;
        MatOfDouble matOfDouble2 = matOfDouble;
        return solvePnPRansac_8(matOfPoint3f.nativeObj, matOfPoint2f.nativeObj, cameraMatrix.nativeObj, matOfDouble.nativeObj, rvec.nativeObj, tvec.nativeObj, inliers.nativeObj);
    }
    ...
    public static void solvePnPRefineLM(Mat objectPoints, Mat imagePoints, Mat cameraMatrix, Mat distCoeffs, Mat rvec, Mat tvec, TermCriteria criteria) {
        ...
        solvePnPRefineLM_0(objectPoints.nativeObj, imagePoints.nativeObj, cameraMatrix.nativeObj, distCoeffs.nativeObj, rvec.nativeObj, tvec.nativeObj, termCriteria.type, termCriteria.maxCount, termCriteria.epsilon);
    }
    ...
    public static void solvePnPRefineVVS(Mat objectPoints, Mat imagePoints, Mat cameraMatrix, Mat distCoeffs, Mat rvec, Mat tvec, TermCriteria criteria, double VVSlambda) {
        TermCriteria termCriteria = criteria;
        long j = objectPoints.nativeObj;
        long j2 = j;
        solvePnPRefineVVS_0(j2, imagePoints.nativeObj, cameraMatrix.nativeObj, distCoeffs.nativeObj, rvec.nativeObj, tvec.nativeObj, termCriteria.type, termCriteria.maxCount, termCriteria.epsilon, VVSlambda);
    }
    ...
    public static void solvePnPRefineVVS(Mat objectPoints, Mat imagePoints, Mat cameraMatrix, Mat distCoeffs, Mat rvec, Mat tvec, TermCriteria criteria) {
        TermCriteria termCriteria = criteria;
        solvePnPRefineVVS_1(objectPoints.nativeObj, imagePoints.nativeObj, cameraMatrix.nativeObj, distCoeffs.nativeObj, rvec.nativeObj, tvec.nativeObj, termCriteria.type, termCriteria.maxCount, termCriteria.epsilon);
    }
    ...
    public static int solvePnPGeneric(Mat objectPoints, Mat imagePoints, Mat cameraMatrix, Mat distCoeffs, List<Mat> rvecs, List<Mat> tvecs, boolean useExtrinsicGuess, int flags, Mat rvec, Mat tvec, Mat reprojectionError) {
        ...
        Mat tvecs_mat = new Mat();
        long j = objectPoints.nativeObj;
        long j2 = imagePoints.nativeObj;
        Mat rvecs_mat2 = rvecs_mat;
        long j3 = j;
        long j4 = j2;
        int retVal = solvePnPGeneric_0(j3, j4, cameraMatrix.nativeObj, distCoeffs.nativeObj, rvecs_mat.nativeObj, tvecs_mat.nativeObj, useExtrinsicGuess, flags, rvec.nativeObj, tvec.nativeObj, reprojectionError.nativeObj);
    ...
    public static int solvePnPGeneric(Mat objectPoints, Mat imagePoints, Mat cameraMatrix, Mat distCoeffs, List<Mat> rvecs, List<Mat> tvecs, boolean useExtrinsicGuess, int flags, Mat rvec, Mat tvec) {
        ...
        long j3 = j;
        long j4 = j2;
        int retVal = solvePnPGeneric_1(j3, j4, cameraMatrix.nativeObj, distCoeffs.nativeObj, rvecs_mat.nativeObj, tvecs_mat.nativeObj, useExtrinsicGuess, flags, rvec.nativeObj, tvec.nativeObj);
        Mat rvecs_mat2 = rvecs_mat;
    ...
    public static Scalar estimateChessboardSharpness(Mat image, Size patternSize, Mat corners, float rise_distance, boolean vertical, Mat sharpness) {
        Size size = patternSize;
        return new Scalar(estimateChessboardSharpness_0(image.nativeObj, size.width, size.height, corners.nativeObj, rise_distance, vertical, sharpness.nativeObj));
    }
    ...
    public static void calibrationMatrixValues(Mat cameraMatrix, Size imageSize, double apertureWidth, double apertureHeight, double[] fovx, double[] fovy, double[] focalLength, Point principalPoint, double[] aspectRatio) {
        ...
        double[] fovy_out2 = fovy_out;
        double[] fovx_out2 = fovx_out;
        ...
        if (point != null) {
            point.f175x = principalPoint_out[0];
            point.f176y = principalPoint_out[1];
        }
        if (aspectRatio != null) {
    ...
    public static double stereoCalibrateExtended(List<Mat> objectPoints, List<Mat> imagePoints1, List<Mat> imagePoints2, Mat cameraMatrix1, Mat distCoeffs1, Mat cameraMatrix2, Mat distCoeffs2, Size imageSize, Mat R, Mat T, Mat E, Mat F, Mat perViewErrors, int flags) {
        ...
        long j = objectPoints_mat.nativeObj;
        long j2 = imagePoints1_mat.nativeObj;
        Mat imagePoints1_mat2 = imagePoints1_mat;
        Mat mat = imagePoints1_mat2;
    ...
    public static void stereoRectify(Mat cameraMatrix1, Mat distCoeffs1, Mat cameraMatrix2, Mat distCoeffs2, Size imageSize, Mat R, Mat T, Mat R1, Mat R2, Mat P1, Mat P2, Mat Q, int flags, double alpha, Size newImageSize, Rect validPixROI1, Rect validPixROI2) {
        ...
        double[] validPixROI1_out3 = validPixROI1_out2;
        ...
        if (rect3 != null) {
            rect3.f180x = (int) validPixROI1_out3[0];
            rect3.f181y = (int) validPixROI1_out3[1];
            rect3.width = (int) validPixROI1_out3[2];
            rect3.height = (int) validPixROI1_out3[3];
        }
        Rect rect4 = validPixROI2;
        if (rect4 != null) {
            rect4.f180x = (int) validPixROI2_out2[0];
            rect4.f181y = (int) validPixROI2_out2[1];
    ...
    public static void stereoRectify(Mat cameraMatrix1, Mat distCoeffs1, Mat cameraMatrix2, Mat distCoeffs2, Size imageSize, Mat R, Mat T, Mat R1, Mat R2, Mat P1, Mat P2, Mat Q, int flags, double alpha, Size newImageSize, Rect validPixROI1) {
        ...
        if (rect2 != null) {
            rect2.f180x = (int) validPixROI1_out2[0];
            rect2.f181y = (int) validPixROI1_out2[1];
    ...
    public static float rectify3Collinear(Mat cameraMatrix1, Mat distCoeffs1, Mat cameraMatrix2, Mat distCoeffs2, Mat cameraMatrix3, Mat distCoeffs3, List<Mat> imgpt1, List<Mat> imgpt3, Size imageSize, Mat R12, Mat T12, Mat R13, Mat T13, Mat R1, Mat R2, Mat R3, Mat P1, Mat P2, Mat P3, Mat Q, double alpha, Size newImgSize, Rect roi1, Rect roi2, int flags) {
        ...
        Rect rect3 = roi1;
        if (rect3 != null) {
            rect3.f180x = (int) roi1_out2[0];
            rect3.f181y = (int) roi1_out2[1];
            rect3.width = (int) roi1_out2[2];
            rect3.height = (int) roi1_out2[3];
        }
        Rect rect4 = roi2;
        if (rect4 != null) {
            rect4.f180x = (int) roi2_out2[0];
            rect4.f181y = (int) roi2_out2[1];
    ...
    public static Mat getOptimalNewCameraMatrix(Mat cameraMatrix, Mat distCoeffs, Size imageSize, double alpha, Size newImgSize, Rect validPixROI, boolean centerPrincipalPoint) {
        ...
        if (rect2 != null) {
            rect2.f180x = (int) validPixROI_out[0];
            rect2.f181y = (int) validPixROI_out[1];
    ...
    public static void calibrateHandEye(List<Mat> R_gripper2base, List<Mat> t_gripper2base, List<Mat> R_target2cam, List<Mat> t_target2cam, Mat R_cam2gripper, Mat t_cam2gripper, int method) {
        ...
        Mat mat = R_gripper2base_mat;
        Mat mat2 = t_gripper2base_mat;
        calibrateHandEye_0(R_gripper2base_mat.nativeObj, t_gripper2base_mat.nativeObj, Converters.vector_Mat_to_Mat(R_target2cam).nativeObj, Converters.vector_Mat_to_Mat(t_target2cam).nativeObj, R_cam2gripper.nativeObj, t_cam2gripper.nativeObj, method);
    }
    ...
    public static void calibrateHandEye(List<Mat> R_gripper2base, List<Mat> t_gripper2base, List<Mat> R_target2cam, List<Mat> t_target2cam, Mat R_cam2gripper, Mat t_cam2gripper) {
        ...
        Mat mat = R_gripper2base_mat;
        Mat mat2 = t_gripper2base_mat;
        calibrateHandEye_1(R_gripper2base_mat.nativeObj, t_gripper2base_mat.nativeObj, Converters.vector_Mat_to_Mat(R_target2cam).nativeObj, Converters.vector_Mat_to_Mat(t_target2cam).nativeObj, R_cam2gripper.nativeObj, t_cam2gripper.nativeObj);
    }
    ...
    public static void calibrateRobotWorldHandEye(List<Mat> R_world2cam, List<Mat> t_world2cam, List<Mat> R_base2gripper, List<Mat> t_base2gripper, Mat R_base2world, Mat t_base2world, Mat R_gripper2cam, Mat t_gripper2cam, int method) {
        ...
        long j = R_world2cam_mat.nativeObj;
        Mat mat = R_base2gripper_mat;
        Mat mat2 = t_base2gripper_mat;
        Mat mat3 = R_world2cam_mat;
        Mat mat4 = t_world2cam_mat;
        long j2 = j;
        calibrateRobotWorldHandEye_0(j2, t_world2cam_mat.nativeObj, R_base2gripper_mat.nativeObj, t_base2gripper_mat.nativeObj, R_base2world.nativeObj, t_base2world.nativeObj, R_gripper2cam.nativeObj, t_gripper2cam.nativeObj, method);
    }
    ...
    public static void calibrateRobotWorldHandEye(List<Mat> R_world2cam, List<Mat> t_world2cam, List<Mat> R_base2gripper, List<Mat> t_base2gripper, Mat R_base2world, Mat t_base2world, Mat R_gripper2cam, Mat t_gripper2cam) {
        ...
        Mat R_base2gripper_mat = Converters.vector_Mat_to_Mat(R_base2gripper);
        Mat t_base2gripper_mat = Converters.vector_Mat_to_Mat(t_base2gripper);
        Mat mat = R_world2cam_mat;
        Mat mat2 = t_world2cam_mat;
        Mat mat3 = R_base2gripper_mat;
    ...
    public static void convertPointsToHomogeneous(Mat src2, Mat dst) {
        convertPointsToHomogeneous_0(src2.nativeObj, dst.nativeObj);
    }

    public static void convertPointsFromHomogeneous(Mat src2, Mat dst) {
        convertPointsFromHomogeneous_0(src2.nativeObj, dst.nativeObj);
    }
    ...
    public static Mat findFundamentalMat(MatOfPoint2f points1, MatOfPoint2f points2, Mat mask, UsacParams params) {
        return new Mat(findFundamentalMat_7(points1.nativeObj, points2.nativeObj, mask.nativeObj, params.nativeObj));
    }
    ...
    public static Mat findEssentialMat(Mat points1, Mat points2, double focal, Point pp, int method, double prob, double threshold, int maxIters, Mat mask) {
        ...
        return new Mat(findEssentialMat_6(j, points2.nativeObj, focal, point.f175x, point.f176y, method, prob, threshold, maxIters, mask.nativeObj));
    }
    ...
    public static Mat findEssentialMat(Mat points1, Mat points2, double focal, Point pp, int method, double prob, double threshold, int maxIters) {
        Point point = pp;
        return new Mat(findEssentialMat_7(points1.nativeObj, points2.nativeObj, focal, point.f175x, point.f176y, method, prob, threshold, maxIters));
    }

    public static Mat findEssentialMat(Mat points1, Mat points2, double focal, Point pp, int method, double prob, double threshold) {
        Point point = pp;
        return new Mat(findEssentialMat_8(points1.nativeObj, points2.nativeObj, focal, point.f175x, point.f176y, method, prob, threshold));
    }

    public static Mat findEssentialMat(Mat points1, Mat points2, double focal, Point pp, int method, double prob) {
        Point point = pp;
        return new Mat(findEssentialMat_9(points1.nativeObj, points2.nativeObj, focal, point.f175x, point.f176y, method, prob));
    }

    public static Mat findEssentialMat(Mat points1, Mat points2, double focal, Point pp, int method) {
        Point point = pp;
        return new Mat(findEssentialMat_10(points1.nativeObj, points2.nativeObj, focal, point.f175x, point.f176y, method));
    }

    public static Mat findEssentialMat(Mat points1, Mat points2, double focal, Point pp) {
        return new Mat(findEssentialMat_11(points1.nativeObj, points2.nativeObj, focal, pp.f175x, pp.f176y));
    }
    ...
    public static Mat findEssentialMat(Mat points1, Mat points2, Mat cameraMatrix1, Mat distCoeffs1, Mat cameraMatrix2, Mat distCoeffs2, int method, double prob, double threshold, Mat mask) {
        long j = points1.nativeObj;
        long j2 = points2.nativeObj;
        return new Mat(findEssentialMat_14(j, j2, cameraMatrix1.nativeObj, distCoeffs1.nativeObj, cameraMatrix2.nativeObj, distCoeffs2.nativeObj, method, prob, threshold, mask.nativeObj));
    }
    ...
    public static Mat findEssentialMat(Mat points1, Mat points2, Mat cameraMatrix1, Mat distCoeffs1, Mat cameraMatrix2, Mat distCoeffs2, int method, double prob, double threshold) {
        long j = points1.nativeObj;
        return new Mat(findEssentialMat_15(j, points2.nativeObj, cameraMatrix1.nativeObj, distCoeffs1.nativeObj, cameraMatrix2.nativeObj, distCoeffs2.nativeObj, method, prob, threshold));
    }
    ...
    public static int recoverPose(Mat E, Mat points1, Mat points2, Mat R, Mat t, double focal, Point pp, Mat mask) {
        ...
        return recoverPose_2(j, j2, points2.nativeObj, R.nativeObj, t.nativeObj, focal, point.f175x, point.f176y, mask.nativeObj);
    }

    public static int recoverPose(Mat E, Mat points1, Mat points2, Mat R, Mat t, double focal, Point pp) {
        Point point = pp;
        return recoverPose_3(E.nativeObj, points1.nativeObj, points2.nativeObj, R.nativeObj, t.nativeObj, focal, point.f175x, point.f176y);
    }
    ...
    public static Rect getValidDisparityROI(Rect roi1, Rect roi2, int minDisparity, int numberOfDisparities, int blockSize) {
        Rect rect = roi1;
        Rect rect2 = roi2;
        return new Rect(getValidDisparityROI_0(rect.f180x, rect.f181y, rect.width, rect.height, rect2.f180x, rect2.f181y, rect2.width, rect2.height, minDisparity, numberOfDisparities, blockSize));
    }
    ...
    public static int estimateAffine3D(Mat src2, Mat dst, Mat out, Mat inliers, double ransacThreshold, double confidence) {
        return estimateAffine3D_0(src2.nativeObj, dst.nativeObj, out.nativeObj, inliers.nativeObj, ransacThreshold, confidence);
    }

    public static int estimateAffine3D(Mat src2, Mat dst, Mat out, Mat inliers, double ransacThreshold) {
        return estimateAffine3D_1(src2.nativeObj, dst.nativeObj, out.nativeObj, inliers.nativeObj, ransacThreshold);
    }

    public static int estimateAffine3D(Mat src2, Mat dst, Mat out, Mat inliers) {
        return estimateAffine3D_2(src2.nativeObj, dst.nativeObj, out.nativeObj, inliers.nativeObj);
    }

    public static Mat estimateAffine3D(Mat src2, Mat dst, double[] scale, boolean force_rotation) {
        double[] scale_out = new double[1];
        Mat retVal = new Mat(estimateAffine3D_3(src2.nativeObj, dst.nativeObj, scale_out, force_rotation));
        if (scale != null) {
            scale[0] = scale_out[0];
        }
        return retVal;
    ...
    public static Mat estimateAffine3D(Mat src2, Mat dst, double[] scale) {
        double[] scale_out = new double[1];
        Mat retVal = new Mat(estimateAffine3D_4(src2.nativeObj, dst.nativeObj, scale_out));
        if (scale != null) {
            scale[0] = scale_out[0];
        }
        return retVal;
    ...
    public static Mat estimateAffine3D(Mat src2, Mat dst) {
        return new Mat(estimateAffine3D_5(src2.nativeObj, dst.nativeObj));
    }

    public static int estimateTranslation3D(Mat src2, Mat dst, Mat out, Mat inliers, double ransacThreshold, double confidence) {
        return estimateTranslation3D_0(src2.nativeObj, dst.nativeObj, out.nativeObj, inliers.nativeObj, ransacThreshold, confidence);
    }

    public static int estimateTranslation3D(Mat src2, Mat dst, Mat out, Mat inliers, double ransacThreshold) {
        return estimateTranslation3D_1(src2.nativeObj, dst.nativeObj, out.nativeObj, inliers.nativeObj, ransacThreshold);
    }

    public static int estimateTranslation3D(Mat src2, Mat dst, Mat out, Mat inliers) {
        return estimateTranslation3D_2(src2.nativeObj, dst.nativeObj, out.nativeObj, inliers.nativeObj);
    }
    ...
    public static void undistort(Mat src2, Mat dst, Mat cameraMatrix, Mat distCoeffs, Mat newCameraMatrix) {
        undistort_0(src2.nativeObj, dst.nativeObj, cameraMatrix.nativeObj, distCoeffs.nativeObj, newCameraMatrix.nativeObj);
    }

    public static void undistort(Mat src2, Mat dst, Mat cameraMatrix, Mat distCoeffs) {
        undistort_1(src2.nativeObj, dst.nativeObj, cameraMatrix.nativeObj, distCoeffs.nativeObj);
    }
    ...
    public static void initInverseRectificationMap(Mat cameraMatrix, Mat distCoeffs, Mat R, Mat newCameraMatrix, Size size, int m1type, Mat map1, Mat map2) {
        ...
        long j = cameraMatrix.nativeObj;
        long j2 = j;
        initInverseRectificationMap_0(j2, distCoeffs.nativeObj, R.nativeObj, newCameraMatrix.nativeObj, size2.width, size2.height, m1type, map1.nativeObj, map2.nativeObj);
    }
    ...
    public static void undistortPoints(MatOfPoint2f src2, MatOfPoint2f dst, Mat cameraMatrix, Mat distCoeffs, Mat R, Mat P) {
        MatOfPoint2f matOfPoint2f = src2;
    ...
    public static void undistortPoints(MatOfPoint2f src2, MatOfPoint2f dst, Mat cameraMatrix, Mat distCoeffs, Mat R) {
        undistortPoints_1(src2.nativeObj, dst.nativeObj, cameraMatrix.nativeObj, distCoeffs.nativeObj, R.nativeObj);
    }

    public static void undistortPoints(MatOfPoint2f src2, MatOfPoint2f dst, Mat cameraMatrix, Mat distCoeffs) {
        undistortPoints_2(src2.nativeObj, dst.nativeObj, cameraMatrix.nativeObj, distCoeffs.nativeObj);
    }

    public static void undistortPointsIter(Mat src2, Mat dst, Mat cameraMatrix, Mat distCoeffs, Mat R, Mat P, TermCriteria criteria) {
        TermCriteria termCriteria = criteria;
        undistortPointsIter_0(src2.nativeObj, dst.nativeObj, cameraMatrix.nativeObj, distCoeffs.nativeObj, R.nativeObj, P.nativeObj, termCriteria.type, termCriteria.maxCount, termCriteria.epsilon);
    }
