...
public class PCTSignatures extends Algorithm {
    ...
    /* renamed from: L1 */
    public static final int f188L1 = 2;

    /* renamed from: L2 */
    public static final int f189L2 = 3;
    public static final int L2SQUARED = 4;

    /* renamed from: L5 */
    public static final int f190L5 = 5;
    ...
    public static PCTSignatures create(int initSampleCount, int initSeedCount, int pointDistribution) {
        return __fromPtr__(create_0(initSampleCount, initSeedCount, pointDistribution));
    }

    public static PCTSignatures create(int initSampleCount, int initSeedCount) {
        return __fromPtr__(create_1(initSampleCount, initSeedCount));
    }

    public static PCTSignatures create(int initSampleCount) {
        return __fromPtr__(create_2(initSampleCount));
    }
    ...
    public static PCTSignatures create(MatOfPoint2f initSamplingPoints, int initSeedCount) {
        return __fromPtr__(create_4(initSamplingPoints.nativeObj, initSeedCount));
    }

    public static PCTSignatures create(MatOfPoint2f initSamplingPoints, MatOfInt initClusterSeedIndexes) {
        return __fromPtr__(create_5(initSamplingPoints.nativeObj, initClusterSeedIndexes.nativeObj));
    }
