...
public class Dnn {
    ...
    public static Net readNet(String framework, MatOfByte bufferModel, MatOfByte bufferConfig) {
        return new Net(readNet_3(framework, bufferModel.nativeObj, bufferConfig.nativeObj));
    }

    public static Net readNet(String framework, MatOfByte bufferModel) {
        return new Net(readNet_4(framework, bufferModel.nativeObj));
    }
    ...
    public static void shrinkCaffeModel(String src2, String dst, List<String> layersTypes) {
        shrinkCaffeModel_0(src2, dst, layersTypes);
    }

    public static void shrinkCaffeModel(String src2, String dst) {
        shrinkCaffeModel_1(src2, dst);
    }
