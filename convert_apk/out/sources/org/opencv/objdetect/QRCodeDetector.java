...
public class QRCodeDetector {
    ...
    public String decodeCurved(Mat img, Mat points, Mat straight_qrcode) {
        return decodeCurved_0(this.nativeObj, img.nativeObj, points.nativeObj, straight_qrcode.nativeObj);
    }

    public String decodeCurved(Mat img, Mat points) {
        return decodeCurved_1(this.nativeObj, img.nativeObj, points.nativeObj);
    }
    ...
    public String detectAndDecodeCurved(Mat img, Mat points, Mat straight_qrcode) {
        return detectAndDecodeCurved_0(this.nativeObj, img.nativeObj, points.nativeObj, straight_qrcode.nativeObj);
    }

    public String detectAndDecodeCurved(Mat img, Mat points) {
        return detectAndDecodeCurved_1(this.nativeObj, img.nativeObj, points.nativeObj);
    }

    public String detectAndDecodeCurved(Mat img) {
        return detectAndDecodeCurved_2(this.nativeObj, img.nativeObj);
    }
