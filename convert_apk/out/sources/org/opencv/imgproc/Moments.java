...
public class Moments {
    ...
    public void completeState() {
        ...
        double d = this.m20;
        double d2 = this.m10;
        double mu202 = d - (d2 * cx);
        double mu112 = this.m11 - (d2 * cy);
        double d3 = this.m02;
        double inv_m002 = inv_m00;
        double inv_m003 = this.m01;
        double mu022 = d3 - (inv_m003 * cy);
        this.mu20 = mu202;
        this.mu11 = mu112;
        this.mu02 = mu022;
        double mu023 = mu022;
        this.mu30 = this.m30 - (((mu202 * 3.0d) + (cx * d2)) * cx);
        double mu113 = mu112 + mu112;
        this.mu21 = (this.m21 - ((mu113 + (cx * inv_m003)) * cx)) - (cy * mu202);
        this.mu12 = (this.m12 - (((d2 * cy) + mu113) * cy)) - (cx * mu023);
        this.mu03 = this.m03 - (((mu023 * 3.0d) + (inv_m003 * cy)) * cy);
