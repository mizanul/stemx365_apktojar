...
public class Imgproc {
    ...
    public static Mat getStructuringElement(int shape, Size ksize, Point anchor) {
        return new Mat(getStructuringElement_0(shape, ksize.width, ksize.height, anchor.f175x, anchor.f176y));
    }
    ...
    public static void medianBlur(Mat src2, Mat dst, int ksize) {
        medianBlur_0(src2.nativeObj, dst.nativeObj, ksize);
    }

    public static void GaussianBlur(Mat src2, Mat dst, Size ksize, double sigmaX, double sigmaY, int borderType) {
        Size size = ksize;
        GaussianBlur_0(src2.nativeObj, dst.nativeObj, size.width, size.height, sigmaX, sigmaY, borderType);
    }

    public static void GaussianBlur(Mat src2, Mat dst, Size ksize, double sigmaX, double sigmaY) {
        Size size = ksize;
        GaussianBlur_1(src2.nativeObj, dst.nativeObj, size.width, size.height, sigmaX, sigmaY);
    }

    public static void GaussianBlur(Mat src2, Mat dst, Size ksize, double sigmaX) {
        GaussianBlur_2(src2.nativeObj, dst.nativeObj, ksize.width, ksize.height, sigmaX);
    }

    public static void bilateralFilter(Mat src2, Mat dst, int d, double sigmaColor, double sigmaSpace, int borderType) {
        bilateralFilter_0(src2.nativeObj, dst.nativeObj, d, sigmaColor, sigmaSpace, borderType);
    }

    public static void bilateralFilter(Mat src2, Mat dst, int d, double sigmaColor, double sigmaSpace) {
        bilateralFilter_1(src2.nativeObj, dst.nativeObj, d, sigmaColor, sigmaSpace);
    }

    public static void boxFilter(Mat src2, Mat dst, int ddepth, Size ksize, Point anchor, boolean normalize, int borderType) {
        Size size = ksize;
        Point point = anchor;
        boxFilter_0(src2.nativeObj, dst.nativeObj, ddepth, size.width, size.height, point.f175x, point.f176y, normalize, borderType);
    }

    public static void boxFilter(Mat src2, Mat dst, int ddepth, Size ksize, Point anchor, boolean normalize) {
        Size size = ksize;
        Point point = anchor;
        boxFilter_1(src2.nativeObj, dst.nativeObj, ddepth, size.width, size.height, point.f175x, point.f176y, normalize);
    }

    public static void boxFilter(Mat src2, Mat dst, int ddepth, Size ksize, Point anchor) {
        Size size = ksize;
        Point point = anchor;
        boxFilter_2(src2.nativeObj, dst.nativeObj, ddepth, size.width, size.height, point.f175x, point.f176y);
    }

    public static void boxFilter(Mat src2, Mat dst, int ddepth, Size ksize) {
        boxFilter_3(src2.nativeObj, dst.nativeObj, ddepth, ksize.width, ksize.height);
    }

    public static void sqrBoxFilter(Mat src2, Mat dst, int ddepth, Size ksize, Point anchor, boolean normalize, int borderType) {
        Size size = ksize;
        Point point = anchor;
        sqrBoxFilter_0(src2.nativeObj, dst.nativeObj, ddepth, size.width, size.height, point.f175x, point.f176y, normalize, borderType);
    }

    public static void sqrBoxFilter(Mat src2, Mat dst, int ddepth, Size ksize, Point anchor, boolean normalize) {
        Size size = ksize;
        Point point = anchor;
        sqrBoxFilter_1(src2.nativeObj, dst.nativeObj, ddepth, size.width, size.height, point.f175x, point.f176y, normalize);
    }

    public static void sqrBoxFilter(Mat src2, Mat dst, int ddepth, Size ksize, Point anchor) {
        Size size = ksize;
        Point point = anchor;
        sqrBoxFilter_2(src2.nativeObj, dst.nativeObj, ddepth, size.width, size.height, point.f175x, point.f176y);
    }

    public static void sqrBoxFilter(Mat src2, Mat dst, int ddepth, Size ksize) {
        sqrBoxFilter_3(src2.nativeObj, dst.nativeObj, ddepth, ksize.width, ksize.height);
    }

    public static void blur(Mat src2, Mat dst, Size ksize, Point anchor, int borderType) {
        Size size = ksize;
        Point point = anchor;
        blur_0(src2.nativeObj, dst.nativeObj, size.width, size.height, point.f175x, point.f176y, borderType);
    }

    public static void blur(Mat src2, Mat dst, Size ksize, Point anchor) {
        blur_1(src2.nativeObj, dst.nativeObj, ksize.width, ksize.height, anchor.f175x, anchor.f176y);
    }

    public static void blur(Mat src2, Mat dst, Size ksize) {
        blur_2(src2.nativeObj, dst.nativeObj, ksize.width, ksize.height);
    }

    public static void filter2D(Mat src2, Mat dst, int ddepth, Mat kernel, Point anchor, double delta, int borderType) {
        Point point = anchor;
        filter2D_0(src2.nativeObj, dst.nativeObj, ddepth, kernel.nativeObj, point.f175x, point.f176y, delta, borderType);
    }

    public static void filter2D(Mat src2, Mat dst, int ddepth, Mat kernel, Point anchor, double delta) {
        Point point = anchor;
        filter2D_1(src2.nativeObj, dst.nativeObj, ddepth, kernel.nativeObj, point.f175x, point.f176y, delta);
    }

    public static void filter2D(Mat src2, Mat dst, int ddepth, Mat kernel, Point anchor) {
        filter2D_2(src2.nativeObj, dst.nativeObj, ddepth, kernel.nativeObj, anchor.f175x, anchor.f176y);
    }

    public static void filter2D(Mat src2, Mat dst, int ddepth, Mat kernel) {
        filter2D_3(src2.nativeObj, dst.nativeObj, ddepth, kernel.nativeObj);
    }

    public static void sepFilter2D(Mat src2, Mat dst, int ddepth, Mat kernelX, Mat kernelY, Point anchor, double delta, int borderType) {
        Point point = anchor;
        sepFilter2D_0(src2.nativeObj, dst.nativeObj, ddepth, kernelX.nativeObj, kernelY.nativeObj, point.f175x, point.f176y, delta, borderType);
    }

    public static void sepFilter2D(Mat src2, Mat dst, int ddepth, Mat kernelX, Mat kernelY, Point anchor, double delta) {
        Point point = anchor;
        sepFilter2D_1(src2.nativeObj, dst.nativeObj, ddepth, kernelX.nativeObj, kernelY.nativeObj, point.f175x, point.f176y, delta);
    }

    public static void sepFilter2D(Mat src2, Mat dst, int ddepth, Mat kernelX, Mat kernelY, Point anchor) {
        Point point = anchor;
        sepFilter2D_2(src2.nativeObj, dst.nativeObj, ddepth, kernelX.nativeObj, kernelY.nativeObj, point.f175x, point.f176y);
    }

    public static void sepFilter2D(Mat src2, Mat dst, int ddepth, Mat kernelX, Mat kernelY) {
        sepFilter2D_3(src2.nativeObj, dst.nativeObj, ddepth, kernelX.nativeObj, kernelY.nativeObj);
    }

    public static void Sobel(Mat src2, Mat dst, int ddepth, int dx, int dy, int ksize, double scale, double delta, int borderType) {
        Sobel_0(src2.nativeObj, dst.nativeObj, ddepth, dx, dy, ksize, scale, delta, borderType);
    }

    public static void Sobel(Mat src2, Mat dst, int ddepth, int dx, int dy, int ksize, double scale, double delta) {
        Sobel_1(src2.nativeObj, dst.nativeObj, ddepth, dx, dy, ksize, scale, delta);
    }

    public static void Sobel(Mat src2, Mat dst, int ddepth, int dx, int dy, int ksize, double scale) {
        Sobel_2(src2.nativeObj, dst.nativeObj, ddepth, dx, dy, ksize, scale);
    }

    public static void Sobel(Mat src2, Mat dst, int ddepth, int dx, int dy, int ksize) {
        Sobel_3(src2.nativeObj, dst.nativeObj, ddepth, dx, dy, ksize);
    }

    public static void Sobel(Mat src2, Mat dst, int ddepth, int dx, int dy) {
        Sobel_4(src2.nativeObj, dst.nativeObj, ddepth, dx, dy);
    }

    public static void spatialGradient(Mat src2, Mat dx, Mat dy, int ksize, int borderType) {
        spatialGradient_0(src2.nativeObj, dx.nativeObj, dy.nativeObj, ksize, borderType);
    }

    public static void spatialGradient(Mat src2, Mat dx, Mat dy, int ksize) {
        spatialGradient_1(src2.nativeObj, dx.nativeObj, dy.nativeObj, ksize);
    }

    public static void spatialGradient(Mat src2, Mat dx, Mat dy) {
        spatialGradient_2(src2.nativeObj, dx.nativeObj, dy.nativeObj);
    }

    public static void Scharr(Mat src2, Mat dst, int ddepth, int dx, int dy, double scale, double delta, int borderType) {
        Scharr_0(src2.nativeObj, dst.nativeObj, ddepth, dx, dy, scale, delta, borderType);
    }

    public static void Scharr(Mat src2, Mat dst, int ddepth, int dx, int dy, double scale, double delta) {
        Scharr_1(src2.nativeObj, dst.nativeObj, ddepth, dx, dy, scale, delta);
    }

    public static void Scharr(Mat src2, Mat dst, int ddepth, int dx, int dy, double scale) {
        Scharr_2(src2.nativeObj, dst.nativeObj, ddepth, dx, dy, scale);
    }

    public static void Scharr(Mat src2, Mat dst, int ddepth, int dx, int dy) {
        Scharr_3(src2.nativeObj, dst.nativeObj, ddepth, dx, dy);
    }

    public static void Laplacian(Mat src2, Mat dst, int ddepth, int ksize, double scale, double delta, int borderType) {
        Laplacian_0(src2.nativeObj, dst.nativeObj, ddepth, ksize, scale, delta, borderType);
    }

    public static void Laplacian(Mat src2, Mat dst, int ddepth, int ksize, double scale, double delta) {
        Laplacian_1(src2.nativeObj, dst.nativeObj, ddepth, ksize, scale, delta);
    }

    public static void Laplacian(Mat src2, Mat dst, int ddepth, int ksize, double scale) {
        Laplacian_2(src2.nativeObj, dst.nativeObj, ddepth, ksize, scale);
    }

    public static void Laplacian(Mat src2, Mat dst, int ddepth, int ksize) {
        Laplacian_3(src2.nativeObj, dst.nativeObj, ddepth, ksize);
    }

    public static void Laplacian(Mat src2, Mat dst, int ddepth) {
        Laplacian_4(src2.nativeObj, dst.nativeObj, ddepth);
    }
    ...
    public static void cornerMinEigenVal(Mat src2, Mat dst, int blockSize, int ksize, int borderType) {
        cornerMinEigenVal_0(src2.nativeObj, dst.nativeObj, blockSize, ksize, borderType);
    }

    public static void cornerMinEigenVal(Mat src2, Mat dst, int blockSize, int ksize) {
        cornerMinEigenVal_1(src2.nativeObj, dst.nativeObj, blockSize, ksize);
    }

    public static void cornerMinEigenVal(Mat src2, Mat dst, int blockSize) {
        cornerMinEigenVal_2(src2.nativeObj, dst.nativeObj, blockSize);
    }

    public static void cornerHarris(Mat src2, Mat dst, int blockSize, int ksize, double k, int borderType) {
        cornerHarris_0(src2.nativeObj, dst.nativeObj, blockSize, ksize, k, borderType);
    }

    public static void cornerHarris(Mat src2, Mat dst, int blockSize, int ksize, double k) {
        cornerHarris_1(src2.nativeObj, dst.nativeObj, blockSize, ksize, k);
    }

    public static void cornerEigenValsAndVecs(Mat src2, Mat dst, int blockSize, int ksize, int borderType) {
        cornerEigenValsAndVecs_0(src2.nativeObj, dst.nativeObj, blockSize, ksize, borderType);
    }

    public static void cornerEigenValsAndVecs(Mat src2, Mat dst, int blockSize, int ksize) {
        cornerEigenValsAndVecs_1(src2.nativeObj, dst.nativeObj, blockSize, ksize);
    }

    public static void preCornerDetect(Mat src2, Mat dst, int ksize, int borderType) {
        preCornerDetect_0(src2.nativeObj, dst.nativeObj, ksize, borderType);
    }

    public static void preCornerDetect(Mat src2, Mat dst, int ksize) {
        preCornerDetect_1(src2.nativeObj, dst.nativeObj, ksize);
    }
    ...
    public static void goodFeaturesToTrackWithQuality(Mat image, Mat corners, int maxCorners, double qualityLevel, double minDistance, Mat mask, Mat cornersQuality, int blockSize, int gradientSize, boolean useHarrisDetector, double k) {
        ...
        long j2 = j;
        goodFeaturesToTrackWithQuality_0(j2, corners.nativeObj, maxCorners, qualityLevel, minDistance, mask.nativeObj, cornersQuality.nativeObj, blockSize, gradientSize, useHarrisDetector, k);
    }
    ...
    public static void HoughLinesPointSet(Mat point, Mat lines, int lines_max, int threshold, double min_rho, double max_rho, double rho_step, double min_theta, double max_theta, double theta_step) {
        long j = point.nativeObj;
        long j2 = j;
        HoughLinesPointSet_0(j2, lines.nativeObj, lines_max, threshold, min_rho, max_rho, rho_step, min_theta, max_theta, theta_step);
    }
    ...
    public static void erode(Mat src2, Mat dst, Mat kernel, Point anchor, int iterations, int borderType, Scalar borderValue) {
        Point point = anchor;
        Scalar scalar = borderValue;
        erode_0(src2.nativeObj, dst.nativeObj, kernel.nativeObj, point.f175x, point.f176y, iterations, borderType, scalar.val[0], scalar.val[1], scalar.val[2], scalar.val[3]);
    }

    public static void erode(Mat src2, Mat dst, Mat kernel, Point anchor, int iterations, int borderType) {
        Point point = anchor;
        erode_1(src2.nativeObj, dst.nativeObj, kernel.nativeObj, point.f175x, point.f176y, iterations, borderType);
    }

    public static void erode(Mat src2, Mat dst, Mat kernel, Point anchor, int iterations) {
        erode_2(src2.nativeObj, dst.nativeObj, kernel.nativeObj, anchor.f175x, anchor.f176y, iterations);
    }

    public static void erode(Mat src2, Mat dst, Mat kernel, Point anchor) {
        erode_3(src2.nativeObj, dst.nativeObj, kernel.nativeObj, anchor.f175x, anchor.f176y);
    }

    public static void erode(Mat src2, Mat dst, Mat kernel) {
        erode_4(src2.nativeObj, dst.nativeObj, kernel.nativeObj);
    }

    public static void dilate(Mat src2, Mat dst, Mat kernel, Point anchor, int iterations, int borderType, Scalar borderValue) {
        Point point = anchor;
        Scalar scalar = borderValue;
        dilate_0(src2.nativeObj, dst.nativeObj, kernel.nativeObj, point.f175x, point.f176y, iterations, borderType, scalar.val[0], scalar.val[1], scalar.val[2], scalar.val[3]);
    }

    public static void dilate(Mat src2, Mat dst, Mat kernel, Point anchor, int iterations, int borderType) {
        Point point = anchor;
        dilate_1(src2.nativeObj, dst.nativeObj, kernel.nativeObj, point.f175x, point.f176y, iterations, borderType);
    }

    public static void dilate(Mat src2, Mat dst, Mat kernel, Point anchor, int iterations) {
        dilate_2(src2.nativeObj, dst.nativeObj, kernel.nativeObj, anchor.f175x, anchor.f176y, iterations);
    }

    public static void dilate(Mat src2, Mat dst, Mat kernel, Point anchor) {
        dilate_3(src2.nativeObj, dst.nativeObj, kernel.nativeObj, anchor.f175x, anchor.f176y);
    }

    public static void dilate(Mat src2, Mat dst, Mat kernel) {
        dilate_4(src2.nativeObj, dst.nativeObj, kernel.nativeObj);
    }

    public static void morphologyEx(Mat src2, Mat dst, int op, Mat kernel, Point anchor, int iterations, int borderType, Scalar borderValue) {
        Point point = anchor;
        Scalar scalar = borderValue;
        morphologyEx_0(src2.nativeObj, dst.nativeObj, op, kernel.nativeObj, point.f175x, point.f176y, iterations, borderType, scalar.val[0], scalar.val[1], scalar.val[2], scalar.val[3]);
    }

    public static void morphologyEx(Mat src2, Mat dst, int op, Mat kernel, Point anchor, int iterations, int borderType) {
        Point point = anchor;
        morphologyEx_1(src2.nativeObj, dst.nativeObj, op, kernel.nativeObj, point.f175x, point.f176y, iterations, borderType);
    }

    public static void morphologyEx(Mat src2, Mat dst, int op, Mat kernel, Point anchor, int iterations) {
        Point point = anchor;
        morphologyEx_2(src2.nativeObj, dst.nativeObj, op, kernel.nativeObj, point.f175x, point.f176y, iterations);
    }

    public static void morphologyEx(Mat src2, Mat dst, int op, Mat kernel, Point anchor) {
        morphologyEx_3(src2.nativeObj, dst.nativeObj, op, kernel.nativeObj, anchor.f175x, anchor.f176y);
    }

    public static void morphologyEx(Mat src2, Mat dst, int op, Mat kernel) {
        morphologyEx_4(src2.nativeObj, dst.nativeObj, op, kernel.nativeObj);
    }

    public static void resize(Mat src2, Mat dst, Size dsize, double fx, double fy, int interpolation) {
        Size size = dsize;
        resize_0(src2.nativeObj, dst.nativeObj, size.width, size.height, fx, fy, interpolation);
    }

    public static void resize(Mat src2, Mat dst, Size dsize, double fx, double fy) {
        Size size = dsize;
        resize_1(src2.nativeObj, dst.nativeObj, size.width, size.height, fx, fy);
    }

    public static void resize(Mat src2, Mat dst, Size dsize, double fx) {
        resize_2(src2.nativeObj, dst.nativeObj, dsize.width, dsize.height, fx);
    }

    public static void resize(Mat src2, Mat dst, Size dsize) {
        resize_3(src2.nativeObj, dst.nativeObj, dsize.width, dsize.height);
    }

    public static void warpAffine(Mat src2, Mat dst, Mat M, Size dsize, int flags, int borderMode, Scalar borderValue) {
        Size size = dsize;
        Scalar scalar = borderValue;
        warpAffine_0(src2.nativeObj, dst.nativeObj, M.nativeObj, size.width, size.height, flags, borderMode, scalar.val[0], scalar.val[1], scalar.val[2], scalar.val[3]);
    }

    public static void warpAffine(Mat src2, Mat dst, Mat M, Size dsize, int flags, int borderMode) {
        Size size = dsize;
        warpAffine_1(src2.nativeObj, dst.nativeObj, M.nativeObj, size.width, size.height, flags, borderMode);
    }

    public static void warpAffine(Mat src2, Mat dst, Mat M, Size dsize, int flags) {
        warpAffine_2(src2.nativeObj, dst.nativeObj, M.nativeObj, dsize.width, dsize.height, flags);
    }

    public static void warpAffine(Mat src2, Mat dst, Mat M, Size dsize) {
        warpAffine_3(src2.nativeObj, dst.nativeObj, M.nativeObj, dsize.width, dsize.height);
    }

    public static void warpPerspective(Mat src2, Mat dst, Mat M, Size dsize, int flags, int borderMode, Scalar borderValue) {
        Size size = dsize;
        Scalar scalar = borderValue;
        warpPerspective_0(src2.nativeObj, dst.nativeObj, M.nativeObj, size.width, size.height, flags, borderMode, scalar.val[0], scalar.val[1], scalar.val[2], scalar.val[3]);
    }

    public static void warpPerspective(Mat src2, Mat dst, Mat M, Size dsize, int flags, int borderMode) {
        Size size = dsize;
        warpPerspective_1(src2.nativeObj, dst.nativeObj, M.nativeObj, size.width, size.height, flags, borderMode);
    }

    public static void warpPerspective(Mat src2, Mat dst, Mat M, Size dsize, int flags) {
        warpPerspective_2(src2.nativeObj, dst.nativeObj, M.nativeObj, dsize.width, dsize.height, flags);
    }

    public static void warpPerspective(Mat src2, Mat dst, Mat M, Size dsize) {
        warpPerspective_3(src2.nativeObj, dst.nativeObj, M.nativeObj, dsize.width, dsize.height);
    }

    public static void remap(Mat src2, Mat dst, Mat map1, Mat map2, int interpolation, int borderMode, Scalar borderValue) {
        Scalar scalar = borderValue;
        long j = src2.nativeObj;
        long j2 = j;
    ...
    public static void remap(Mat src2, Mat dst, Mat map1, Mat map2, int interpolation, int borderMode) {
        remap_1(src2.nativeObj, dst.nativeObj, map1.nativeObj, map2.nativeObj, interpolation, borderMode);
    }

    public static void remap(Mat src2, Mat dst, Mat map1, Mat map2, int interpolation) {
        remap_2(src2.nativeObj, dst.nativeObj, map1.nativeObj, map2.nativeObj, interpolation);
    }
    ...
    public static Mat getRotationMatrix2D(Point center, double angle, double scale) {
        return new Mat(getRotationMatrix2D_0(center.f175x, center.f176y, angle, scale));
    }
    ...
    public static Mat getPerspectiveTransform(Mat src2, Mat dst, int solveMethod) {
        return new Mat(getPerspectiveTransform_0(src2.nativeObj, dst.nativeObj, solveMethod));
    }

    public static Mat getPerspectiveTransform(Mat src2, Mat dst) {
        return new Mat(getPerspectiveTransform_1(src2.nativeObj, dst.nativeObj));
    }

    public static Mat getAffineTransform(MatOfPoint2f src2, MatOfPoint2f dst) {
        return new Mat(getAffineTransform_0(src2.nativeObj, dst.nativeObj));
    }

    public static void getRectSubPix(Mat image, Size patchSize, Point center, Mat patch, int patchType) {
        Size size = patchSize;
        Point point = center;
        getRectSubPix_0(image.nativeObj, size.width, size.height, point.f175x, point.f176y, patch.nativeObj, patchType);
    }

    public static void getRectSubPix(Mat image, Size patchSize, Point center, Mat patch) {
        getRectSubPix_1(image.nativeObj, patchSize.width, patchSize.height, center.f175x, center.f176y, patch.nativeObj);
    }

    @Deprecated
    public static void logPolar(Mat src2, Mat dst, Point center, double M, int flags) {
        Point point = center;
        logPolar_0(src2.nativeObj, dst.nativeObj, point.f175x, point.f176y, M, flags);
    }

    @Deprecated
    public static void linearPolar(Mat src2, Mat dst, Point center, double maxRadius, int flags) {
        Point point = center;
        linearPolar_0(src2.nativeObj, dst.nativeObj, point.f175x, point.f176y, maxRadius, flags);
    }

    public static void warpPolar(Mat src2, Mat dst, Size dsize, Point center, double maxRadius, int flags) {
        Size size = dsize;
        Point point = center;
        warpPolar_0(src2.nativeObj, dst.nativeObj, size.width, size.height, point.f175x, point.f176y, maxRadius, flags);
    }

    public static void integral(Mat src2, Mat sum, int sdepth) {
        integral_0(src2.nativeObj, sum.nativeObj, sdepth);
    }

    public static void integral(Mat src2, Mat sum) {
        integral_1(src2.nativeObj, sum.nativeObj);
    }

    public static void integral2(Mat src2, Mat sum, Mat sqsum, int sdepth, int sqdepth) {
        integral2_0(src2.nativeObj, sum.nativeObj, sqsum.nativeObj, sdepth, sqdepth);
    }

    public static void integral2(Mat src2, Mat sum, Mat sqsum, int sdepth) {
        integral2_1(src2.nativeObj, sum.nativeObj, sqsum.nativeObj, sdepth);
    }

    public static void integral2(Mat src2, Mat sum, Mat sqsum) {
        integral2_2(src2.nativeObj, sum.nativeObj, sqsum.nativeObj);
    }

    public static void integral3(Mat src2, Mat sum, Mat sqsum, Mat tilted, int sdepth, int sqdepth) {
        integral3_0(src2.nativeObj, sum.nativeObj, sqsum.nativeObj, tilted.nativeObj, sdepth, sqdepth);
    }

    public static void integral3(Mat src2, Mat sum, Mat sqsum, Mat tilted, int sdepth) {
        integral3_1(src2.nativeObj, sum.nativeObj, sqsum.nativeObj, tilted.nativeObj, sdepth);
    }

    public static void integral3(Mat src2, Mat sum, Mat sqsum, Mat tilted) {
        integral3_2(src2.nativeObj, sum.nativeObj, sqsum.nativeObj, tilted.nativeObj);
    }

    public static void accumulate(Mat src2, Mat dst, Mat mask) {
        accumulate_0(src2.nativeObj, dst.nativeObj, mask.nativeObj);
    }

    public static void accumulate(Mat src2, Mat dst) {
        accumulate_1(src2.nativeObj, dst.nativeObj);
    }

    public static void accumulateSquare(Mat src2, Mat dst, Mat mask) {
        accumulateSquare_0(src2.nativeObj, dst.nativeObj, mask.nativeObj);
    }

    public static void accumulateSquare(Mat src2, Mat dst) {
        accumulateSquare_1(src2.nativeObj, dst.nativeObj);
    }
    ...
    public static void accumulateWeighted(Mat src2, Mat dst, double alpha, Mat mask) {
        accumulateWeighted_0(src2.nativeObj, dst.nativeObj, alpha, mask.nativeObj);
    }

    public static void accumulateWeighted(Mat src2, Mat dst, double alpha) {
        accumulateWeighted_1(src2.nativeObj, dst.nativeObj, alpha);
    }
    ...
    public static double threshold(Mat src2, Mat dst, double thresh, double maxval, int type) {
        return threshold_0(src2.nativeObj, dst.nativeObj, thresh, maxval, type);
    }

    public static void adaptiveThreshold(Mat src2, Mat dst, double maxValue, int adaptiveMethod, int thresholdType, int blockSize, double C) {
        adaptiveThreshold_0(src2.nativeObj, dst.nativeObj, maxValue, adaptiveMethod, thresholdType, blockSize, C);
    }

    public static void pyrDown(Mat src2, Mat dst, Size dstsize, int borderType) {
        pyrDown_0(src2.nativeObj, dst.nativeObj, dstsize.width, dstsize.height, borderType);
    }

    public static void pyrDown(Mat src2, Mat dst, Size dstsize) {
        pyrDown_1(src2.nativeObj, dst.nativeObj, dstsize.width, dstsize.height);
    }

    public static void pyrDown(Mat src2, Mat dst) {
        pyrDown_2(src2.nativeObj, dst.nativeObj);
    }

    public static void pyrUp(Mat src2, Mat dst, Size dstsize, int borderType) {
        pyrUp_0(src2.nativeObj, dst.nativeObj, dstsize.width, dstsize.height, borderType);
    }

    public static void pyrUp(Mat src2, Mat dst, Size dstsize) {
        pyrUp_1(src2.nativeObj, dst.nativeObj, dstsize.width, dstsize.height);
    }

    public static void pyrUp(Mat src2, Mat dst) {
        pyrUp_2(src2.nativeObj, dst.nativeObj);
    }
    ...
    public static void equalizeHist(Mat src2, Mat dst) {
        equalizeHist_0(src2.nativeObj, dst.nativeObj);
    }
    ...
    public static void pyrMeanShiftFiltering(Mat src2, Mat dst, double sp, double sr, int maxLevel, TermCriteria termcrit) {
        TermCriteria termCriteria = termcrit;
        pyrMeanShiftFiltering_0(src2.nativeObj, dst.nativeObj, sp, sr, maxLevel, termCriteria.type, termCriteria.maxCount, termCriteria.epsilon);
    }

    public static void pyrMeanShiftFiltering(Mat src2, Mat dst, double sp, double sr, int maxLevel) {
        pyrMeanShiftFiltering_1(src2.nativeObj, dst.nativeObj, sp, sr, maxLevel);
    }

    public static void pyrMeanShiftFiltering(Mat src2, Mat dst, double sp, double sr) {
        pyrMeanShiftFiltering_2(src2.nativeObj, dst.nativeObj, sp, sr);
    }

    public static void grabCut(Mat img, Mat mask, Rect rect, Mat bgdModel, Mat fgdModel, int iterCount, int mode) {
        Rect rect2 = rect;
        grabCut_0(img.nativeObj, mask.nativeObj, rect2.f180x, rect2.f181y, rect2.width, rect2.height, bgdModel.nativeObj, fgdModel.nativeObj, iterCount, mode);
    }

    public static void grabCut(Mat img, Mat mask, Rect rect, Mat bgdModel, Mat fgdModel, int iterCount) {
        Rect rect2 = rect;
        grabCut_1(img.nativeObj, mask.nativeObj, rect2.f180x, rect2.f181y, rect2.width, rect2.height, bgdModel.nativeObj, fgdModel.nativeObj, iterCount);
    }

    public static void distanceTransformWithLabels(Mat src2, Mat dst, Mat labels, int distanceType, int maskSize, int labelType) {
        distanceTransformWithLabels_0(src2.nativeObj, dst.nativeObj, labels.nativeObj, distanceType, maskSize, labelType);
    }

    public static void distanceTransformWithLabels(Mat src2, Mat dst, Mat labels, int distanceType, int maskSize) {
        distanceTransformWithLabels_1(src2.nativeObj, dst.nativeObj, labels.nativeObj, distanceType, maskSize);
    }

    public static void distanceTransform(Mat src2, Mat dst, int distanceType, int maskSize, int dstType) {
        distanceTransform_0(src2.nativeObj, dst.nativeObj, distanceType, maskSize, dstType);
    }

    public static void distanceTransform(Mat src2, Mat dst, int distanceType, int maskSize) {
        distanceTransform_1(src2.nativeObj, dst.nativeObj, distanceType, maskSize);
    }
    ...
    public static int floodFill(Mat image, Mat mask, Point seedPoint, Scalar newVal, Rect rect, Scalar loDiff, Scalar upDiff, int flags) {
        ...
        int retVal = floodFill_0(image.nativeObj, mask.nativeObj, point.f175x, point.f176y, scalar.val[0], scalar.val[1], scalar.val[2], scalar.val[3], dArr, scalar2.val[0], scalar2.val[1], scalar2.val[2], scalar2.val[3], scalar3.val[0], scalar3.val[1], scalar3.val[2], scalar3.val[3], flags);
        if (rect2 != null) {
            rect2.f180x = (int) rect_out3[0];
            rect2.f181y = (int) rect_out3[1];
    ...
    public static int floodFill(Mat image, Mat mask, Point seedPoint, Scalar newVal, Rect rect, Scalar loDiff, Scalar upDiff) {
        ...
        Scalar scalar3 = upDiff;
        double[] rect_out = new double[4];
        int retVal = floodFill_1(image.nativeObj, mask.nativeObj, point.f175x, point.f176y, scalar.val[0], scalar.val[1], scalar.val[2], scalar.val[3], rect_out, scalar2.val[0], scalar2.val[1], scalar2.val[2], scalar2.val[3], scalar3.val[0], scalar3.val[1], scalar3.val[2], scalar3.val[3]);
        if (rect2 != null) {
            rect2.f180x = (int) rect_out[0];
            rect2.f181y = (int) rect_out[1];
    ...
    public static int floodFill(Mat image, Mat mask, Point seedPoint, Scalar newVal, Rect rect, Scalar loDiff) {
        ...
        Scalar scalar2 = loDiff;
        double[] rect_out = new double[4];
        int retVal = floodFill_2(image.nativeObj, mask.nativeObj, point.f175x, point.f176y, scalar.val[0], scalar.val[1], scalar.val[2], scalar.val[3], rect_out, scalar2.val[0], scalar2.val[1], scalar2.val[2], scalar2.val[3]);
        if (rect2 != null) {
            rect2.f180x = (int) rect_out[0];
            rect2.f181y = (int) rect_out[1];
            rect2.width = (int) rect_out[2];
    ...
    public static int floodFill(Mat image, Mat mask, Point seedPoint, Scalar newVal, Rect rect) {
        ...
        Rect rect2 = rect;
        double[] rect_out = new double[4];
        int retVal = floodFill_3(image.nativeObj, mask.nativeObj, point.f175x, point.f176y, scalar.val[0], scalar.val[1], scalar.val[2], scalar.val[3], rect_out);
        if (rect2 != null) {
            rect2.f180x = (int) rect_out[0];
            rect2.f181y = (int) rect_out[1];
            rect2.width = (int) rect_out[2];
    ...
    public static int floodFill(Mat image, Mat mask, Point seedPoint, Scalar newVal) {
        Point point = seedPoint;
        Scalar scalar = newVal;
        return floodFill_4(image.nativeObj, mask.nativeObj, point.f175x, point.f176y, scalar.val[0], scalar.val[1], scalar.val[2], scalar.val[3]);
    }
    ...
    public static void cvtColor(Mat src2, Mat dst, int code, int dstCn) {
        cvtColor_0(src2.nativeObj, dst.nativeObj, code, dstCn);
    }

    public static void cvtColor(Mat src2, Mat dst, int code) {
        cvtColor_1(src2.nativeObj, dst.nativeObj, code);
    }
    ...
    public static void demosaicing(Mat src2, Mat dst, int code, int dstCn) {
        demosaicing_0(src2.nativeObj, dst.nativeObj, code, dstCn);
    }

    public static void demosaicing(Mat src2, Mat dst, int code) {
        demosaicing_1(src2.nativeObj, dst.nativeObj, code);
    }
    ...
    public static void findContours(Mat image, List<MatOfPoint> contours, Mat hierarchy, int mode, int method, Point offset) {
        ...
        findContours_0(image.nativeObj, contours_mat.nativeObj, hierarchy.nativeObj, mode, method, point.f175x, point.f176y);
    ...
    public static void boxPoints(RotatedRect box, Mat points) {
        boxPoints_0(box.center.f175x, box.center.f176y, box.size.width, box.size.height, box.angle, points.nativeObj);
    }
    ...
    public static void minEnclosingCircle(MatOfPoint2f points, Point center, float[] radius) {
        ...
        if (center != null) {
            center.f175x = center_out[0];
            center.f176y = center_out[1];
        }
        if (radius != null) {
    ...
    public static double pointPolygonTest(MatOfPoint2f contour, Point pt, boolean measureDist) {
        return pointPolygonTest_0(contour.nativeObj, pt.f175x, pt.f176y, measureDist);
    }
    ...
    public static int rotatedRectangleIntersection(RotatedRect rect1, RotatedRect rect2, Mat intersectingRegion) {
        ...
        double d = rotatedRect.center.f175x;
        return rotatedRectangleIntersection_0(d, rotatedRect.center.f176y, rotatedRect.size.width, rotatedRect.size.height, rotatedRect.angle, rotatedRect2.center.f175x, rotatedRect2.center.f176y, rotatedRect2.size.width, rotatedRect2.size.height, rotatedRect2.angle, intersectingRegion.nativeObj);
    }
    ...
    public static void applyColorMap(Mat src2, Mat dst, int colormap) {
        applyColorMap_0(src2.nativeObj, dst.nativeObj, colormap);
    }

    public static void applyColorMap(Mat src2, Mat dst, Mat userColor) {
        applyColorMap_1(src2.nativeObj, dst.nativeObj, userColor.nativeObj);
    }
    ...
    public static void line(Mat img, Point pt1, Point pt2, Scalar color, int thickness, int lineType, int shift) {
        ...
        Point point2 = pt2;
        Scalar scalar = color;
        line_0(img.nativeObj, point.f175x, point.f176y, point2.f175x, point2.f176y, scalar.val[0], scalar.val[1], scalar.val[2], scalar.val[3], thickness, lineType, shift);
    }
    ...
    public static void line(Mat img, Point pt1, Point pt2, Scalar color, int thickness, int lineType) {
        ...
        Point point2 = pt2;
        Scalar scalar = color;
        line_1(img.nativeObj, point.f175x, point.f176y, point2.f175x, point2.f176y, scalar.val[0], scalar.val[1], scalar.val[2], scalar.val[3], thickness, lineType);
    }
    ...
    public static void line(Mat img, Point pt1, Point pt2, Scalar color, int thickness) {
        ...
        Point point2 = pt2;
        Scalar scalar = color;
        line_2(img.nativeObj, point.f175x, point.f176y, point2.f175x, point2.f176y, scalar.val[0], scalar.val[1], scalar.val[2], scalar.val[3], thickness);
    }
    ...
    public static void line(Mat img, Point pt1, Point pt2, Scalar color) {
        ...
        Point point2 = pt2;
        Scalar scalar = color;
        line_3(img.nativeObj, point.f175x, point.f176y, point2.f175x, point2.f176y, scalar.val[0], scalar.val[1], scalar.val[2], scalar.val[3]);
    }
    ...
    public static void arrowedLine(Mat img, Point pt1, Point pt2, Scalar color, int thickness, int line_type, int shift, double tipLength) {
        ...
        Point point2 = pt2;
        Scalar scalar = color;
        arrowedLine_0(img.nativeObj, point.f175x, point.f176y, point2.f175x, point2.f176y, scalar.val[0], scalar.val[1], scalar.val[2], scalar.val[3], thickness, line_type, shift, tipLength);
    }
    ...
    public static void arrowedLine(Mat img, Point pt1, Point pt2, Scalar color, int thickness, int line_type, int shift) {
        ...
        Point point2 = pt2;
        Scalar scalar = color;
        arrowedLine_1(img.nativeObj, point.f175x, point.f176y, point2.f175x, point2.f176y, scalar.val[0], scalar.val[1], scalar.val[2], scalar.val[3], thickness, line_type, shift);
    }
    ...
    public static void arrowedLine(Mat img, Point pt1, Point pt2, Scalar color, int thickness, int line_type) {
        ...
        Point point2 = pt2;
        Scalar scalar = color;
        arrowedLine_2(img.nativeObj, point.f175x, point.f176y, point2.f175x, point2.f176y, scalar.val[0], scalar.val[1], scalar.val[2], scalar.val[3], thickness, line_type);
    }
    ...
    public static void arrowedLine(Mat img, Point pt1, Point pt2, Scalar color, int thickness) {
        ...
        Point point2 = pt2;
        Scalar scalar = color;
        arrowedLine_3(img.nativeObj, point.f175x, point.f176y, point2.f175x, point2.f176y, scalar.val[0], scalar.val[1], scalar.val[2], scalar.val[3], thickness);
    }
    ...
    public static void arrowedLine(Mat img, Point pt1, Point pt2, Scalar color) {
        ...
        Point point2 = pt2;
        Scalar scalar = color;
        arrowedLine_4(img.nativeObj, point.f175x, point.f176y, point2.f175x, point2.f176y, scalar.val[0], scalar.val[1], scalar.val[2], scalar.val[3]);
    }
    ...
    public static void rectangle(Mat img, Point pt1, Point pt2, Scalar color, int thickness, int lineType, int shift) {
        ...
        Point point2 = pt2;
        Scalar scalar = color;
        rectangle_0(img.nativeObj, point.f175x, point.f176y, point2.f175x, point2.f176y, scalar.val[0], scalar.val[1], scalar.val[2], scalar.val[3], thickness, lineType, shift);
    }
    ...
    public static void rectangle(Mat img, Point pt1, Point pt2, Scalar color, int thickness, int lineType) {
        ...
        Point point2 = pt2;
        Scalar scalar = color;
        rectangle_1(img.nativeObj, point.f175x, point.f176y, point2.f175x, point2.f176y, scalar.val[0], scalar.val[1], scalar.val[2], scalar.val[3], thickness, lineType);
    }
    ...
    public static void rectangle(Mat img, Point pt1, Point pt2, Scalar color, int thickness) {
        ...
        Point point2 = pt2;
        Scalar scalar = color;
        rectangle_2(img.nativeObj, point.f175x, point.f176y, point2.f175x, point2.f176y, scalar.val[0], scalar.val[1], scalar.val[2], scalar.val[3], thickness);
    }
    ...
    public static void rectangle(Mat img, Point pt1, Point pt2, Scalar color) {
        ...
        Point point2 = pt2;
        Scalar scalar = color;
        rectangle_3(img.nativeObj, point.f175x, point.f176y, point2.f175x, point2.f176y, scalar.val[0], scalar.val[1], scalar.val[2], scalar.val[3]);
    }

    public static void rectangle(Mat img, Rect rec, Scalar color, int thickness, int lineType, int shift) {
        Rect rect = rec;
        Scalar scalar = color;
        rectangle_4(img.nativeObj, rect.f180x, rect.f181y, rect.width, rect.height, scalar.val[0], scalar.val[1], scalar.val[2], scalar.val[3], thickness, lineType, shift);
    }

    public static void rectangle(Mat img, Rect rec, Scalar color, int thickness, int lineType) {
        Rect rect = rec;
        Scalar scalar = color;
        rectangle_5(img.nativeObj, rect.f180x, rect.f181y, rect.width, rect.height, scalar.val[0], scalar.val[1], scalar.val[2], scalar.val[3], thickness, lineType);
    }

    public static void rectangle(Mat img, Rect rec, Scalar color, int thickness) {
        Rect rect = rec;
        Scalar scalar = color;
        rectangle_6(img.nativeObj, rect.f180x, rect.f181y, rect.width, rect.height, scalar.val[0], scalar.val[1], scalar.val[2], scalar.val[3], thickness);
    }

    public static void rectangle(Mat img, Rect rec, Scalar color) {
        Rect rect = rec;
        Scalar scalar = color;
        rectangle_7(img.nativeObj, rect.f180x, rect.f181y, rect.width, rect.height, scalar.val[0], scalar.val[1], scalar.val[2], scalar.val[3]);
    }

    public static void circle(Mat img, Point center, int radius, Scalar color, int thickness, int lineType, int shift) {
        Point point = center;
        Scalar scalar = color;
        circle_0(img.nativeObj, point.f175x, point.f176y, radius, scalar.val[0], scalar.val[1], scalar.val[2], scalar.val[3], thickness, lineType, shift);
    }

    public static void circle(Mat img, Point center, int radius, Scalar color, int thickness, int lineType) {
        Point point = center;
        Scalar scalar = color;
        circle_1(img.nativeObj, point.f175x, point.f176y, radius, scalar.val[0], scalar.val[1], scalar.val[2], scalar.val[3], thickness, lineType);
    }

    public static void circle(Mat img, Point center, int radius, Scalar color, int thickness) {
        Point point = center;
        Scalar scalar = color;
        circle_2(img.nativeObj, point.f175x, point.f176y, radius, scalar.val[0], scalar.val[1], scalar.val[2], scalar.val[3], thickness);
    }

    public static void circle(Mat img, Point center, int radius, Scalar color) {
        Point point = center;
        Scalar scalar = color;
        circle_3(img.nativeObj, point.f175x, point.f176y, radius, scalar.val[0], scalar.val[1], scalar.val[2], scalar.val[3]);
    }
    ...
    public static void ellipse(Mat img, Point center, Size axes, double angle, double startAngle, double endAngle, Scalar color, int thickness, int lineType, int shift) {
        ...
        Size size = axes;
        Scalar scalar = color;
        ellipse_0(img.nativeObj, point.f175x, point.f176y, size.width, size.height, angle, startAngle, endAngle, scalar.val[0], scalar.val[1], scalar.val[2], scalar.val[3], thickness, lineType, shift);
    }
    ...
    public static void ellipse(Mat img, Point center, Size axes, double angle, double startAngle, double endAngle, Scalar color, int thickness, int lineType) {
        ...
        Size size = axes;
        Scalar scalar = color;
        ellipse_1(img.nativeObj, point.f175x, point.f176y, size.width, size.height, angle, startAngle, endAngle, scalar.val[0], scalar.val[1], scalar.val[2], scalar.val[3], thickness, lineType);
    }
    ...
    public static void ellipse(Mat img, Point center, Size axes, double angle, double startAngle, double endAngle, Scalar color, int thickness) {
        ...
        Size size = axes;
        Scalar scalar = color;
        ellipse_2(img.nativeObj, point.f175x, point.f176y, size.width, size.height, angle, startAngle, endAngle, scalar.val[0], scalar.val[1], scalar.val[2], scalar.val[3], thickness);
    }
    ...
    public static void ellipse(Mat img, Point center, Size axes, double angle, double startAngle, double endAngle, Scalar color) {
        ...
        Size size = axes;
        Scalar scalar = color;
        ellipse_3(img.nativeObj, point.f175x, point.f176y, size.width, size.height, angle, startAngle, endAngle, scalar.val[0], scalar.val[1], scalar.val[2], scalar.val[3]);
    }

    public static void ellipse(Mat img, RotatedRect box, Scalar color, int thickness, int lineType) {
        RotatedRect rotatedRect = box;
        Scalar scalar = color;
        ellipse_4(img.nativeObj, rotatedRect.center.f175x, rotatedRect.center.f176y, rotatedRect.size.width, rotatedRect.size.height, rotatedRect.angle, scalar.val[0], scalar.val[1], scalar.val[2], scalar.val[3], thickness, lineType);
    }

    public static void ellipse(Mat img, RotatedRect box, Scalar color, int thickness) {
        RotatedRect rotatedRect = box;
        Scalar scalar = color;
        ellipse_5(img.nativeObj, rotatedRect.center.f175x, rotatedRect.center.f176y, rotatedRect.size.width, rotatedRect.size.height, rotatedRect.angle, scalar.val[0], scalar.val[1], scalar.val[2], scalar.val[3], thickness);
    }

    public static void ellipse(Mat img, RotatedRect box, Scalar color) {
        RotatedRect rotatedRect = box;
        Scalar scalar = color;
        ellipse_6(img.nativeObj, rotatedRect.center.f175x, rotatedRect.center.f176y, rotatedRect.size.width, rotatedRect.size.height, rotatedRect.angle, scalar.val[0], scalar.val[1], scalar.val[2], scalar.val[3]);
    }
    ...
    public static void drawMarker(Mat img, Point position, Scalar color, int markerType, int markerSize, int thickness, int line_type) {
        ...
        Scalar scalar = color;
        drawMarker_0(img.nativeObj, point.f175x, point.f176y, scalar.val[0], scalar.val[1], scalar.val[2], scalar.val[3], markerType, markerSize, thickness, line_type);
    }

    public static void drawMarker(Mat img, Point position, Scalar color, int markerType, int markerSize, int thickness) {
        Point point = position;
        Scalar scalar = color;
        drawMarker_1(img.nativeObj, point.f175x, point.f176y, scalar.val[0], scalar.val[1], scalar.val[2], scalar.val[3], markerType, markerSize, thickness);
    }

    public static void drawMarker(Mat img, Point position, Scalar color, int markerType, int markerSize) {
        Point point = position;
        Scalar scalar = color;
        drawMarker_2(img.nativeObj, point.f175x, point.f176y, scalar.val[0], scalar.val[1], scalar.val[2], scalar.val[3], markerType, markerSize);
    }

    public static void drawMarker(Mat img, Point position, Scalar color, int markerType) {
        Point point = position;
        Scalar scalar = color;
        drawMarker_3(img.nativeObj, point.f175x, point.f176y, scalar.val[0], scalar.val[1], scalar.val[2], scalar.val[3], markerType);
    }

    public static void drawMarker(Mat img, Point position, Scalar color) {
        Point point = position;
        Scalar scalar = color;
        drawMarker_4(img.nativeObj, point.f175x, point.f176y, scalar.val[0], scalar.val[1], scalar.val[2], scalar.val[3]);
    }
    ...
    public static void fillPoly(Mat img, List<MatOfPoint> pts, Scalar color, int lineType, int shift, Point offset) {
        ...
        Scalar scalar = color;
        Point point = offset;
        fillPoly_0(img.nativeObj, Converters.vector_vector_Point_to_Mat(list, new ArrayList<>(list != null ? pts.size() : 0)).nativeObj, scalar.val[0], scalar.val[1], scalar.val[2], scalar.val[3], lineType, shift, point.f175x, point.f176y);
    }
    ...
    public static void drawContours(Mat image, List<MatOfPoint> contours, int contourIdx, Scalar color, int thickness, int lineType, Mat hierarchy, int maxLevel, Point offset) {
        ...
        Scalar scalar = color;
        Point point = offset;
        drawContours_0(image.nativeObj, Converters.vector_vector_Point_to_Mat(list, new ArrayList<>(list != null ? contours.size() : 0)).nativeObj, contourIdx, scalar.val[0], scalar.val[1], scalar.val[2], scalar.val[3], thickness, lineType, hierarchy.nativeObj, maxLevel, point.f175x, point.f176y);
    }
    ...
    public static boolean clipLine(Rect imgRect, Point pt1, Point pt2) {
        ...
        boolean retVal = clipLine_0(rect.f180x, rect.f181y, rect.width, rect.height, point.f175x, point.f176y, pt1_out, point2.f175x, point2.f176y, pt2_out);
        Point point3 = pt1;
        if (point3 != null) {
            point3.f175x = pt1_out2[0];
            point3.f176y = pt1_out2[1];
        }
        if (point2 != null) {
            point2.f175x = pt2_out[0];
            point2.f176y = pt2_out[1];
        }
        return retVal;
    }
    ...
    public static void ellipse2Poly(Point center, Size axes, int angle, int arcStart, int arcEnd, int delta, MatOfPoint pts) {
        Point point = center;
        Size size = axes;
        ellipse2Poly_0(point.f175x, point.f176y, size.width, size.height, angle, arcStart, arcEnd, delta, pts.nativeObj);
    }
    ...
    public static void putText(Mat img, String text, Point org2, int fontFace, double fontScale, Scalar color, int thickness, int lineType, boolean bottomLeftOrigin) {
        Point point = org2;
        Scalar scalar = color;
        putText_0(img.nativeObj, text, point.f175x, point.f176y, fontFace, fontScale, scalar.val[0], scalar.val[1], scalar.val[2], scalar.val[3], thickness, lineType, bottomLeftOrigin);
    }
    ...
    public static void putText(Mat img, String text, Point org2, int fontFace, double fontScale, Scalar color, int thickness, int lineType) {
        Point point = org2;
        Scalar scalar = color;
        putText_1(img.nativeObj, text, point.f175x, point.f176y, fontFace, fontScale, scalar.val[0], scalar.val[1], scalar.val[2], scalar.val[3], thickness, lineType);
    }

    public static void putText(Mat img, String text, Point org2, int fontFace, double fontScale, Scalar color, int thickness) {
        Point point = org2;
        Scalar scalar = color;
        putText_2(img.nativeObj, text, point.f175x, point.f176y, fontFace, fontScale, scalar.val[0], scalar.val[1], scalar.val[2], scalar.val[3], thickness);
    }

    public static void putText(Mat img, String text, Point org2, int fontFace, double fontScale, Scalar color) {
        Point point = org2;
        Scalar scalar = color;
        putText_3(img.nativeObj, text, point.f175x, point.f176y, fontFace, fontScale, scalar.val[0], scalar.val[1], scalar.val[2], scalar.val[3]);
    }
    ...
    public static void HoughLinesWithAccumulator(Mat image, Mat lines, double rho, double theta, int threshold, double srn, double stn, double min_theta, double max_theta) {
        long j = image.nativeObj;
        long j2 = j;
        HoughLinesWithAccumulator_0(j2, lines.nativeObj, rho, theta, threshold, srn, stn, min_theta, max_theta);
    }
