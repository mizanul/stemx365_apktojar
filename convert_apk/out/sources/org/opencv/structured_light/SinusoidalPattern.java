...
public class SinusoidalPattern extends StructuredLightPattern {
    ...
    public static SinusoidalPattern create(SinusoidalPattern_Params parameters) {
        return __fromPtr__(create_0(parameters.getNativeObjAddr()));
    }
    ...
    public void computePhaseMap(List<Mat> patternImages, Mat wrappedPhaseMap, Mat shadowMask) {
        computePhaseMap_1(this.nativeObj, Converters.vector_Mat_to_Mat(patternImages).nativeObj, wrappedPhaseMap.nativeObj, shadowMask.nativeObj);
    }

    public void computePhaseMap(List<Mat> patternImages, Mat wrappedPhaseMap) {
        computePhaseMap_2(this.nativeObj, Converters.vector_Mat_to_Mat(patternImages).nativeObj, wrappedPhaseMap.nativeObj);
    }

    public void unwrapPhaseMap(Mat wrappedPhaseMap, Mat unwrappedPhaseMap, Size camSize, Mat shadowMask) {
        Size size = camSize;
        unwrapPhaseMap_0(this.nativeObj, wrappedPhaseMap.nativeObj, unwrappedPhaseMap.nativeObj, size.width, size.height, shadowMask.nativeObj);
    }

    public void unwrapPhaseMap(Mat wrappedPhaseMap, Mat unwrappedPhaseMap, Size camSize) {
        unwrapPhaseMap_1(this.nativeObj, wrappedPhaseMap.nativeObj, unwrappedPhaseMap.nativeObj, camSize.width, camSize.height);
    }
