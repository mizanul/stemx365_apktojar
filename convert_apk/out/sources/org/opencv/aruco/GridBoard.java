...
public class GridBoard extends Board {
    ...
    public void draw(Size outSize, Mat img, int marginSize) {
        draw_1(this.nativeObj, outSize.width, outSize.height, img.nativeObj, marginSize);
    }

    public void draw(Size outSize, Mat img) {
        draw_2(this.nativeObj, outSize.width, outSize.height, img.nativeObj);
    }
    ...
    public static GridBoard create(int markersX, int markersY, float markerLength, float markerSeparation, Dictionary dictionary, int firstMarker) {
        return __fromPtr__(create_0(markersX, markersY, markerLength, markerSeparation, dictionary.getNativeObjAddr(), firstMarker));
    }

    public static GridBoard create(int markersX, int markersY, float markerLength, float markerSeparation, Dictionary dictionary) {
        return __fromPtr__(create_1(markersX, markersY, markerLength, markerSeparation, dictionary.getNativeObjAddr()));
    }
