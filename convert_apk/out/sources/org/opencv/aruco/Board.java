...
public class Board {
    ...
    private static native void setIds_0(long j, long j2);

    private static native void set_ids_0(long j, long j2);
    ...
    public static Board create(List<Mat> objPoints, Dictionary dictionary, Mat ids) {
        return __fromPtr__(create_0(Converters.vector_Mat_to_Mat(objPoints).nativeObj, dictionary.getNativeObjAddr(), ids.nativeObj));
    }

    public void setIds(Mat ids) {
        setIds_0(this.nativeObj, ids.nativeObj);
    }
    ...
    public void set_ids(MatOfInt ids) {
        set_ids_0(this.nativeObj, ids.nativeObj);
    }
