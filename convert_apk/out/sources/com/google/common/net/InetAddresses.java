...
public final class InetAddresses {
    ...
    private static final Inet4Address LOOPBACK4 = ((Inet4Address) forString(Address.LOOPBACK));
    ...
    public static final class TeredoInfo {
        ...
        public TeredoInfo(@Nullable Inet4Address server2, @Nullable Inet4Address client2, int port2, int flags2) {
            ...
            Preconditions.checkArgument(flags2 >= 0 && flags2 <= 65535, "flags '%s' is out of range (0 <= flags <= 0xffff)", Integer.valueOf(flags2));
            this.server = (Inet4Address) Objects.firstNonNull(server2, InetAddresses.ANY4);
            this.client = (Inet4Address) Objects.firstNonNull(client2, InetAddresses.ANY4);
            this.port = port2;
            this.flags = flags2;
        }
    ...
    public static Inet4Address getCoercedIPv4Address(InetAddress ip) {
        ...
        int coercedHash = Hashing.murmur3_32().hashLong(addressAsLong).asInt() | Videoio.CAP_OPENNI_GENERATORS_MASK;
        if (coercedHash == -1) {
            coercedHash = -2;
        }
