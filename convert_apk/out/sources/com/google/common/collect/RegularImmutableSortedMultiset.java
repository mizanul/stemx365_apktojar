...
final class RegularImmutableSortedMultiset<E> extends ImmutableSortedMultiset<E> {
    ...
    public CumulativeCountEntry<E> lastEntry() {
        ImmutableList<CumulativeCountEntry<E>> immutableList = this.entries;
        return (CumulativeCountEntry) immutableList.get(immutableList.size() - 1);
    }
    ...
    /* renamed from: com.google.common.collect.RegularImmutableSortedMultiset$3 */
    static /* synthetic */ class C06393 {
    ...
    public ImmutableSortedMultiset<E> headMultiset(E upperBound, BoundType boundType) {
        int index;
        int i = C06393.$SwitchMap$com$google$common$collect$BoundType[boundType.ordinal()];
        if (i == 1) {
