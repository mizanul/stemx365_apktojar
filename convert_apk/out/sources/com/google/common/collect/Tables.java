...
public final class Tables {
    ...
    private static class TransformedTable<R, C, V1, V2> implements Table<R, C, V2> {
        ...
        public Set<Table.Cell<R, C, V2>> cellSet() {
            TransformedTable<R, C, V1, V2>.CellSet cellSet2 = this.cellSet;
            if (cellSet2 != null) {
                return cellSet2;
            }
            TransformedTable<R, C, V1, V2>.CellSet cellSet3 = new CellSet();
        ...
        public Map<R, Map<C, V2>> rowMap() {
            Map<R, Map<C, V2>> map = this.rowMap;
            if (map != null) {
                return map;
            }
        ...
        public Map<C, Map<R, V2>> columnMap() {
            Map<C, Map<R, V2>> map = this.columnMap;
            if (map != null) {
                return map;
            }
