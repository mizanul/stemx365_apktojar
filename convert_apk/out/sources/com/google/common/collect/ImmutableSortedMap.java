...
public class ImmutableSortedMap<K, V> extends ImmutableSortedMapFauxverideShim<K, V> implements NavigableMap<K, V> {
    private static final ImmutableSortedMap<Comparable, Object> NATURAL_EMPTY_MAP = new ImmutableSortedMap<>(ImmutableList.m42of(), NATURAL_ORDER);
    ...
    /* renamed from: of */
    public static <K, V> ImmutableSortedMap<K, V> m93of() {
    ...
    private static <K, V> ImmutableSortedMap<K, V> emptyMap(Comparator<? super K> comparator2) {
        ...
        return new ImmutableSortedMap<>(ImmutableList.m42of(), comparator2);
    }

    /* renamed from: of */
    public static <K extends Comparable<? super K>, V> ImmutableSortedMap<K, V> m94of(K k1, V v1) {
        return new ImmutableSortedMap<>(ImmutableList.m43of(entryOf(k1, v1)), Ordering.natural());
    }

    /* renamed from: of */
    public static <K extends Comparable<? super K>, V> ImmutableSortedMap<K, V> m95of(K k1, V v1, K k2, V v2) {
        return new Builder(Ordering.natural()).put((Object) k1, (Object) v1).put((Object) k2, (Object) v2).build();
    }

    /* renamed from: of */
    public static <K extends Comparable<? super K>, V> ImmutableSortedMap<K, V> m96of(K k1, V v1, K k2, V v2, K k3, V v3) {
        return new Builder(Ordering.natural()).put((Object) k1, (Object) v1).put((Object) k2, (Object) v2).put((Object) k3, (Object) v3).build();
    }

    /* renamed from: of */
    public static <K extends Comparable<? super K>, V> ImmutableSortedMap<K, V> m97of(K k1, V v1, K k2, V v2, K k3, V v3, K k4, V v4) {
    ...
    /* renamed from: of */
    public static <K extends Comparable<? super K>, V> ImmutableSortedMap<K, V> m98of(K k1, V v1, K k2, V v2, K k3, V v3, K k4, V v4, K k5, V v5) {
    ...
    public ImmutableSet<Map.Entry<K, V>> createEntrySet() {
        return isEmpty() ? ImmutableSet.m80of() : new EntrySet();
    }
    ...
    public Map.Entry<K, V> lastEntry() {
        ...
        return (Map.Entry) immutableList.get(immutableList.size() - 1);
    }
