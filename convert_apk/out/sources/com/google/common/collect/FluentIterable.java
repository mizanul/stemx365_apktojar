...
public abstract class FluentIterable<E> implements Iterable<E> {
    ...
    public final Optional<E> first() {
        ...
        return iterator.hasNext() ? Optional.m20of(iterator.next()) : Optional.absent();
    }
    ...
    public final Optional<E> last() {
        ...
        if (iterable2 instanceof List) {
            ...
            return Optional.m20of(list.get(list.size() - 1));
        }
        ...
        if (iterable3 instanceof SortedSet) {
            return Optional.m20of(((SortedSet) iterable3).last());
        }
        do {
            current = iterator.next();
        } while (iterator.hasNext());
        return Optional.m20of(current);
    }
