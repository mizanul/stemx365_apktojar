...
public final class ArrayTable<R, C, V> implements Table<R, C, V>, Serializable {
    ...
    /* renamed from: at */
    public V mo8939at(int rowIndex, int columnIndex) {
    ...
    public Map<R, V> column(C columnKey) {
        Preconditions.checkNotNull(columnKey);
        Integer columnIndex = this.columnKeyToIndex.get(columnKey);
        return columnIndex == null ? ImmutableMap.m61of() : new Column(columnIndex.intValue());
    }
    ...
    public Map<C, V> row(R rowKey) {
        Preconditions.checkNotNull(rowKey);
        Integer rowIndex = this.rowKeyToIndex.get(rowKey);
        return rowIndex == null ? ImmutableMap.m61of() : new Row(rowIndex.intValue());
    }
