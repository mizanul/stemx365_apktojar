...
public final class LinkedHashMultimap<K, V> extends AbstractSetMultimap<K, V> {
    ...
    private LinkedHashMultimap(int expectedKeys, int expectedValuesPerKey2) {
        ...
        this.linkedEntries = new LinkedHashSet((int) Math.min(1073741824, ((long) expectedKeys) * ((long) expectedValuesPerKey2)));
    }
    ...
    public Iterator<Map.Entry<K, V>> createEntryIterator() {
        ...
        return new Iterator<Map.Entry<K, V>>() {
            ...
            public Map.Entry<K, V> next() {
                Map.Entry<K, V> entry2 = (Map.Entry) delegateIterator.next();
                this.entry = entry2;
                return entry2;
            }
