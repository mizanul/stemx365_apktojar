...
public abstract class ImmutableMultimap<K, V> implements Multimap<K, V>, Serializable {
    ...
    /* renamed from: of */
    public static <K, V> ImmutableMultimap<K, V> m67of() {
        return ImmutableListMultimap.m55of();
    }

    /* renamed from: of */
    public static <K, V> ImmutableMultimap<K, V> m68of(K k1, V v1) {
        return ImmutableListMultimap.m56of(k1, v1);
    }

    /* renamed from: of */
    public static <K, V> ImmutableMultimap<K, V> m69of(K k1, V v1, K k2, V v2) {
        return ImmutableListMultimap.m57of(k1, v1, k2, v2);
    }

    /* renamed from: of */
    public static <K, V> ImmutableMultimap<K, V> m70of(K k1, V v1, K k2, V v2, K k3, V v3) {
        return ImmutableListMultimap.m58of(k1, v1, k2, v2, k3, v3);
    }

    /* renamed from: of */
    public static <K, V> ImmutableMultimap<K, V> m71of(K k1, V v1, K k2, V v2, K k3, V v3, K k4, V v4) {
        return ImmutableListMultimap.m59of(k1, v1, k2, v2, k3, v3, k4, v4);
    }

    /* renamed from: of */
    public static <K, V> ImmutableMultimap<K, V> m72of(K k1, V v1, K k2, V v2, K k3, V v3, K k4, V v4, K k5, V v5) {
        return ImmutableListMultimap.m60of(k1, v1, k2, v2, k3, v3, k4, v4, k5, v5);
    }
