...
public class ImmutableListMultimap<K, V> extends ImmutableMultimap<K, V> implements ListMultimap<K, V> {
    ...
    /* renamed from: of */
    public static <K, V> ImmutableListMultimap<K, V> m55of() {
        return EmptyImmutableListMultimap.INSTANCE;
    }

    /* renamed from: of */
    public static <K, V> ImmutableListMultimap<K, V> m56of(K k1, V v1) {
    ...
    /* renamed from: of */
    public static <K, V> ImmutableListMultimap<K, V> m57of(K k1, V v1, K k2, V v2) {
        Builder<K, V> builder = builder();
        builder.put(k1, v1);
        builder.put(k2, v2);
        return builder.build();
    ...
    /* renamed from: of */
    public static <K, V> ImmutableListMultimap<K, V> m58of(K k1, V v1, K k2, V v2, K k3, V v3) {
        Builder<K, V> builder = builder();
        builder.put(k1, v1);
        builder.put(k2, v2);
        builder.put(k3, v3);
    ...
    /* renamed from: of */
    public static <K, V> ImmutableListMultimap<K, V> m59of(K k1, V v1, K k2, V v2, K k3, V v3, K k4, V v4) {
        Builder<K, V> builder = builder();
        builder.put(k1, v1);
        builder.put(k2, v2);
        builder.put(k3, v3);
    ...
    /* renamed from: of */
    public static <K, V> ImmutableListMultimap<K, V> m60of(K k1, V v1, K k2, V v2, K k3, V v3, K k4, V v4, K k5, V v5) {
        Builder<K, V> builder = builder();
        builder.put(k1, v1);
        builder.put(k2, v2);
        builder.put(k3, v3);
    ...
    public ImmutableList<V> get(@Nullable K key) {
        ...
        return list == null ? ImmutableList.m42of() : list;
    }
        ...
        if (keyCount >= 0) {
            ...
            while (i < keyCount) {
                ...
                if (valueCount > 0) {
                    ...
                    builder.put(key, ImmutableList.copyOf((E[]) array));
                    tmpSize += valueCount;
                    i++;
                } else {
