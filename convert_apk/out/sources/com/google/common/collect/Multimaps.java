...
public final class Multimaps {
    ...
    private static class MapMultimap<K, V> implements SetMultimap<K, V>, Serializable {
        private static final Joiner.MapJoiner JOINER = Joiner.m19on("], ").withKeyValueSeparator("=[").useForNull("null");
            ...
            return new AbstractSet<V>() {
                public Iterator<V> iterator() {
                    return new Iterator<V>() {
                        ...
                        public boolean hasNext() {
                            return this.f70i == 0 && MapMultimap.this.map.containsKey(key);
                        }
    ...
    private static class TransformedEntriesMultimap<K, V1, V2> implements Multimap<K, V2> {
        ...
        public Map<K, Collection<V2>> asMap() {
            Map<K, Collection<V2>> aM = this.asMap;
            if (aM != null) {
                return aM;
            }
            Map<K, Collection<V2>> aM2 = Maps.transformEntries(this.fromMultimap.asMap(), new Maps.EntryTransformer<K, Collection<V1>, Collection<V2>>() {
        ...
        public Collection<Map.Entry<K, V2>> entries() {
            Collection<Map.Entry<K, V2>> es = this.entries;
            if (es != null) {
                return es;
            }
            Collection<Map.Entry<K, V2>> es2 = new TransformedEntries(this.transformer);
            this.entries = es2;
            return es2;
        }
        ...
        public Collection<V2> values() {
            Collection<V2> vs = this.values;
            if (vs != null) {
                return vs;
            }
            Collection<V2> vs2 = Collections2.transform(this.fromMultimap.entries(), new Function<Map.Entry<K, V1>, V2>() {
    ...
    private static class FilteredMultimap<K, V> implements Multimap<K, V> {
        ...
        class AsMap extends ForwardingMap<K, Collection<V>> {
            ...
            public Collection<Collection<V>> values() {
                FilteredMultimap<K, V>.AsMap.Values values = this.asMapValues;
                if (values != null) {
                    return values;
                }
                Values values2 = new Values();
                this.asMapValues = values2;
                return values2;
            }
            ...
            public Set<Map.Entry<K, Collection<V>>> entrySet() {
                FilteredMultimap<K, V>.AsMap.EntrySet entrySet2 = this.entrySet;
                if (entrySet2 != null) {
                    return entrySet2;
                }
                EntrySet entrySet3 = new EntrySet(super.entrySet());
        ...
        public Multiset<K> keys() {
            AbstractMultiset<K> abstractMultiset = this.keys;
            if (abstractMultiset != null) {
