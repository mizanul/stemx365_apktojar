...
final class GeneralRange<T> implements Serializable {
    ...
    public GeneralRange<T> intersect(GeneralRange<T> other) {
        ...
        if (!hasLowerBound()) {
            ...
            lowType = generalRange.lowerBoundType;
        ...
        T upEnd2 = this.upperEndpoint;
        BoundType upType2 = this.upperBoundType;
        if (!hasUpperBound()) {
            hasUpBound = generalRange.hasUpperBound;
            T upEnd3 = generalRange.upperEndpoint;
            upType2 = generalRange.upperBoundType;
            upEnd = upEnd3;
        } else if (!other.hasUpperBound() || ((cmp2 = this.comparator.compare(this.upperEndpoint, generalRange.upperEndpoint)) <= 0 && !(cmp2 == 0 && generalRange.upperBoundType == BoundType.OPEN))) {
            upEnd = upEnd2;
        } else {
            T upEnd4 = generalRange.upperEndpoint;
            upType2 = generalRange.upperBoundType;
            upEnd = upEnd4;
        }
    ...
    public String toString() {
        ...
        builder.append(":");
        int i = C04681.$SwitchMap$com$google$common$collect$BoundType[this.lowerBoundType.ordinal()];
        if (i == 1) {
            builder.append('[');
        } else if (i == 2) {
            builder.append('(');
        ...
        int i2 = C04681.$SwitchMap$com$google$common$collect$BoundType[this.upperBoundType.ordinal()];
        if (i2 == 1) {
            builder.append(']');
        } else if (i2 == 2) {
            builder.append(')');
