...
final class SingletonImmutableTable<R, C, V> extends ImmutableTable<R, C, V> {
    ...
    public ImmutableSet<Table.Cell<R, C, V>> cellSet() {
        return ImmutableSet.m81of(Tables.immutableCell(this.singleRowKey, this.singleColumnKey, this.singleValue));
    }

    public ImmutableMap<R, V> column(C columnKey) {
        Preconditions.checkNotNull(columnKey);
        return containsColumn(columnKey) ? ImmutableMap.m62of(this.singleRowKey, this.singleValue) : ImmutableMap.m61of();
    }

    public ImmutableSet<C> columnKeySet() {
        return ImmutableSet.m81of(this.singleColumnKey);
    }

    public ImmutableMap<C, Map<R, V>> columnMap() {
        return ImmutableMap.m62of(this.singleColumnKey, ImmutableMap.m62of(this.singleRowKey, this.singleValue));
    }
    ...
    public ImmutableMap<C, V> row(R rowKey) {
        ...
        return containsRow(rowKey) ? ImmutableMap.m62of(this.singleColumnKey, this.singleValue) : ImmutableMap.m61of();
    }

    public ImmutableSet<R> rowKeySet() {
        return ImmutableSet.m81of(this.singleRowKey);
    }

    public ImmutableMap<R, Map<C, V>> rowMap() {
        return ImmutableMap.m62of(this.singleRowKey, ImmutableMap.m62of(this.singleColumnKey, this.singleValue));
    }
    ...
    public ImmutableCollection<V> values() {
        return ImmutableSet.m81of(this.singleValue);
    }
