...
class TypeResolver {
    ...
    TypeResolver() {
        this.typeTable = ImmutableMap.m61of();
    }
    ...
    private static final class WildcardCapturer {
        ...
        /* renamed from: id */
        private final AtomicInteger f84id;

        private WildcardCapturer() {
            this.f84id = new AtomicInteger();
        }
        ...
        public Type capture(Type type) {
            ...
            if (type instanceof ParameterizedType) {
                ...
                return Types.newTypeVariable(WildcardCapturer.class, "capture#" + this.f84id.incrementAndGet() + "-of ? extends " + Joiner.m18on((char) Typography.amp).join((Object[]) upperBounds), wildcardType.getUpperBounds());
            } else {
