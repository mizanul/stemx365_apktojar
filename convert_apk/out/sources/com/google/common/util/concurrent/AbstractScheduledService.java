...
public abstract class AbstractScheduledService implements Service {
    ...
    public final AbstractService delegate = new AbstractService() {
        ...
        public final Runnable task = new Runnable() {
            public void run() {
                C07451.this.lock.lock();
                try {
                    AbstractScheduledService.this.runOneIteration();
                    C07451.this.lock.unlock();
                } catch (Throwable t) {
                    C07451.this.lock.unlock();
                    throw t;
                }
            ...
            this.executorService.execute(new Runnable() {
                public void run() {
                    ...
                    try {
                        ...
                        Future unused = C07451.this.runningTask = AbstractScheduledService.this.scheduler().schedule(AbstractScheduledService.this.delegate, C07451.this.executorService, C07451.this.task);
                        C07451.this.notifyStarted();
                        C07451.this.lock.unlock();
                    } catch (Throwable t) {
                        C07451.this.lock.unlock();
                        throw t;
        ...
        public final void doStop() {
            ...
            this.executorService.execute(new Runnable() {
                public void run() {
                    try {
                        C07451.this.lock.lock();
                        if (C07451.this.state() != Service.State.STOPPING) {
                            C07451.this.lock.unlock();
                            return;
                        }
                        AbstractScheduledService.this.shutDown();
                        C07451.this.lock.unlock();
                        C07451.this.notifyStopped();
                    } catch (Throwable t) {
                        C07451.this.notifyFailed(t);
