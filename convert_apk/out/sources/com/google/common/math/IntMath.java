...
public final class IntMath {
    static int[] BIGGEST_BINOMIALS = {Integer.MAX_VALUE, Integer.MAX_VALUE, 65536, 2345, Videoio.CAP_PROP_XI_GAMMAC, 193, 110, 75, 58, 49, 43, 39, 37, 35, 34, 34, 33};
    ...
    static final int[] POWERS_OF_10 = {1, 10, 100, 1000, 10000, 100000, DurationKt.NANOS_IN_MILLIS, 10000000, 100000000, 1000000000};
    ...
    public static int log2(int x, RoundingMode mode) {
        ...
        switch (C07211.$SwitchMap$java$math$RoundingMode[mode.ordinal()]) {
            case 1:
