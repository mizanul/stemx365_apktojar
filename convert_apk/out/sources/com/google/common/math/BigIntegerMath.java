...
public final class BigIntegerMath {
    ...
    public static int log2(BigInteger x, RoundingMode mode) {
        ...
        switch (C07191.$SwitchMap$java$math$RoundingMode[mode.ordinal()]) {
            case 1:
    ...
    public static int log10(BigInteger x, RoundingMode mode) {
        ...
        int floorLog = 0;
        int i = powersOf10.size() - 1;
        BigInteger powOf10 = null;
        while (i >= 0) {
            powOf10 = powersOf10.get(i);
            floorLog *= 2;
