...
class ComparisonsKt__ComparisonsKt {
    ...
    public static final <T> Comparator<T> then(Comparator<T> $this$then, Comparator<? super T> comparator) {
        Intrinsics.checkNotNullParameter($this$then, "$this$then");
        Intrinsics.checkNotNullParameter(comparator, "comparator");
        return new ComparisonsKt__ComparisonsKt$then$1<>($this$then, comparator);
    }

    public static final <T> Comparator<T> thenDescending(Comparator<T> $this$thenDescending, Comparator<? super T> comparator) {
        Intrinsics.checkNotNullParameter($this$thenDescending, "$this$thenDescending");
        Intrinsics.checkNotNullParameter(comparator, "comparator");
        return new ComparisonsKt__ComparisonsKt$thenDescending$1<>($this$thenDescending, comparator);
    }
