...
public class FunctionReference extends CallableReference implements FunctionBase, KFunction {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof FunctionReference) {
            ...
            if (!Intrinsics.areEqual((Object) getOwner(), (Object) other.getOwner()) || !getName().equals(other.getName()) || !getSignature().equals(other.getSignature()) || this.flags != other.flags || this.arity != other.arity || !Intrinsics.areEqual(getBoundReceiver(), other.getBoundReceiver())) {
                return false;
            }
            return true;
