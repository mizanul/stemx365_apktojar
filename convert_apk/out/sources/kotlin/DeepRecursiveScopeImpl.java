...
final class DeepRecursiveScopeImpl<T, R> extends DeepRecursiveScope<T, R> implements Continuation<R> {
    ...
    public <U, S> Object callRecursive(DeepRecursiveFunction<U, S> $this$callRecursive, U value2, Continuation<? super S> $completion) {
        ...
        if (function2 != null) {
            DeepRecursiveScopeImpl $this$with = this;
            Function3 currentFunction = $this$with.function;
            if (function2 != currentFunction) {
                $this$with.function = function2;
                if (cont2 != null) {
                    $this$with.cont = $this$with.crossFunctionCompletion(currentFunction, cont2);
                } else {
                    throw new NullPointerException("null cannot be cast to non-null type kotlin.coroutines.Continuation<kotlin.Any?>");
                }
            } else if (cont2 != null) {
                $this$with.cont = cont2;
            } else {
                throw new NullPointerException("null cannot be cast to non-null type kotlin.coroutines.Continuation<kotlin.Any?>");
            }
            $this$with.value = value2;
            Object coroutine_suspended = IntrinsicsKt.getCOROUTINE_SUSPENDED();
            if (coroutine_suspended == IntrinsicsKt.getCOROUTINE_SUSPENDED()) {
                DebugProbesKt.probeCoroutineSuspended($completion);
            }
    ...
    private final Continuation<Object> crossFunctionCompletion(Function3<? super DeepRecursiveScope<?, ?>, Object, ? super Continuation<Object>, ? extends Object> currentFunction, Continuation<Object> cont2) {
        return new C0768x3ce6e4bb(EmptyCoroutineContext.INSTANCE, this, currentFunction, cont2);
    }
    ...
    public final R runCallLoop() {
        while (true) {
            ...
            if (cont2 == null) {
                ...
                return result2;
            } else if (Result.m190equalsimpl0(DeepRecursiveKt.UNDEFINED_RESULT, result2)) {
                try {
                    ...
                    if (function3 != null) {
                        ...
                        if (r != IntrinsicsKt.getCOROUTINE_SUSPENDED()) {
                            ...
                            cont2.resumeWith(Result.m188constructorimpl(r));
                        }
                    } else {
                    ...
                    cont2.resumeWith(Result.m188constructorimpl(ResultKt.createFailure(e)));
                }
            } else {
