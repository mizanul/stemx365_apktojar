...
class MathKt__MathJVMKt extends MathKt__MathHKt {
    ...
    /* renamed from: ln */
    private static final double m155ln(double x) {
        return Math.log(x);
    }
    ...
    /* renamed from: ln */
    private static final float m156ln(float x) {
