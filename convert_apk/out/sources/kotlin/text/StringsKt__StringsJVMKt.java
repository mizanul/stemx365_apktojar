...
class StringsKt__StringsJVMKt extends StringsKt__StringNumberConversionsKt {
    ...
    public static final String replace(String $this$replace, char oldChar, char newChar, boolean ignoreCase) {
        ...
        for (int i = 0; i < $this$forEach$iv.length(); i++) {
            ...
            $this$buildString.append(CharsKt.equals(c, oldChar, ignoreCase) ? newChar : c);
        }
    ...
    public static final String replace(String $this$replace, String oldValue, String newValue, boolean ignoreCase) {
        ...
        int occurrenceIndex = StringsKt.indexOf((CharSequence) $this$run, oldValue, 0, ignoreCase);
        ...
        if (newLengthHint >= 0) {
            ...
            do {
                ...
                if (occurrenceIndex >= $this$run.length() || (occurrenceIndex = StringsKt.indexOf((CharSequence) $this$run, oldValue, occurrenceIndex + searchStep, ignoreCase)) <= 0) {
                ...
                i = occurrenceIndex + oldValueLength;
                break;
            } while ((occurrenceIndex = StringsKt.indexOf((CharSequence) $this$run, oldValue, occurrenceIndex + searchStep, ignoreCase)) <= 0);
            stringBuilder.append($this$run, i, $this$run.length());
