...
class CollectionsKt__CollectionsKt extends CollectionsKt__CollectionsJVMKt {
    public static final <T> Collection<T> asCollection(T[] $this$asCollection) {
        Intrinsics.checkNotNullParameter($this$asCollection, "$this$asCollection");
    ...
    public static final <T> List<T> optimizeReadOnlyList(List<? extends T> $this$optimizeReadOnlyList) {
        Intrinsics.checkNotNullParameter($this$optimizeReadOnlyList, "$this$optimizeReadOnlyList");
        int size = $this$optimizeReadOnlyList.size();
        if (size == 0) {
            return CollectionsKt.emptyList();
        }
        if (size != 1) {
    ...
    public static /* synthetic */ int binarySearchBy$default(List $this$binarySearchBy, Comparable key, int fromIndex, int toIndex, Function1 selector, int i, Object obj) {
        ...
        Intrinsics.checkNotNullParameter($this$binarySearchBy, "$this$binarySearchBy");
