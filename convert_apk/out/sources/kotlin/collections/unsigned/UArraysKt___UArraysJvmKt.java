...
class UArraysKt___UArraysJvmKt {
    ...
    public static final List<ULong> m657asListQwZRm1k(long[] $this$asList) {
        Intrinsics.checkNotNullParameter($this$asList, "$this$asList");
        return new UArraysKt___UArraysJvmKt$asList$2($this$asList);
    }

    /* renamed from: asList-GBYM_sE  reason: not valid java name */
    public static final List<UByte> m656asListGBYM_sE(byte[] $this$asList) {
        Intrinsics.checkNotNullParameter($this$asList, "$this$asList");
        return new UArraysKt___UArraysJvmKt$asList$3($this$asList);
    }

    /* renamed from: asList-rL5Bavg  reason: not valid java name */
    public static final List<UShort> m658asListrL5Bavg(short[] $this$asList) {
        Intrinsics.checkNotNullParameter($this$asList, "$this$asList");
    ...
    public static /* synthetic */ int m660binarySearch2fe2U9s$default(int[] iArr, int i, int i2, int i3, int i4, Object obj) {
        ...
        if ((i4 & 4) != 0) {
            i3 = UIntArray.m342getSizeimpl(iArr);
        }
        return UArraysKt.m659binarySearch2fe2U9s(iArr, i, i2, i3);
    }

    /* renamed from: binarySearch-2fe2U9s  reason: not valid java name */
    public static final int m659binarySearch2fe2U9s(int[] $this$binarySearch, int element, int fromIndex, int toIndex) {
        Intrinsics.checkNotNullParameter($this$binarySearch, "$this$binarySearch");
        AbstractList.Companion.checkRangeIndexes$kotlin_stdlib(fromIndex, toIndex, UIntArray.m342getSizeimpl($this$binarySearch));
    ...
    public static /* synthetic */ int m664binarySearchK6DWlUc$default(long[] jArr, long j, int i, int i2, int i3, Object obj) {
        ...
        if ((i3 & 4) != 0) {
            i2 = ULongArray.m420getSizeimpl(jArr);
        }
        return UArraysKt.m663binarySearchK6DWlUc(jArr, j, i, i2);
    }

    /* renamed from: binarySearch-K6DWlUc  reason: not valid java name */
    public static final int m663binarySearchK6DWlUc(long[] $this$binarySearch, long element, int fromIndex, int toIndex) {
        Intrinsics.checkNotNullParameter($this$binarySearch, "$this$binarySearch");
        AbstractList.Companion.checkRangeIndexes$kotlin_stdlib(fromIndex, toIndex, ULongArray.m420getSizeimpl($this$binarySearch));
    ...
    public static final int m665binarySearchWpHrYlw(byte[] $this$binarySearch, byte element, int fromIndex, int toIndex) {
        Intrinsics.checkNotNullParameter($this$binarySearch, "$this$binarySearch");
        AbstractList.Companion.checkRangeIndexes$kotlin_stdlib(fromIndex, toIndex, UByteArray.m264getSizeimpl($this$binarySearch));
    ...
    public static /* synthetic */ int m662binarySearchEtDCXyQ$default(short[] sArr, short s, int i, int i2, int i3, Object obj) {
        ...
        if ((i3 & 4) != 0) {
            i2 = UShortArray.m524getSizeimpl(sArr);
        }
        return UArraysKt.m661binarySearchEtDCXyQ(sArr, s, i, i2);
    }

    /* renamed from: binarySearch-EtDCXyQ  reason: not valid java name */
    public static final int m661binarySearchEtDCXyQ(short[] $this$binarySearch, short element, int fromIndex, int toIndex) {
        Intrinsics.checkNotNullParameter($this$binarySearch, "$this$binarySearch");
        AbstractList.Companion.checkRangeIndexes$kotlin_stdlib(fromIndex, toIndex, UShortArray.m524getSizeimpl($this$binarySearch));
    ...
    private static final BigDecimal sumOfBigDecimal(int[] $this$sumOf, Function1<? super UInt, ? extends BigDecimal> selector) {
        ...
        for (int element : $this$sumOf) {
            BigDecimal add = sum.add((BigDecimal) selector.invoke(UInt.m276boximpl(element)));
    ...
    private static final BigDecimal sumOfBigDecimal(long[] $this$sumOf, Function1<? super ULong, ? extends BigDecimal> selector) {
        ...
        for (long element : $this$sumOf) {
            BigDecimal add = sum.add((BigDecimal) selector.invoke(ULong.m354boximpl(element)));
            Intrinsics.checkNotNullExpressionValue(add, "this.add(other)");
            sum = add;
        }
        return sum;
    ...
    private static final BigDecimal sumOfBigDecimal(byte[] $this$sumOf, Function1<? super UByte, ? extends BigDecimal> selector) {
        ...
        for (byte element : $this$sumOf) {
            BigDecimal add = sum.add((BigDecimal) selector.invoke(UByte.m200boximpl(element)));
            Intrinsics.checkNotNullExpressionValue(add, "this.add(other)");
            sum = add;
        }
        return sum;
    ...
    private static final BigDecimal sumOfBigDecimal(short[] $this$sumOf, Function1<? super UShort, ? extends BigDecimal> selector) {
        ...
        for (short element : $this$sumOf) {
            BigDecimal add = sum.add((BigDecimal) selector.invoke(UShort.m460boximpl(element)));
            Intrinsics.checkNotNullExpressionValue(add, "this.add(other)");
            sum = add;
        }
        return sum;
    ...
    private static final BigInteger sumOfBigInteger(int[] $this$sumOf, Function1<? super UInt, ? extends BigInteger> selector) {
        ...
        for (int element : $this$sumOf) {
            BigInteger add = sum.add((BigInteger) selector.invoke(UInt.m276boximpl(element)));
            Intrinsics.checkNotNullExpressionValue(add, "this.add(other)");
            sum = add;
        }
        return sum;
    ...
    private static final BigInteger sumOfBigInteger(long[] $this$sumOf, Function1<? super ULong, ? extends BigInteger> selector) {
        ...
        Intrinsics.checkNotNullExpressionValue(sum, "BigInteger.valueOf(this.toLong())");
        for (long element : $this$sumOf) {
            BigInteger add = sum.add((BigInteger) selector.invoke(ULong.m354boximpl(element)));
            Intrinsics.checkNotNullExpressionValue(add, "this.add(other)");
            sum = add;
        }
        return sum;
    ...
    private static final BigInteger sumOfBigInteger(byte[] $this$sumOf, Function1<? super UByte, ? extends BigInteger> selector) {
        ...
        Intrinsics.checkNotNullExpressionValue(sum, "BigInteger.valueOf(this.toLong())");
        for (byte element : $this$sumOf) {
            BigInteger add = sum.add((BigInteger) selector.invoke(UByte.m200boximpl(element)));
            Intrinsics.checkNotNullExpressionValue(add, "this.add(other)");
            sum = add;
        }
        return sum;
    ...
    private static final BigInteger sumOfBigInteger(short[] $this$sumOf, Function1<? super UShort, ? extends BigInteger> selector) {
        ...
        Intrinsics.checkNotNullExpressionValue(sum, "BigInteger.valueOf(this.toLong())");
        for (short element : $this$sumOf) {
            BigInteger add = sum.add((BigInteger) selector.invoke(UShort.m460boximpl(element)));
            Intrinsics.checkNotNullExpressionValue(add, "this.add(other)");
            sum = add;
        }
        return sum;
