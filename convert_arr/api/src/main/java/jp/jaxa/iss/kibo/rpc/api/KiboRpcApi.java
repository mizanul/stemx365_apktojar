...
public class KiboRpcApi {
    ...
    public static final String TARGET_IMAGES_SAVE_DIR="/";
    ...
    public Result moveTo3(Point goalPoint, Quaternion orientation, boolean printRobotPosition) {
     ...
     public Result moveTo(final Point goalPoint, final Quaternion orientation, final boolean printRobotPosition) {
      ...
      private boolean isActiveTarget() {
        ...
        if (front) {
            common.util.CustomLog.i((String)"KiboRpcApi", (String)"[Start] flashlightControl: front");
            common.util.CustomLog.i((String)"KiboRpcApi", (String)("Parameters: brightness == " + brightness));
            flloc = FlashlightLocation.FRONT;
        } else {
            common.util.CustomLog.i((String)"KiboRpcApi", (String)"[Start] flashlightControl: back");
            common.util.CustomLog.i((String)"KiboRpcApi", (String)("Parameters: brightness == " + brightness));
        ...
        common.util.CustomLog.i((String)"KiboRpcApi", (String)"[Finish] flashlightControlFront");
        return this.getCommandResult(pendingResult, false, -1);
    }
   ...
   public List<Integer> getActiveTargets() {
    ...
    public boolean setPlanner(PlannerType plannerType) {
        ...
        try {
            JSONObject data = new JSONObject();
            common.util.CustomLog.v((String)"KiboRpcApi", (String)"[Start] setSignalStateFoundPattern");
            ...
            this.gsService.sendData(MessageType.JSON, "data", data.toString());
            common.util.CustomLog.v((String)"KiboRpcApi", (String)"[Finish] setSignalStateFoundPattern");
        }
     ...
     private void setSignalStateRecognitionPattern() {
        try {
            JSONObject data = new JSONObject();
            common.util.CustomLog.v((String)"KiboRpcApi", (String)"[Start] setSignalStateRecognitionPattern");
            //this.setterNode.setSignalState((byte)3, 1);  // TODO
            data.put("signal_light", (Object)"Turn on the recognition pattern");
            this.gsService.sendData(MessageType.JSON, "data", data.toString());
            common.util.CustomLog.v((String)"KiboRpcApi", (String)"[Finish] setSignalStateRecognitionPattern");
        }
        catch (JSONException e) {
...
public boolean takeSnapshot(int targetNumber, boolean hasTakenSnapshot, int approach_times) {
   ...
   private void saveImage(Bitmap image, String imageName, File file) throws SecurityException, IOException, NullPointerException {
    ...
    public void setAreaInfo(int areaId, String itemName, int number) {
        try {
            common.util.CustomLog.i((String)"KiboRpcApi", (String)"[Start] setAreaInfo");
            boolean checkArgs = true;
            if (itemName == null) {
                common.util.CustomLog.e((String)"KiboRpcApi", (String)"[saveBitmapImage] itemName is null");
                itemName = "";
            }
            common.util.CustomLog.i((String)"KiboRpcApi", (String)("Parameters: areaId == " + areaId + ", itemName == " + itemName + ", number == " + number));
            ...
            data.put("num", number);
            this.gsService.sendData(MessageType.JSON, "data", data.toString());
            common.util.CustomLog.i((String)"KiboRpcApi", (String)"[Finish] setAreaInfo");
        }
        catch (Exception e) {
...
public void reportPoint1Arrival() {
      try {
       ...
       public void notifyRecognitionItem() {
        common.util.CustomLog.i((String)"KiboRpcApi", (String)"[Start] notifyRecognitionItem");
        try {
            common.util.CustomLog.v((String)"KiboRpcApi", (String)"[notifyRecognitionItem] Target Item recognition is complete");
            JSONObject data = new JSONObject();
            data.put("status", (Object)"Target Item recognition is complete");
            this.gsService.sendData(MessageType.JSON, "data", data.toString());
            if (!this.gsService.getOnSimulation()) {
                this.setSignalStateRecognitionPattern();
                //this.setterNode.setSignalState((byte)17, 1);  //TODO
            }
        }
        catch (JSONException e) {
        ...
        common.util.CustomLog.i((String)"KiboRpcApi", (String)"[Finish] notifyRecognitionItem");
    }

   public boolean reportRoundingCompletion() {
        common.util.CustomLog.i((String)"KiboRpcApi", (String)"[Start] reportRoundingCompletion");
        try {
            if (!this.reportCompletion) {
                common.util.CustomLog.v((String)"KiboRpcApi", (String)"[reportRoundingCompletion] Make rounding is complete message");
                JSONObject data = new JSONObject();
                ...
                common.util.CustomLog.v((String)"KiboRpcApi", (String)"[reportRoundingCompletion] Do getRobotKinematics");
                Kinematics kinematics = this.getRobotKinematics();
                if (kinematics == null || kinematics.getPosition() == null || kinematics.getOrientation() == null) {
                    common.util.CustomLog.e((String)"KiboRpcApi", (String)"[reportRoundingCompletion] It was not possible to get a kinematics.");
                    if (kinematics == null) {
                        common.util.CustomLog.e((String)"KiboRpcApi", (String)"[reportRoundingCompletion] kinematics is null.");
                    }
                    if (kinematics.getPosition() == null) {
                        common.util.CustomLog.e((String)"KiboRpcApi", (String)"[reportRoundingCompletion] kinematics.getPosition() is null.");
                    }
                    if (kinematics.getOrientation() == null) {
                        common.util.CustomLog.e((String)"KiboRpcApi", (String)"[reportRoundingCompletion] kinematics.getOrientation() is null.");
                    }
                    return false;
                }
                String positionX = String.format("%.3f", kinematics.getPosition().getX());
                ...
                this.gsService.sendData(MessageType.JSON, "data", data.toString());
                for (int i = 0; i < 2; ++i) {
                    common.util.CustomLog.v((String)"KiboRpcApi", (String)("[reportRoundingCompletion] Count: " + i));
        ...
        common.util.CustomLog.i((String)"KiboRpcApi", (String)"[Finish] reportRoundingCompletion");
        return true;
    }

 
   public void takeTargetItemSnapshot() {
         common.util.CustomLog.i((String)"KiboRpcApi", (String)"[Start] takeTargetItemSnapshot");
        try {
            if (!this.tookTargetItemSnap) {
                boolean result = true;
                int approach_time = 1;
                if (!this.gsService.getOnSimulation()) {
                     common.util.CustomLog.v((String)"KiboRpcApi", (String)"[takeTargetItemSnapshot] getOnSimulation: False");
                     common.util.CustomLog.v((String)"KiboRpcApi", (String)"[takeTargetItemSnapshot] Set approach_time");
                    approach_time = 2;
                }
                if (!(result = this.takeSnapshot(approach_time))) {
                     common.util.CustomLog.e((String)"KiboRpcApi", (String)"[takeTargetItemSnapshot] Fail to Take the targetItem Snapshot.");
                }
                 common.util.CustomLog.v((String)"KiboRpcApi", (String)"[takeTargetItemSnapshot] Make finish message");
                JSONObject data = new JSONObject();
                data.put("t_stamp_finish", (Object)this.df.format(new Date(System.currentTimeMillis())));
                data.put("status", (Object)"Mission Finish");
                this.gsService.sendData(MessageType.JSON, "data", data.toString());
                 common.util.CustomLog.v((String)"KiboRpcApi", (String)"[takeTargetItemSnapshot] Do getRobotKinematics");
                Kinematics kinematics = this.getRobotKinematics();
                if (kinematics != null && kinematics.getPosition() != null && kinematics.getOrientation() != null) {
                    String positionX = String.format("%.3f", kinematics.getPosition().getX());
                    String positionY = String.format("%.3f", kinematics.getPosition().getY());
                    ...
                    this.gsService.sendData(MessageType.JSON, "data", data.toString());
                     ...
                     common.util.CustomLog.e((String)"KiboRpcApi", (String)"[takeTargetItemSnapshot] It was not possible to get a kinematics.");
                    if (kinematics == null) {
                         common.util.CustomLog.e((String)"KiboRpcApi", (String)"[takeTargetItemSnapshot] kinematics is null.");
                    }
                    if (kinematics.getPosition() == null) {
                         common.util.CustomLog.e((String)"KiboRpcApi", (String)"[takeTargetItemSnapshot] kinematics.getPosition() is null.");
                    }
                    if (kinematics.getOrientation() == null) {
                         common.util.CustomLog.e((String)"KiboRpcApi", (String)"[takeTargetItemSnapshot] kinematics.getOrientation() is null.");
                    }
                }
                if (!this.gsService.getOnSimulation()) {
                     common.util.CustomLog.v((String)"KiboRpcApi", (String)"[takeTargetItemSnapshot] getOnSimulation: False");
                     common.util.CustomLog.v((String)"KiboRpcApi", (String)"[takeTargetItemSnapshot] Set SignalState");
         ...
         common.util.CustomLog.i((String)"KiboRpcApi", (String)"[Finish] takeTargetItemSnapshot");
    }
  ...
  private boolean takeSnapshot(int approach_times) {
        try {
            common.util.CustomLog.v((String)"KiboRpcApi", (String)"[Start] takeSnapshot");
            Object data = null;
            for (int i = 1; i <= approach_times; ++i) {
                common.util.CustomLog.v((String)"KiboRpcApi", (String)("[takeSnapshot] Count: " + i));
                long startTime = System.currentTimeMillis();
                if (i == 1) {
                    common.util.CustomLog.v((String)"KiboRpcApi", (String)"[takeSnapshot] Make start message");
                }
                common.util.CustomLog.v((String)"KiboRpcApi", (String)"[takeSnapshot] Make target snapshot");
                if (!this.gsService.getOnSimulation()) {
                    common.util.CustomLog.v((String)"KiboRpcApi", (String)"[takeSnapshot] getOnSimulation: False");
                    common.util.CustomLog.v((String)"KiboRpcApi", (String)"[takeSnapshot] Save bitmap");
                    Bitmap image = this.getBitmapNavCam();
                ...
                while (currentTime - startTime <= 1000L) {
                    if (this.gsService.getOnSimulation()) {
                        common.util.CustomLog.v((String)"KiboRpcApi", (String)"[takeSnapshot] getOnSimulation: True");
                        common.util.CustomLog.v((String)"KiboRpcApi", (String)"[takeSnapshot] Sleep inteval");
                        Thread.sleep(10L);
                    } else {
                        common.util.CustomLog.v((String)"KiboRpcApi", (String)"[takeSnapshot] getOnSimulation: False");
                        common.util.CustomLog.v((String)"KiboRpcApi", (String)"[takeSnapshot] Sleep inteval");
            ...
            common.util.CustomLog.v((String)"KiboRpcApi", (String)"[takeSnapshot] Make target finish message");
            common.util.CustomLog.v((String)"KiboRpcApi", (String)"[Finish] takeSnapshot");
            return true;
        }
    ...
    private void saveBitmap(Bitmap saveImage) throws SecurityException, IOException, NullPointerException {
        common.util.CustomLog.v((String)"KiboRpcApi", (String)"[Start] saveBitmap");
        String filepath = this.gsService.getGuestScienceDataBasePath() + TARGET_IMAGES_SAVE_DIR;
        File file = new File(filepath);
        if (!file.exists()) {
            common.util.CustomLog.v((String)"KiboRpcApi", (String)"[saveBitmap] Make save directory");
            file.mkdir();
        }
        Date mDate = new Date();
        SimpleDateFormat fileNameDate = new SimpleDateFormat("yyyyMMdd_HHmmss");
        ...
        out.flush();
        out.close();
        common.util.CustomLog.v((String)"KiboRpcApi", (String)"[Finish] saveBitmap");
    }
