...
import jp.jaxa.iss.kibo.rpc.api.sub.SetterNode;
...
public final class KiboRpcApi
 {
    ...
    private void sendExceptionMessage(String errmsg, Exception err) {
        common.util.Log.v((String)"KiboRpcApi", (String)"[Start] sendExceptionMessage");
        try {
            JSONObject data = new JSONObject();
            data.put("error", (Object)("[" + err.getClass().getName() + "] " + errmsg));
            common.util.Log.e((String)"KiboRpcApi", (String)errmsg, (Throwable)err);
            ...
            common.util.Log.e((String)"KiboRpcApi", (String)"[sendExceptionMessage] Failed to send error message.", (Throwable)e);
        }
        common.util.Log.v((String)"KiboRpcApi", (String)"[Finish] sendExceptionMessage");
    }

    private KiboRpcApi(KiboRpcService startGuestScienceService) {
        common.util.Log.v((String)"KiboRpcApi", (String)"[Start] KiboRpcApi");
        common.util.Log.i((String)"KiboRpcApi", (String)"[AARVersion] AAR version 5.1.0");
        this.configureRobot();
        ...
        common.util.Log.v((String)"KiboRpcApi", (String)"[Finish] KiboRpcApi");
    }

    private void configureRobot() {
        common.util.Log.v((String)"KiboRpcApi", (String)"[Start] configureRobot");
        ...
        common.util.Log.v((String)"KiboRpcApi", (String)"[Finish] configureRobot");
    }
    ...
    private Result getCommandResult(PendingResult pending, boolean printRobotPosition, int timeout) {
        common.util.Log.v((String)"KiboRpcApi", (String)"[Start] getCommandResult");
        Result result = null;
        int counter = 0;
        try {
            while (!pending.isFinished()) {
                if (timeout >= 0) {
                    common.util.Log.v((String)"KiboRpcApi", (String)"[getCommandResult] Setting timeout");
                    if (counter > timeout) {
                        common.util.Log.v((String)"KiboRpcApi", (String)"[getCommandResult] return null");
                        Result var = null;
        return null;
                    }
                }
                if (printRobotPosition) {
                    common.util.Log.v((String)"KiboRpcApi", (String)"[getCommandResult] Meanwhile, let's get the positioning along the trajectory");
                    Kinematics k = this.getterNode.getCurrentKinematics();
                    if (k.getPosition() != null) {
                        common.util.Log.i((String)"KiboRpcApi", (String)("[getCommandResult] Current Position: " + k.getPosition().toString()));
                    }
                    if (k.getOrientation() != null) {
                        common.util.Log.i((String)"KiboRpcApi", (String)("[getCommandResult] Current Orientation: " + k.getOrientation().toString()));
                    }
                }
            ...
            common.util.Log.v((String)"KiboRpcApi", (String)"[Finish] getCommandResult");
            return result;
        }
    }

    private void printLogCommandResult(Result result) {
        common.util.Log.i((String)"KiboRpcApi", (String)"[Start] printLogCommandResult");
        if (result != null) {
            if (result.getStatus() != null) {
                common.util.Log.i((String)"KiboRpcApi", (String)("[printLogCommandResult] Command status: " + result.getStatus().toString()));
            }
            if (!result.hasSucceeded()) {
                common.util.Log.e((String)"KiboRpcApi", (String)("[printLogCommandResult] Command message: " + result.getMessage()));
            }
            common.util.Log.i((String)"KiboRpcApi", (String)"[printLogCommandResult] Done.");
            common.util.Log.i((String)"KiboRpcApi", (String)"[Finish] printLogCommandResult");
        } else {
            common.util.Log.e((String)"KiboRpcApi", (String)"[printLogCommandResult] Invalid result.");
        }
    }

    private Result stopAllMotion() {
        common.util.Log.v((String)"KiboRpcApi", (String)"[Start] stopAllMotion");
        ...
        common.util.Log.v((String)"KiboRpcApi", (String)"[Finish] stopAllMotion");
        return result;
    }

    private boolean setPlanner(PlannerType plannerType) {
        common.util.Log.v((String)"KiboRpcApi", (String)"[Start] setPlanner");
        PendingResult pendingResult = null;
        try {
        ...
        if (result != null) {
            if (result.hasSucceeded()) {
                ...
                common.util.Log.v((String)"KiboRpcApi", (String)("[setPlanner] Planner is set to " + plannerType));
            }
            common.util.Log.v((String)"KiboRpcApi", (String)"[Finish] setPlanner");
            return result.hasSucceeded();
        }
        common.util.Log.e((String)"KiboRpcApi", (String)"[setPlanner] Invalid result.");
        return false;
    }

    public void shutdownFactory() {
        common.util.Log.v((String)"KiboRpcApi", (String)"[Start] shutdownFactory");
        this.factory.shutdown();
        common.util.Log.v((String)"KiboRpcApi", (String)"[Finish] shutdownFactory");
    }

    public static KiboRpcApi getInstance(KiboRpcService startGuestScienceService) {
        common.util.Log.v((String)"KiboRpcApi", (String)"[Start] getInstance");
        if (instance == null) {
            common.util.Log.v((String)"KiboRpcApi", (String)"[getInstance] Make instance");
            instance = new KiboRpcApi(startGuestScienceService);
        }
        common.util.Log.v((String)"KiboRpcApi", (String)"[Finish] getInstance");
        return instance;
    }

    private Kinematics getTrustedRobotKinematics() {
        common.util.Log.i((String)"KiboRpcApi", (String)"[Start] getTrustedRobotKinematics");
        common.util.Log.i((String)"KiboRpcApi", (String)"[getTrustedRobotKinematics] Waiting for robot to acquire position.");
        Kinematics k = null;
        ...
        while (end_point - start_point < 30000L) {
            ...
            if (k.getConfidence() == Kinematics.Confidence.GOOD) {
                common.util.Log.v((String)"KiboRpcApi", (String)"[getTrustedRobotKinematics] Break loop");
                break;
            }
            k = null;
            try {
                ...
                common.util.Log.e((String)"KiboRpcApi", (String)"[getTrustedRobotkinematics] It was not possible to get a trusted kinematics. Sorry.");
                return null;
            }
            end_point = System.currentTimeMillis();
        }
        common.util.Log.i((String)"KiboRpcApi", (String)"[Finish] getTrustedRobotKinematics");
        return k;
    }

    public Kinematics getRobotKinematics() {
        common.util.Log.i((String)"KiboRpcApi", (String)"[Start] getRobotKinematics");
        common.util.Log.i((String)"KiboRpcApi", (String)"[getRobotKinematics] Waiting for robot to acquire position.");
        common.util.Log.i((String)"KiboRpcApi", (String)"[Finish] getRobotKinematics");
        return this.getterNode.getCurrentKinematics();
    }

    public Bitmap getBitmapNavCam() {
        common.util.Log.i((String)"KiboRpcApi", (String)"[Start] getBitmapNavCam");
        Bitmap ret = this.getterNode.getBitmapNavCam();
        if (ret == null) {
            common.util.Log.i((String)"KiboRpcApi", (String)"[getBitmapNavCam] ret is null.");
            common.util.Log.e((String)"KiboRpcApi", (String)"[getBitmapNavCam] It was not possible to get a Bitmap from Nav Cam.");
        }
        common.util.Log.i((String)"KiboRpcApi", (String)"[Finish] getBitmapNavCam");
        return ret;
    }

    public Bitmap getBitmapDockCam() {
        common.util.Log.i((String)"KiboRpcApi", (String)"[Start] getBitmapDockCam");
        Bitmap ret = this.getterNode.getBitmapDockCam();
        if (ret == null) {
            common.util.Log.i((String)"KiboRpcApi", (String)"[getBitmapDockCam] ret is null.");
            common.util.Log.e((String)"KiboRpcApi", (String)"[getBitmapDockCam] It was not possible to get a Bitmap from Dock Cam.");
        }
        common.util.Log.i((String)"KiboRpcApi", (String)"[Finish] getBitmapDockCam");
        return ret;
    }

    public Mat getMatNavCam() {
        common.util.Log.i((String)"KiboRpcApi", (String)"[Start] getMatNavCam");
        Mat ret = this.getterNode.getMatNavCam();
        if (ret == null) {
            common.util.Log.i((String)"KiboRpcApi", (String)"[getMatNavCam] ret is null.");
            common.util.Log.e((String)"KiboRpcApi", (String)"[getMatNavCam] It was not possible to get a Mat from Nav Cam.");
        }
        common.util.Log.i((String)"KiboRpcApi", (String)"[Finish] getMatNavCam");
        return ret;
    }

    public Mat getMatDockCam() {
        common.util.Log.i((String)"KiboRpcApi", (String)"[Start] getMatDockCam");
        Mat ret = this.getterNode.getMatDockCam();
        if (ret == null) {
            common.util.Log.i((String)"KiboRpcApi", (String)"[getMatDockCam] ret is null.");
            common.util.Log.e((String)"KiboRpcApi", (String)"[getMatDockCam] It was not possible to get a Mat from Dock Cam.");
        }
        common.util.Log.i((String)"KiboRpcApi", (String)"[Finish] getMatDockCam");
        return ret;
    }

    public Result flashlightControlFront(float brightness) {
        common.util.Log.i((String)"KiboRpcApi", (String)"[Start] flashlightControlFront");
        if (!this.getterNode.getOnSimulation() && brightness > 0.01f) {
            common.util.Log.v((String)"KiboRpcApi", (String)"[flashlightControlFront] In the final, the maximum value of the light is set to 0.01.");
            brightness = 0.01f;
        }
        common.util.Log.i((String)"KiboRpcApi", (String)("Parameters: brightness == " + brightness));
        PendingResult pendingResult = null;
        try {
        ...
        common.util.Log.i((String)"KiboRpcApi", (String)"[Finish] flashlightControlFront");
        return this.getCommandResult(pendingResult, false, -1);
    }

    public Result flashlightControlBack(float brightness) {
        common.util.Log.i((String)"KiboRpcApi", (String)"[Start] flashlightControlBack");
        if (!this.getterNode.getOnSimulation() && brightness > 0.01f) {
            common.util.Log.v((String)"KiboRpcApi", (String)"[flashlightControlBack] In the final, the maximum value of the light is set to 0.01.");
            brightness = 0.01f;
        }
        common.util.Log.i((String)"KiboRpcApi", (String)("Parameters: brightness == " + brightness));
        PendingResult pendingResult = null;
        ...
        common.util.Log.i((String)"KiboRpcApi", (String)"[Finish] flashlightControlBack");
        return this.getCommandResult(pendingResult, false, -1);
    }
    ...
    private Result flashlightControl(float brightness, boolean front) {
        ...
        if (front) {
            common.util.Log.i((String)"KiboRpcApi", (String)"[Start] flashlightControl: front");
            common.util.Log.i((String)"KiboRpcApi", (String)("Parameters: brightness == " + brightness));
            flloc = FlashlightLocation.FRONT;
        } else {
            common.util.Log.i((String)"KiboRpcApi", (String)"[Start] flashlightControl: back");
            common.util.Log.i((String)"KiboRpcApi", (String)("Parameters: brightness == " + brightness));
    ...
    public Result moveTo(Point goalPoint, Quaternion orientation, boolean printRobotPosition) {
        common.util.Log.i((String)"KiboRpcApi", (String)"[Start] moveTo");
        common.util.Log.i((String)"KiboRpcApi", (String)("Parameters: goalPoint == " + goalPoint + ", orientation == " + orientation + ", printRobotPosition == " + printRobotPosition));
        if (goalPoint == null) {
            common.util.Log.i((String)"KiboRpcApi", (String)("[moveTo] goalPoint == " + goalPoint));
            common.util.Log.e((String)"KiboRpcApi", (String)"[moveTo] goalPoint is invalid.");
            return null;
        }
        if (orientation == null) {
            common.util.Log.i((String)"KiboRpcApi", (String)("[moveTo] orientation == " + orientation));
            common.util.Log.e((String)"KiboRpcApi", (String)"[moveTo] orientation is invalid.");
            return null;
        }
        if (!this.setPlanner(PlannerType.TRAPEZOIDAL)) {
            common.util.Log.e((String)"KiboRpcApi", (String)"[moveTo] Cannot set planner.");
            return null;
        }
        common.util.Log.i((String)"KiboRpcApi", (String)("[moveTo] Planner is set to " + this.plannerType.toString() + "."));
        Result result = this.stopAllMotion();
        if (result == null) {
            common.util.Log.i((String)"KiboRpcApi", (String)("[moveTo] result == " + result));
            common.util.Log.e((String)"KiboRpcApi", (String)"[moveTo] Cannot stop all motion.");
            return null;
        }
        if (result.hasSucceeded()) {
            common.util.Log.i((String)"KiboRpcApi", (String)("[moveTo] Planner is " + this.plannerType.toString() + "."));
            common.util.Log.i((String)"KiboRpcApi", (String)"[moveTo] Moving the bee.");
            PendingResult pendingResult = null;
            try {
        ...
        common.util.Log.i((String)"KiboRpcApi", (String)"[Finish] moveTo");
        return result;
    }

    public Result relativeMoveTo(Point goalPoint, Quaternion orientation, boolean printRobotPosition) {
        common.util.Log.i((String)"KiboRpcApi", (String)"[Start] relativeMoveTo");
        common.util.Log.i((String)"KiboRpcApi", (String)("Parameters: goalPoint == " + goalPoint + ", orientation == " + orientation + ", printRobotPosition == " + printRobotPosition));
        if (goalPoint == null) {
            common.util.Log.i((String)"KiboRpcApi", (String)("[relativeMoveTo] goalPoint == " + goalPoint));
            common.util.Log.e((String)"KiboRpcApi", (String)"[relativeMoveTo] goalPoint is invalid.");
            return null;
        }
        if (orientation == null) {
            common.util.Log.i((String)"KiboRpcApi", (String)("[relativeMoveTo] orientation == " + orientation));
            common.util.Log.e((String)"KiboRpcApi", (String)"[relativeMoveTo] orientation is invalid.");
            return null;
        }
        Kinematics k = this.getTrustedRobotKinematics();
        if (k == null) {
            common.util.Log.i((String)"KiboRpcApi", (String)("[relativeMoveTo] k == " + k));
            common.util.Log.e((String)"KiboRpcApi", (String)"[relativeMoveTo] Cannot get robot kinematics.");
            return null;
        }
        ...
        common.util.Log.i((String)"KiboRpcApi", (String)"[Finish] relativeMoveTo");
    ...
    private void setSignalStateFoundPattern() {
        try {
            JSONObject data = new JSONObject();
            common.util.Log.v((String)"KiboRpcApi", (String)"[Start] setSignalStateFoundPattern");
            ...
            this.gsService.sendData(MessageType.JSON, "data", data.toString());
            common.util.Log.v((String)"KiboRpcApi", (String)"[Finish] setSignalStateFoundPattern");
        }
        catch (JSONException e) {
    ...
    private void setSignalStateRecognitionPattern() {
        try {
            JSONObject data = new JSONObject();
            common.util.Log.v((String)"KiboRpcApi", (String)"[Start] setSignalStateRecognitionPattern");
            this.setterNode.setSignalState((byte)3, 1);
            data.put("signal_light", (Object)"Turn on the recognition pattern");
            this.gsService.sendData(MessageType.JSON, "data", data.toString());
            common.util.Log.v((String)"KiboRpcApi", (String)"[Finish] setSignalStateRecognitionPattern");
        }
        catch (JSONException e) {
    ...
    public boolean startMission() {
        common.util.Log.i((String)"KiboRpcApi", (String)"[Start] startMission");
        ...
        try {
            ...
            this.gsService.sendData(MessageType.JSON, "data", data.toString());
            common.util.Log.i((String)"KiboRpcApi", (String)("Undock Start: " + time));
            PendingResult pendingResult = this.robot.undock();
            int timeout = 100;
            if (!this.getterNode.getOnSimulation()) {
                common.util.Log.d((String)"KiboRpcApi", (String)"set timeout -1");
                timeout = -1;
            }
            ...
            if (result != null && result.hasSucceeded()) {
                ...
                common.util.Log.i((String)"KiboRpcApi", (String)("Undock Finish: " + time));
            } else {
                data.put("failed", (Object)"Undock failed");
                time = this.df.format(new Date(System.currentTimeMillis()));
                common.util.Log.e((String)"KiboRpcApi", (String)("Undock failed: " + time));
            }
            this.gsService.sendData(MessageType.JSON, "data", data.toString());
            if (isSuccess) {
                time = this.df.format(new Date(System.currentTimeMillis()));
                ...
                this.gsService.sendData(MessageType.JSON, "data", data.toString());
                common.util.Log.i((String)"KiboRpcApi", (String)("Mission Start: " + time));
            }
        }
        catch (JSONException e) {
        ...
        common.util.Log.i((String)"KiboRpcApi", (String)"[Finish] startMission");
        return isSuccess;
    }
    ...
    private Result setQuietMode() {
        try {
            common.util.Log.v((String)"KiboRpcApi", (String)"[Start] setQuietMode");
            common.util.Log.i((String)"KiboRpcApi", (String)"[setQuietMode] Change the flight mode to Quiet mode.");
            ...
            common.util.Log.i((String)"KiboRpcApi", (String)"[setQuietMode] Changed flight mode to Quiet mode.");
            common.util.Log.v((String)"KiboRpcApi", (String)"[Finish] setQuietMode");
            return result;
        }
        catch (AstrobeeRuntimeException e) {
    ...
    private Result setLomoMode() {
        try {
            common.util.Log.v((String)"KiboRpcApi", (String)"[Start] setLomoMode");
            common.util.Log.i((String)"KiboRpcApi", (String)"[setLomoMode] Change the flight mode to Lomo mode.");
            ...
            Result result = this.getCommandResult(pendingResult, true, -1);
            common.util.Log.i((String)"KiboRpcApi", (String)"[setLomoMode] Changed flight mode to Lomo mode.");
            common.util.Log.v((String)"KiboRpcApi", (String)"[Finish] setLomoMode");
            return result;
        }
        catch (AstrobeeRuntimeException e) {
    ...
    public void notifyRecognitionItem() {
        common.util.Log.i((String)"KiboRpcApi", (String)"[Start] notifyRecognitionItem");
        try {
            common.util.Log.v((String)"KiboRpcApi", (String)"[notifyRecognitionItem] Target Item recognition is complete");
            JSONObject data = new JSONObject();
        ...
        common.util.Log.i((String)"KiboRpcApi", (String)"[Finish] notifyRecognitionItem");
    }

    public boolean reportRoundingCompletion() {
        common.util.Log.i((String)"KiboRpcApi", (String)"[Start] reportRoundingCompletion");
        try {
            if (!this.reportCompletion) {
                common.util.Log.v((String)"KiboRpcApi", (String)"[reportRoundingCompletion] Make rounding is complete message");
                JSONObject data = new JSONObject();
                ...
                common.util.Log.v((String)"KiboRpcApi", (String)"[reportRoundingCompletion] Do getRobotKinematics");
                ...
                if (kinematics == null || kinematics.getPosition() == null || kinematics.getOrientation() == null) {
                    common.util.Log.e((String)"KiboRpcApi", (String)"[reportRoundingCompletion] It was not possible to get a kinematics.");
                    if (kinematics == null) {
                        common.util.Log.e((String)"KiboRpcApi", (String)"[reportRoundingCompletion] kinematics is null.");
                    }
                    if (kinematics.getPosition() == null) {
                        common.util.Log.e((String)"KiboRpcApi", (String)"[reportRoundingCompletion] kinematics.getPosition() is null.");
                    }
                    if (kinematics.getOrientation() == null) {
                        common.util.Log.e((String)"KiboRpcApi", (String)"[reportRoundingCompletion] kinematics.getOrientation() is null.");
                    }
                    return false;
                }
                ...
                this.gsService.sendData(MessageType.JSON, "data", data.toString());
                for (int i = 0; i < 2; ++i) {
                    common.util.Log.v((String)"KiboRpcApi", (String)("[reportRoundingCompletion] Count: " + i));
        ...
        common.util.Log.i((String)"KiboRpcApi", (String)"[Finish] reportRoundingCompletion");
        return true;
    }

    public void takeTargetItemSnapshot() {
        common.util.Log.i((String)"KiboRpcApi", (String)"[Start] takeTargetItemSnapshot");
        try {
            if (!this.tookTargetItemSnap) {
                boolean result = true;
                int approach_time = 1;
                if (!this.getterNode.getOnSimulation()) {
                    common.util.Log.v((String)"KiboRpcApi", (String)"[takeTargetItemSnapshot] getOnSimulation: False");
                    common.util.Log.v((String)"KiboRpcApi", (String)"[takeTargetItemSnapshot] Set approach_time");
                    approach_time = 2;
                }
                if (!(result = this.takeSnapshot(approach_time))) {
                    common.util.Log.e((String)"KiboRpcApi", (String)"[takeTargetItemSnapshot] Fail to Take the targetItem Snapshot.");
                }
                common.util.Log.v((String)"KiboRpcApi", (String)"[takeTargetItemSnapshot] Make finish message");
                JSONObject data = new JSONObject();
                data.put("t_stamp_finish", (Object)this.df.format(new Date(System.currentTimeMillis())));
                data.put("status", (Object)"Mission Finish");
                this.gsService.sendData(MessageType.JSON, "data", data.toString());
                common.util.Log.v((String)"KiboRpcApi", (String)"[takeTargetItemSnapshot] Do getRobotKinematics");
                Kinematics kinematics = this.getRobotKinematics();
                if (kinematics != null && kinematics.getPosition() != null && kinematics.getOrientation() != null) {
                    String positionX = String.format("%.3f", kinematics.getPosition().getX());
                    String positionY = String.format("%.3f", kinematics.getPosition().getY());
                    ...
                    common.util.Log.e((String)"KiboRpcApi", (String)"[takeTargetItemSnapshot] It was not possible to get a kinematics.");
                    if (kinematics == null) {
                        common.util.Log.e((String)"KiboRpcApi", (String)"[takeTargetItemSnapshot] kinematics is null.");
                    }
                    if (kinematics.getPosition() == null) {
                        common.util.Log.e((String)"KiboRpcApi", (String)"[takeTargetItemSnapshot] kinematics.getPosition() is null.");
                    }
                    if (kinematics.getOrientation() == null) {
                        common.util.Log.e((String)"KiboRpcApi", (String)"[takeTargetItemSnapshot] kinematics.getOrientation() is null.");
                    }
                }
                if (!this.getterNode.getOnSimulation()) {
                    common.util.Log.v((String)"KiboRpcApi", (String)"[takeTargetItemSnapshot] getOnSimulation: False");
                    common.util.Log.v((String)"KiboRpcApi", (String)"[takeTargetItemSnapshot] Set SignalState");
        ...
        common.util.Log.i((String)"KiboRpcApi", (String)"[Finish] takeTargetItemSnapshot");
    }

    private boolean takeSnapshot(int approach_times) {
        try {
            common.util.Log.v((String)"KiboRpcApi", (String)"[Start] takeSnapshot");
            Object data = null;
            for (int i = 1; i <= approach_times; ++i) {
                common.util.Log.v((String)"KiboRpcApi", (String)("[takeSnapshot] Count: " + i));
                long startTime = System.currentTimeMillis();
                if (i == 1) {
                    common.util.Log.v((String)"KiboRpcApi", (String)"[takeSnapshot] Make start message");
                }
                common.util.Log.v((String)"KiboRpcApi", (String)"[takeSnapshot] Make target snapshot");
                if (!this.getterNode.getOnSimulation()) {
                    common.util.Log.v((String)"KiboRpcApi", (String)"[takeSnapshot] getOnSimulation: False");
                    common.util.Log.v((String)"KiboRpcApi", (String)"[takeSnapshot] Save bitmap");
                ...
                while (currentTime - startTime <= 1000L) {
                    if (this.getterNode.getOnSimulation()) {
                        common.util.Log.v((String)"KiboRpcApi", (String)"[takeSnapshot] getOnSimulation: True");
                        common.util.Log.v((String)"KiboRpcApi", (String)"[takeSnapshot] Sleep inteval");
                        Thread.sleep(10L);
                    } else {
                        common.util.Log.v((String)"KiboRpcApi", (String)"[takeSnapshot] getOnSimulation: False");
                        common.util.Log.v((String)"KiboRpcApi", (String)"[takeSnapshot] Sleep inteval");
            ...
            common.util.Log.v((String)"KiboRpcApi", (String)"[takeSnapshot] Make target finish message");
            common.util.Log.v((String)"KiboRpcApi", (String)"[Finish] takeSnapshot");
            return true;
        }
    ...
    private void saveBitmap(Bitmap saveImage) throws SecurityException, IOException, NullPointerException {
        common.util.Log.v((String)"KiboRpcApi", (String)"[Start] saveBitmap");
        String filepath = this.gsService.getGuestScienceDataBasePath() + TARGET_IMAGES_SAVE_DIR;
        File file = new File(filepath);
        if (!file.exists()) {
            common.util.Log.v((String)"KiboRpcApi", (String)"[saveBitmap] Make save directory");
            file.mkdir();
        }
        Date mDate = new Date();
        ...
        out.flush();
        out.close();
        common.util.Log.v((String)"KiboRpcApi", (String)"[Finish] saveBitmap");
    }

    public double[][] getNavCamIntrinsics() {
        common.util.Log.i((String)"KiboRpcApi", (String)"[Start] getNavCamIntrinsics");
        double[][] camera_param = new double[2][];
        if (this.getterNode.getOnSimulation()) {
            common.util.Log.v((String)"KiboRpcApi", (String)"[getNavCamIntrinsics] getOnSimulation: True");
            common.util.Log.v((String)"KiboRpcApi", (String)"[getNavCamIntrinsics] Set simulation param");
            camera_param[0] = this.NAVCAM_CAMERA_MATRIX_SIMULATION;
            camera_param[1] = this.NAVCAM_DISTORTION_COEFFICIENTS_SIMULATION;
        } else {
            common.util.Log.v((String)"KiboRpcApi", (String)"[getNavCamIntrinsics] Set ISS param");
            camera_param[0] = this.NAVCAM_CAMERA_MATRIX_ISS;
            camera_param[1] = this.NAVCAM_DISTORTION_COEFFICIENTS_ISS;
        }
        common.util.Log.i((String)"KiboRpcApi", (String)"[Finish] getNavCamIntrinsics");
        return camera_param;
    }

    public double[][] getDockCamIntrinsics() {
        common.util.Log.i((String)"KiboRpcApi", (String)"[Start] getDockCamIntrinsics");
        double[][] camera_param = new double[2][];
        if (this.getterNode.getOnSimulation()) {
            common.util.Log.v((String)"KiboRpcApi", (String)"[getDockCamIntrinsics] getOnSimulation: True");
            common.util.Log.v((String)"KiboRpcApi", (String)"[getDockCamIntrinsics] Set simulation param");
            camera_param[0] = this.DOCKCAM_CAMERA_MATRIX_SIMULATION;
            camera_param[1] = this.DOCKCAM_DISTORTION_COEFFICIENTS_SIMULATION;
        } else {
            common.util.Log.v((String)"KiboRpcApi", (String)"[getDockCamIntrinsics] Set ISS param");
            camera_param[0] = this.DOCKCAM_CAMERA_MATRIX_ISS;
            camera_param[1] = this.DOCKCAM_DISTORTION_COEFFICIENTS_ISS;
        }
        common.util.Log.i((String)"KiboRpcApi", (String)"[Finish] getDockCamIntrinsics");
        return camera_param;
    }

    public void saveBitmapImage(Bitmap image, String imageName) {
        try {
            common.util.Log.i((String)"KiboRpcApi", (String)"[Start] saveBitmapImage");
            boolean checkArgs = true;
            if (image == null) {
                common.util.Log.e((String)"KiboRpcApi", (String)"[saveBitmapImage] image is null");
                checkArgs = false;
            }
            if (imageName == null) {
                common.util.Log.e((String)"KiboRpcApi", (String)"[saveBitmapImage] imageName is null");
                checkArgs = false;
            }
            if (checkArgs) {
                common.util.Log.i((String)"KiboRpcApi", (String)("Parameters: image, imageName == " + imageName));
                common.util.Log.v((String)"KiboRpcApi", (String)"[saveBitmapImage] getOnSimulation: True");
                common.util.Log.v((String)"KiboRpcApi", (String)"[saveBitmapImage] Check directry");
                String filepath = this.gsService.getGuestScienceDataBasePath() + DEBUG_IMAGES_SAVE_DIR;
                File file = new File(filepath);
                if (!file.exists()) {
                    common.util.Log.v((String)"KiboRpcApi", (String)"[saveBitmapImage] Make save directry");
                    file.mkdir();
                }
                ...
                if (list.length >= 50) {
                    common.util.Log.e((String)"KiboRpcApi", (String)"[saveBitmapImage] Can't save more than 50 images");
                } else if (size > 1228800) {
                    common.util.Log.e((String)"KiboRpcApi", (String)"[saveBitmapImage] The size is too large.");
                } else {
                    common.util.Log.v((String)"KiboRpcApi", (String)"[saveBitmapImage] Save bitmap image");
                    this.saveImage(image, imageName, file);
                }
            }
            common.util.Log.i((String)"KiboRpcApi", (String)"[Finish] saveBitmapImage");
        }
        catch (Exception e) {
    ...
    public void saveMatImage(Mat image, String imageName) {
        try {
            common.util.Log.i((String)"KiboRpcApi", (String)"[Start] saveMatImage");
            boolean checkArgs = true;
            if (image == null) {
                common.util.Log.e((String)"KiboRpcApi", (String)"[saveMatImage] image is null");
                checkArgs = false;
            }
            if (imageName == null) {
                common.util.Log.e((String)"KiboRpcApi", (String)"[saveMatImage] imageName is null");
                checkArgs = false;
            }
            if (checkArgs) {
                common.util.Log.i((String)"KiboRpcApi", (String)("Parameters: image, imageName == " + imageName));
                common.util.Log.v((String)"KiboRpcApi", (String)"[saveMatImage] getOnSimulation: True");
                common.util.Log.v((String)"KiboRpcApi", (String)"[saveMatImage] Check directry");
                String filepath = this.gsService.getGuestScienceDataBasePath() + DEBUG_IMAGES_SAVE_DIR;
                File file = new File(filepath);
                if (!file.exists()) {
                    common.util.Log.v((String)"KiboRpcApi", (String)"[saveMatImage] make save directory");
                    file.mkdir();
                }
                File[] list = file.listFiles();
                ...
                int size = width * height;
                if (list.length >= 50) {
                    common.util.Log.e((String)"KiboRpcApi", (String)"[saveMatImage] Can't save more than 50 images.");
                } else if (size > 1228800) {
                    common.util.Log.e((String)"KiboRpcApi", (String)"[saveMatImage] The size is too large.");
                } else {
                    common.util.Log.v((String)"KiboRpcApi", (String)"[saveMatImage] Save mat image");
            ...
            common.util.Log.i((String)"KiboRpcApi", (String)"[Finish] saveMatImage");
        }
        catch (Exception e) {
    ...
    private void saveImage(Bitmap image, String imageName, File file) throws SecurityException, IOException, NullPointerException {
        ...
        common.util.Log.v((String)"KiboRpcApi", (String)AttachName);
        FileOutputStream out = new FileOutputStream(AttachName);
    ...
    public void setAreaInfo(int areaId, String itemName, int number) {
        try {
            common.util.Log.i((String)"KiboRpcApi", (String)"[Start] setAreaInfo");
            boolean checkArgs = true;
            if (itemName == null) {
                common.util.Log.e((String)"KiboRpcApi", (String)"[saveBitmapImage] itemName is null");
                itemName = "";
            }
            common.util.Log.i((String)"KiboRpcApi", (String)("Parameters: areaId == " + areaId + ", itemName == " + itemName + ", number == " + number));
            ...
            data.put("num", number);
            this.gsService.sendData(MessageType.JSON, "data", data.toString());
            common.util.Log.i((String)"KiboRpcApi", (String)"[Finish] setAreaInfo");
        }
        catch (Exception e) {
